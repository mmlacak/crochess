...
#define CC_STEPS_PAWN_DISPLACEMENT_LEN (4)
...
#define CC_STEPS_PAWN_DISPLACEMENT_SIZE (CC_STEPS_PAWN_DISPLACEMENT_LEN + 1)
...
extern CcTypedStep const CC_STEPS_PAWN_DISPLACEMENT[ CC_STEPS_PAWN_DISPLACEMENT_SIZE ];
