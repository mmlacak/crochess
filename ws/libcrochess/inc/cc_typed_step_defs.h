...
#define CC_STEPS_SIDEWAYS_PAWN_LEN (CC_STEPS_PAWN_LEN + 2)
...
// all Serpent steps == left diagonal + right diagonal + color-change
#define CC_STEPS_ALL_SERPENT_LEN (CC_STEPS_DIAGONAL_SERPENT_LEN + CC_STEPS_DIAGONAL_SERPENT_LEN + CC_STEPS_COLOR_CHANGE_SERPENT_LEN)
...
#define CC_STEPS_PAWN_DISPLACEMENT_LEN (4) // TODO :: DOCS
...
#define CC_STEPS_PAWN_DISPLACEMENT_SIZE (CC_STEPS_PAWN_DISPLACEMENT_LEN + 1) // TODO :: DOCS
...
extern CcTypedStep const CC_STEPS_PAWN_DISPLACEMENT[ CC_STEPS_PAWN_DISPLACEMENT_SIZE ]; // TODO :: DOCS
