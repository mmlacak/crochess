...
CcParsedSideEffect cc_parsed_side_effect_none( void ) {
    return cc_parsed_side_effect( CC_PSEE_None, CC_PE_None, CC_LTE_NoneLost,
                                  CC_POS_CAST_INVALID,
                                  CC_POS_CAST_INVALID,
                                  CC_PE_None );
}
...
CcParsedSideEffect cc_parsed_side_effect_en_passant( cc_piece_t pawn, CcPos distant ) {
    return cc_parsed_side_effect( CC_PSEE_EnPassant, pawn, CC_LTE_NoneLost,
                                  CC_POS_CAST_INVALID,
                                  distant,
                                  CC_PE_None );
}
...
CcParsedSideEffect cc_parsed_side_effect_castle( cc_piece_t rook, CcPos start, CcPos destination ) {
    return cc_parsed_side_effect( CC_PSEE_Castle, rook, CC_LTE_NoneLost,
                                  start,
                                  destination,
                                  CC_PE_None );
}
...
CcParsedSideEffect cc_parsed_side_effect_failed_conversion( void ) {
    return cc_parsed_side_effect( CC_PSEE_FailedConversion, CC_PE_None, CC_LTE_NoneLost,
                                  CC_POS_CAST_INVALID,
                                  CC_POS_CAST_INVALID,
                                  CC_PE_None );
}
...
CcParsedSideEffect cc_parsed_side_effect_transparency( cc_piece_t piece ) {
    return cc_parsed_side_effect( CC_PSEE_Transparency, piece, CC_LTE_NoneLost,
                                  CC_POS_CAST_INVALID,
                                  CC_POS_CAST_INVALID,
                                  CC_PE_None );
}
...
CcParsedSideEffect cc_parsed_side_effect_diversion( cc_piece_t piece ) {
    return cc_parsed_side_effect( CC_PSEE_Divergence, piece, CC_LTE_NoneLost,
                                  CC_POS_CAST_INVALID,
                                  CC_POS_CAST_INVALID,
                                  CC_PE_None );
}
...
CcParsedSideEffect cc_parsed_side_effect_resurrect( cc_piece_t piece, CcPos destination ) {
    return cc_parsed_side_effect( CC_PSEE_Resurrection, piece, CC_LTE_NoneLost,
                                  CC_POS_CAST_INVALID,
                                  destination,
                                  CC_PE_None );
}
...
CcParsedSideEffect cc_parsed_side_effect_failed_resurrection( void ) {
    return cc_parsed_side_effect( CC_PSEE_FailedResurrection, CC_PE_None, CC_LTE_NoneLost,
                                  CC_POS_CAST_INVALID,
                                  CC_POS_CAST_INVALID,
                                  CC_PE_None );
}
...
bool cc_parsed_side_effect_to_short_str( CcParsedSideEffect se,
    ...
    cc_piece_t pe = cc_parsed_side_effect_piece( se );
