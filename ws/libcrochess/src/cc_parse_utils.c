...
size_t cc_parsed_step_link_len( CcStepLinkEnum sle ) {
    switch ( sle ) {
...
CcSideEffectEnum cc_parse_side_effect_type( char const * step_an_str,
                                            bool * has_promotion_sign__o ) {
    if ( !step_an_str ) return CC_SEE_None;
...
size_t cc_parsed_side_effect_type_len( CcSideEffectEnum see,
