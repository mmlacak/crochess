                                ...
                                int * restrict rank__o )
{
    ...
    if ( *file_0_str != '\0' )
    {
        ...
        if ( !cc_variant_is_coord_on_board( cb->type, file_0 ) )
        ...
        if ( *rank_0_str != '\0' )
        {
            ...
            if ( !cc_variant_is_coord_on_board( cb->type, rank_0 ) )
            ...
            if ( *file_1_str != '\0' )
            {
                ...
                if ( !cc_variant_is_coord_on_board( cb->type, file_1 ) )
                ...
                if ( *rank_1_str != '\0' )
                {
                    ...
                    if ( !cc_variant_is_coord_on_board( cb->type, rank_1 ) )
                                     ...
                                     CcSideEffect * restrict side_effect__o )
{
    ...
    else if ( *s == '<' )
    {
        ...
        if ( islower( *( s + 1 ) ) )
        {
            ...
            if ( !cc_variant_is_coord_on_board( cb->type, dest_i ) )
                return false;
        }
        else
            return false;
        ...
        if ( isdigit( *( s + 1 ) ) )
        {
            ...
            if ( !cc_variant_is_coord_on_board( cb->type, dest_j ) )
                return false;
        }
        else
            return false;
