...
char cc_tag_as_char( CcTagType ct ) {
    switch ( CC_TAG_VALUE( ct ) ) {
        ...
        case CC_TE_CanRush : return CC_TAG_GET_MOVE_STARTER_FLAG( ct ) ? CC_TAG_CHAR_MOVE_STARTER_CAN_RUSH : CC_TAG_CHAR_CAN_RUSH;
        case CC_TE_CanCastle : return CC_TAG_GET_MOVE_STARTER_FLAG( ct ) ? CC_TAG_CHAR_MOVE_STARTER_CAN_CASTLE : CC_TAG_CHAR_CAN_CASTLE;
        case CC_TE_DelayedPromotion : return CC_TAG_GET_MOVE_STARTER_FLAG( ct ) ? CC_TAG_CHAR_MOVE_STARTER_DELAYED_PROMOTION : CC_TAG_CHAR_DELAYED_PROMOTION;
        case CC_TE_EnPassant : return CC_TAG_GET_MOVE_STARTER_FLAG( ct ) ? CC_TAG_CHAR_MOVE_STARTER_EN_PASSANT : CC_TAG_CHAR_EN_PASSANT;
        case CC_TE_PawnSacrifice : return CC_TAG_GET_MOVE_STARTER_FLAG( ct ) ? CC_TAG_CHAR_MOVE_STARTER_PAWN_SACRIFICE : CC_TAG_CHAR_PAWN_SACRIFICE;
...
CcTagType cc_tag_from_char( char c ) {
    switch ( c ) {
        ...
        case CC_TAG_CHAR_MOVE_STARTER_CAN_RUSH : return CC_TAG_SET_MOVE_STARTER_FLAG( CC_TE_CanRush );
        case CC_TAG_CHAR_MOVE_STARTER_CAN_CASTLE : return CC_TAG_SET_MOVE_STARTER_FLAG( CC_TE_CanCastle );
        case CC_TAG_CHAR_MOVE_STARTER_DELAYED_PROMOTION : return CC_TAG_SET_MOVE_STARTER_FLAG( CC_TE_DelayedPromotion );
        case CC_TAG_CHAR_MOVE_STARTER_EN_PASSANT : return CC_TAG_SET_MOVE_STARTER_FLAG( CC_TE_EnPassant );
        case CC_TAG_CHAR_MOVE_STARTER_PAWN_SACRIFICE : return CC_TAG_SET_MOVE_STARTER_FLAG( CC_TE_PawnSacrifice );
