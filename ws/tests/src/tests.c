...
char const CROCHESS_TESTS_VERSION[] = "0.0.2.38:237+20210827.165100"; // source-new-crochess-tests-version-major-minor-feature-commit+meta~breaks-place-marker
