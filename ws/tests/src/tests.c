...
char const CROCHESS_TESTS_VERSION[] = "0.0.1.268:1447+20250802.112141"; // source-new-crochess-tests-version-major-minor-feature-commit+meta~breaks-place-marker
