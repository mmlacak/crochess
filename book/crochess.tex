...
% \renewcommand{\ttdefault}{ucr} % URW Courier
% \renewcommand\ttdefault{lcmtt} % \renewcommand*\ttdefault{lcmtt} % Computer Modern Teletype L

% \usepackage{tgcursor} % TeX Gyre Cursor
% \usepackage{lmodern} % Latin Modern Mono
% \usepackage{nimbusmono} % Nimbus 15 Mono
% \usepackage{courier} % Courier, provided by URW Nimbus Mono
% \usepackage{courierten} % Courier 10 Pitch BT
...
% \renewcommand{\ttdefault}{newtxtt} % New TXTT
...
% \newcommand{\algmov}[3]{\hspace*{1em}\algfmt{#1}\hspace*{1em}\alg{#2}\hspace*{1em}\alg{#3}\\}
\newcommand{\algmov}[4][1em]{\hspace*{#1}\algfmt{#2}\hspace*{1em}\alg{#3}\hspace*{1em}\alg{#4}\\}
...
\begin{center}
    ...
    878 \textperiodcentered \textperiodcentered \textperiodcentered ~2021-01-10 04:30:18 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2021-01-10 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        d6e9e75322307ad06694fbbd51dad7db849f4026 \\ % last-commit-id-place-marker
        2021-01-08 04:29:20 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2021-01-10} \\ [0.5em] % new-commit-date-small-place-marker
