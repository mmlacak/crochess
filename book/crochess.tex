...
\begin{center}
    ...
    708 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-08-27 20:41:00 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-08-27 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        adc2de55bf4f28bb4ddce3504508f48c940e973e \\ % last-commit-id-place-marker
        2020-08-27 20:14:03 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-08-27} \\ [0.5em] % new-commit-date-small-place-marker
