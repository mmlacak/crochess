...
\begin{titlepage}
\vspace*{\stretch{2}}
\begin{center} % 2.5mm == left adr right margin difference
...
\end{center} % 2.5mm == left adr right margin difference
\vspace{\stretch{1}}
\end{titlepage}
% ---------------------------------------------------------- Title page
...
\begin{center}
    ...
    Version: 20230512.195731 \\ [2.0em] % book-new-commit-version-squished-utc-date-time-place-marker
    ...
    2023-05-12 \\ % book-new-commit-version-date-place-marker
    Zagreb, Croatia
...
\begin{center}
    ...
    \small{2023-05-12} \\ [0.5em] % book-new-commit-version-date-small-place-marker
