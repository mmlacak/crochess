...
\newcommand{\algpar}[1]{\noindent\algfmt{#1}}
\newcommand{\algmov}[5][1em]{\hspace{#1}\algfmt{#2}\hspace{1em}\alg{#3}\hspace{1em}\alg{#4}\hspace{1em}\emph{\small{#5}}\\}
...
\begin{center}
    ...
    Version: 20220110.053516 \\ [2.0em] % book-new-commit-version-squished-utc-date-time-place-marker
