...
\begin{center}
    ...
    825 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-12-08 15:35:01 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-12-08 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        1a7e5f5e7395a7fb6d0b6347cfb5660b2d07716a \\ % last-commit-id-place-marker
        2020-12-08 15:10:15 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-12-08} \\ [0.5em] % new-commit-date-small-place-marker
