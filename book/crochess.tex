...
\begin{center}
    ...
    865 \textperiodcentered \textperiodcentered \textperiodcentered ~2021-01-01 14:21:29 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2021-01-01 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        468939679eff527610d5027060faf621dd87c9ad \\ % last-commit-id-place-marker
        2020-12-30 15:41:23 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2021-01-01} \\ [0.5em] % new-commit-date-small-place-marker
