...
\usepackage[utf8]{inputenc} % For Charter, LM, and Helvetica.
% \usepackage[T1]{fontenc}

% \usepackage{lmodern} % Better then default, semi-bold.
% \usepackage{mlmodern} % Better then default, semi-bold.

\usepackage{alltt}

% \usepackage{tgcursor} % TeX Gyre Cursor % semi-bold {, }, under-bold _
% \usepackage{lmodern} % Latin Modern Mono % overrides normal font --> is ok, almost the same geometry as Charter; tt --> everything (semi-)bold, heightened
% \usepackage[lighttt]{lmodern} % Latin Modern Mono % overrides normal font --> is ok, almost the same geometry as Charter; tt --> still ugly %, uppercase heightened
% \usepackage{nimbusmono} % Nimbus 15 Mono % overrides Charter defaults; tt --> everything (semi-)bold, under-bold %, :
% \usepackage{courier} % Courier, provided by URW Nimbus Mono % semi-bold {, }, under-bold _
% \usepackage{courierten} % Courier 10 Pitch BT % Needs T1 (?)
% \usepackage[scaled]{beramono} % Bera Mono % With T1 butch, squary font

% \usepackage[zerostyle=d]{newtxtt} %% Various versions of zeros available. See documentation for details
% \usepackage{newtxtt} %% Various versions of zeros available. See documentation for details
% \renewcommand{\ttdefault}{newtxtt} % New TXTT % Not courier, everything semi-bold, heightened

\renewcommand{\ttdefault}{pcr} % Adobe Courier % semi-bold {, }, under-bold _
% \renewcommand{\ttdefault}{ucr} % URW Courier % Needs T1 (?)
% \renewcommand\ttdefault{lcmtt} % Computer Modern Teletype L % everything (semi-)bold, heightened, no italics
% \renewcommand*\ttdefault{lcmtt} % Computer Modern Teletype L % everything (semi-)bold, heightened, no italics
\usepackage[T1]{fontenc} % Used for Couriers, and other TT fonts.
...
\begin{center}
    ...
    Version: 20230906.004602 \\ [2.0em] % book-new-commit-version-squished-utc-date-time-place-marker

    \emph{Legal} \\
    This book is published as Public Domain work; \\
    under Creative Commons Zero license, \\
    where Public Domain is not applicable. \\
    ...
    \href{https://en.wikipedia.org/wiki/Creative\_Commons\_license\#Zero\_/\_public\_domain}{https://en.wikipedia.org/wiki/Creative\_Commons\_license\\\#Zero\_/\_public\_domain} \\ [2.0em]

    \emph{Third, revised edition} \\
    2023-09-06 \\ % book-new-commit-version-date-place-marker
    Zagreb, Croatia

    \vfill
    \includegraphics[height=1.0\baselineskip, keepaspectratio=true]{Public_Domain_Mark_button.svg.png}~\includegraphics[height=1.0\baselineskip, keepaspectratio=true]{CC0_button.svg.png}
    \vspace*{0.7\baselineskip}
\end{center}
\clearpage % ..........................................................
% ------------------------------------------------------ Publisher page
...
\begin{center}
    ...
    \small{2023-09-06} \\ [0.5em] % book-new-commit-version-date-small-place-marker
...
\vfill
\hspace*{\fill}{\includegraphics[height=1.0\baselineskip, keepaspectratio=true]{Public_Domain_Mark_button.svg.png}~\includegraphics[height=1.0\baselineskip, keepaspectratio=true]{CC0_button.svg.png}}
\clearpage % ..........................................................
% ------------------------------------------- Challenge, end cover page
