...
\begin{center}
    ...
    797 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-11-24 17:50:01 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-11-24 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        ddd8e68a552e8a984ae4a45cefa22f9ed625cd5e \\ % last-commit-id-place-marker
        2020-11-24 16:55:26 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-11-24} \\ [0.5em] % new-commit-date-small-place-marker
