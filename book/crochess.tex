...
\newcommand{\alg}[1]{\algb{#1}} % Default, use this!
...
\begin{center}
    ...
    853 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-12-23 12:37:04 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-12-23 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        d0c4522fec46e03aba3aea5749afcd4554138704 \\ % last-commit-id-place-marker
        2020-12-23 07:06:35 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-12-23} \\ [0.5em] % new-commit-date-small-place-marker
