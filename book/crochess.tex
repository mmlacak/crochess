...
\begin{center}
    ...
    658 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-07-16 14:10:17 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-07-16 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        c1ef63256a11a9e723af5a66fddc5909ab319d5e \\ % last-commit-id-place-marker
        2020-07-15 16:22:38 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-07-16} \\ [0.5em] % new-commit-date-small-place-marker
