...
\begin{center}
    ...
    620 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-06-24 05:59:07 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-06-24 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Last commit} \\
        656a338c958033e263628d352cd8e5e1db52799a \\ % last-commit-id-place-marker
        2020-06-24 05:29:24 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-06-24} \\ [0.5em] % new-commit-date-small-place-marker
