...
\begin{center}
    ...
    749 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-11-05 17:21:06 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    \tiny{
        \emph{Parent commit} \\
        48ea6a7172f1f3cd3a94999f04378548f435befd \\ % last-commit-id-place-marker
        2020-10-11 21:15:19 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
