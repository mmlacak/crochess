...
\begin{center}
    ...
    727 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-09-18 13:01:24 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-09-18 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        25ebb9a70ce30baabffe2fb03a823870ae50ae4 \\ % last-commit-id-place-marker
        2020-09-17 13:12:33 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-09-18} \\ [0.5em] % new-commit-date-small-place-marker
