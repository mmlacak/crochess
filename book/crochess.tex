...
\begin{center}
    ...
    821 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-12-06 02:40:24 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    \tiny{
        \emph{Parent commit} \\
        f21cfe486ae8217cca0c95b527073a7c0282f3a \\ % last-commit-id-place-marker
        2020-12-06 00:52:34 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
