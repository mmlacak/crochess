...
\begin{center}
    ...
    856 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-12-25 17:49:45 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    \tiny{
        \emph{Parent commit} \\
        396343ff5eb9699806f844997d5bd128937f76f9 \\ % last-commit-id-place-marker
        2020-12-25 16:22:49 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
