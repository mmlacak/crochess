...
\begin{center}
    ...
    6003ac5537cf3ce06d4cf099b9fb48f428260086 \\ % commit-id-place-marker
    2020-05-17 02:11:11 UTC \\ % commit-date-time-place-marker
    \vspace*{-0.5em} 
    \tiny{Commit id, date and time are from parent commit.}\normalsize{} \\ [2.0em]
    ...
    2020-05-17 \\ % commit-date-place-marker
    Zagreb, Croatia
...
\begin{center}
    ...
    \small{2020-05-17} \\ [0.5em] % commit-date-small-place-marker
