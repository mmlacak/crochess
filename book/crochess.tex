...
\begin{center}
    ...
    713 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-08-29 00:29:30 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-08-29 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        70f6f4c7066befbd34eec7cd01235823837f84ce \\ % last-commit-id-place-marker
        2020-08-28 23:58:29 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-08-29} \\ [0.5em] % new-commit-date-small-place-marker
