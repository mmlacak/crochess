...
\begin{center}
    ...
    733 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-09-20 13:48:07 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    \tiny{
        \emph{Parent commit} \\
        4923f9cbb086709f56604595f5b26953d0a929ee \\ % last-commit-id-place-marker
        2020-09-20 13:28:44 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
