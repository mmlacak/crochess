...
\begin{center}
    ...
    893 \textperiodcentered \textperiodcentered \textperiodcentered ~2021-01-13 08:53:43 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2021-01-13 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        0e0d6422ce6c9fc49fe91ccd7ac969347732c9a2 \\ % last-commit-id-place-marker
        2021-01-13 07:50:45 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2021-01-13} \\ [0.5em] % new-commit-date-small-place-marker
