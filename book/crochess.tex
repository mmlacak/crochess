...
\begin{center}
    ...
    666 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-07-19 01:46:34 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-07-19 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        d394b45de3a2e1079d4dc8949708dbfd35260ae2 \\ % last-commit-id-place-marker
        2020-07-19 01:28:51 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-07-19} \\ [0.5em] % new-commit-date-small-place-marker
