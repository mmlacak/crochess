...
\newcommand{\algc}[1]{\algbi{#1}}
\newcommand{\algfmt}[1]{\algn{#1}}
...
\begin{center}
    ...
    855 \textperiodcentered \textperiodcentered \textperiodcentered ~2020-12-25 16:22:49 UTC \textperiodcentered \textperiodcentered \textperiodcentered ~master \\ [2.0em] % new-commit-count-date-time-branch-place-marker
    ...
    2020-12-25 \\ % new-commit-date-place-marker
    Zagreb, Croatia
    ...
    \tiny{
        \emph{Parent commit} \\
        8e305487ae0eadb44c7d4edf940deba67194a3e1 \\ % last-commit-id-place-marker
        2020-12-23 13:16:49 UTC \\ % last-commit-date-time-place-marker
    }
    \normalsize{}
    \vspace{0.05\textheight}
\end{center}
...
\begin{center}
    ...
    \small{2020-12-25} \\ [0.5em] % new-commit-date-small-place-marker
