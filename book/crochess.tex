...
% \usepackage{courierten} % Courier 10 Pitch BT % Not good, can't render <, >, |, everything semi-bold
...
% \renewcommand{\ttdefault}{ucr} % URW Courier % Not good, can't render <, >, |, semi-bold {, }
...
\begin{center}
    ...
    Version: 20220506.014445 \\ [2.0em] % book-new-commit-version-squished-utc-date-time-place-marker
    ...
    2022-05-06 \\ % book-new-commit-version-date-place-marker
    Zagreb, Croatia
...
\begin{center}
    ...
    \small{2022-05-06} \\ [0.5em] % book-new-commit-version-date-small-place-marker
