...
class SceneMix(SceneMixin, \
    ...
    def _get_recent_scene_method_names(self):
        return  [
                    # 'scn_o_15_starchild_activated_wave_not_teleporting_init', \
                    # 'scn_o_16_starchild_activated_wave_not_teleporting_end', \
                    'scn_o_17_starchild_activated_wave_not_moving_a_star', \
                    ...
                    # 'scn_o_24_trance_journey_started_by_shaman', \
                ]
