...
class SceneMix( SceneMixin, \
    ...
    def _get_recent_scene_method_names( self ):
        return  [
                    # 'scn_mv_84_activation_after_en_passant_init', \
                    # 'scn_mv_85_activation_after_en_passant_end', \
                    # 'scn_mv_86_en_passant_denied_init', \
                    # 'scn_mv_87_en_passant_denied_pawn_activated', \
                    'scn_mv_88_en_passant_denied_end', \
