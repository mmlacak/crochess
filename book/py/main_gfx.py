...
Licensed under 3-clause (modified) BSD license. See LICENSE.txt for details.''')
    ...
    collections.add_argument('-s', '--scenes', action='store_true', default=False, help='render recent scenes, move examples')
    collections.add_argument('-t', '--all_scenes', action='store_true', default=False, help='render all scenes, move examples')
...
#     is_final = args.final
    ...
    if args.all or args.all_scenes or args.scenes:
        render.render_all_example_scenes(do_all_scenes=args.all_scenes)
