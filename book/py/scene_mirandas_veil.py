...
class SceneMirandasVeilMixin:
    ...
    def scn_mv_05_wave_no_activating_blocked_piece(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_05_wave_no_activating_blocked_piece', bt)
    ...
    def scn_mv_34_activated_piece_checking(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_34_activated_piece_checking', bt, height=9.7)
