...
class SceneMirandasVeilMixin:
    ...
    def scn_mv_36_reactivating_piece_init(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_36_reactivating_piece_init', bt)
    ...
    def scn_mv_37_reactivating_piece_steps(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_37_reactivating_piece_steps', bt)
    ...
    def scn_mv_38_pinned_piece_cascaded_init(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_38_pinned_piece_cascaded_init', bt) # , height=13.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_39_pinned_piece_cascaded_1(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_39_pinned_piece_cascaded_1', bt) # , height=13.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_40_pinned_piece_cascaded_end(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_40_pinned_piece_cascaded_end', bt) # , height=13.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_41_pinned_piece_cascaded_2(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_41_pinned_piece_cascaded_2', bt) # , height=13.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_42_activated_piece_check_init(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_42_activated_piece_check_init', bt, height=13.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_43_activated_piece_check_cascade(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_43_activated_piece_check_cascade', bt, height=13.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_44_static_move_is_illegal_init(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_44_static_move_is_illegal_init', bt, height=9.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_45_static_move_is_illegal_end(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_45_static_move_is_illegal_end', bt, height=9.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_46_static_piece_is_legal_init(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_46_static_piece_is_legal_init', bt) # , height=9.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_47_static_piece_is_legal_end(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_47_static_piece_is_legal_end', bt) # , height=9.3) # , y=0.7, height=12.5)
        rect = (0.05, 0.8, 0.65, 0.1)
    ...
    def scn_mv_48_delayed_promotion_is_legal_init(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_48_delayed_promotion_is_legal_init', bt, y=10.7, height=3.3)
    ...
    def scn_mv_49_delayed_promotion_is_legal_end(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_49_delayed_promotion_is_legal_end', bt, y=10.7, height=3.3)
    ...
    def scn_mv_50_wave_cascading_opponent(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_50_wave_cascading_opponent', bt)
    ...
    def scn_mv_51_cascaded_opponent_capturing(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_51_cascaded_opponent_capturing', bt)
    ...
    def scn_mv_52_cascaded_opponent_promoting(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_52_cascaded_opponent_promoting', bt)
    ...
    def scn_mv_53_cascade_self_checkmate_init(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_53_cascade_self_checkmate_init', bt)
    ...
    def scn_mv_54_cascade_self_checkmate_end(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_54_cascade_self_checkmate_end', bt)
    ...
    def scn_mv_55_wave_blocked_init(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_55_wave_blocked_init', bt)
    ...
    def scn_mv_56_wave_blocked_end(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_56_wave_blocked_end', bt)
    ...
    def scn_mv_57_wave_block_castling_king(self, bt=BoardType.MirandasVeil):

        scene = Scene('scn_mv_57_wave_block_castling_king', bt, height=1)
