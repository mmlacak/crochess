...
class SceneMirandasVeilMixin:
    ...
    def scn_mv_05_cascading_rook(self, bt=BoardType.MirandasVeil):
        # move_wave_cascading_rook

        scene = Scene('scn_mv_05_cascading_rook', bt, width=9, height=9)
    ...
    def scn_mv_06_cascading_wave_1(self, bt=BoardType.MirandasVeil):
        # move_wave_cascading_wave_1

        scene = Scene('scn_mv_06_cascading_wave_1', bt, width=9, height=9)
    ...
    def scn_mv_07_cascading_wave_2(self, bt=BoardType.MirandasVeil):
        # move_wave_cascading_wave_2

        scene = Scene('scn_mv_07_cascading_wave_2', bt, width=9, height=9)
    ...
    def scn_mv_08_cascading_rook_2nd_time(self, bt=BoardType.MirandasVeil):
        # move_wave_cascading_rook_b

        scene = Scene('scn_mv_08_cascading_rook_2nd_time', bt, width=9, height=9)
    ...
    def scn_mv_09_cascading_wave_1_2nd_time(self, bt=BoardType.MirandasVeil):
        # move_wave_cascading_wave_1_b

        scene = Scene('scn_mv_09_cascading_wave_1_2nd_time', bt, width=9, height=9)
    ...
    def scn_mv_10_cascading_queen(self, bt=BoardType.MirandasVeil):
        # move_wave_cascading_queen

        scene = Scene('scn_mv_10_cascading_queen', bt, width=9, height=9)
    ...
    def scn_mv_11_cascading_wave_2_2nd_time(self, bt=BoardType.MirandasVeil):
        # move_wave_cascading_wave_2_b

        scene = Scene('scn_mv_11_cascading_wave_2_2nd_time', bt, width=9, height=9)
    ...
    def scn_mv_12_cascading_wave_1_3rd_time(self, bt=BoardType.MirandasVeil):
        # move_wave_cascading_wave_1_c

        scene = Scene('scn_mv_12_cascading_wave_1_3rd_time', bt, width=9, height=9)
    ...
    def scn_mv_13_cascading_end(self, bt=BoardType.MirandasVeil):
        # move_wave_cascading_end

        scene = Scene('scn_mv_13_cascading_end', bt, width=9, height=9)
    ...
    def scn_mv_14_casc_oppo_light_queen(self, bt=BoardType.MirandasVeil):
        # move_wave_opponent_light_queen

        scene = Scene('scn_mv_14_casc_oppo_light_queen', bt, width=9, height=9)
    ...
    def scn_mv_15_casc_oppo_light_wave(self, bt=BoardType.MirandasVeil):
        # move_wave_opponent_light_wave

        scene = Scene('scn_mv_15_casc_oppo_light_wave', bt, width=9, height=9)
    ...
    def scn_mv_16_casc_oppo_dark_wave(self, bt=BoardType.MirandasVeil):
        # move_wave_opponent_dark_wave

        scene = Scene('scn_mv_16_casc_oppo_dark_wave', bt, width=9, height=9)
    ...
    def scn_mv_17_casc_oppo_dark_queen(self, bt=BoardType.MirandasVeil):
        # move_wave_opponent_dark_queen

        scene = Scene('scn_mv_17_casc_oppo_dark_queen', bt, width=9, height=9)
    ...
    def scn_mv_18_casc_oppo_end(self, bt=BoardType.MirandasVeil):
        # move_wave_opponent_end

        scene = Scene('scn_mv_18_casc_oppo_end', bt, width=9, height=9)
    ...
    def scn_mv_19_activating_rush_pawn_init(self, bt=BoardType.MirandasVeil):
        # move_wave_activating_pawn_init

        scene = Scene('scn_mv_19_activating_rush_pawn_init', bt) # , width=5, height=8)
    ...
    def scn_mv_20_activating_rush_pawn_end(self, bt=BoardType.MirandasVeil):
        # move_wave_activating_pawn_end

        scene = Scene('scn_mv_20_activating_rush_pawn_end', bt)
