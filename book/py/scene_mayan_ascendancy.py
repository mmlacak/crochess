...
class SceneMayanAscendancyMixin:
    ...
    def scn_ma_11_convert_rook_castling_init(self, bt=BoardType.MayanAscendancy):
        ...
        scene = Scene('scn_ma_11_convert_rook_castling_init', bt, width=12, height=2)
        ...
        scene.board.set_piece(5, 0, piece=PieceType.Bishop)
        scene.board.set_piece(6, 0, piece=PieceType.King)
    ...
    def scn_ma_12_convert_rook_castling_end(self, bt=BoardType.MayanAscendancy):
        ...
        scene = Scene('scn_ma_12_convert_rook_castling_end', bt, width=12, height=2)

        scene.board.set_piece(0, 0, piece=PieceType(PieceType.Rook))
        scene.board.set_piece(0, 1, piece=PieceType(PieceType.Queen))
        scene.board.set_piece(6, 1, piece=PieceType.Bishop)
        scene.board.set_piece(6, 0, piece=PieceType(PieceType.King))
        ...
        # direction <1,1>
        scene.append_arrow( 5, 0, 6, 1, mark_type=MarkType.Blocked )
    ...
    def scn_ma_13_convert_rook_castling(self, bt=BoardType.MayanAscendancy):
        ...
        scene = Scene('scn_ma_13_convert_rook_castling', bt, width=12, height=2)

        scene.board.set_piece(4, 0, piece=PieceType.Rook)
        scene.board.set_piece(0, 1, piece=PieceType.Queen)
        scene.board.set_piece(3, 0, piece=PieceType.King)
        ...
        scene.append_text("K", 6, 0, mark_type=MarkType.Blocked)
    ...
    def scn_ma_14_convert_pawn_rush_init(self, bt=BoardType.MayanAscendancy):
        ...
        scene = Scene('scn_ma_14_convert_pawn_rush_init', bt, width=3, height=6)

        startR = (0, 4)
        startP = (0, 1)
        scene.board.set_piece(*startR, piece=PieceType.Rook)
        scene.board.set_piece(*startP, piece=PieceType.Pyramid)
        scene.board.set_piece(1, 1, piece=-PieceType.Pawn)
        scene.board.set_piece(1, 0, piece=PieceType.King)
    ...
    def scn_ma_15_convert_pawn_rush_end(self, bt=BoardType.MayanAscendancy):
        ...
        scene = Scene('scn_ma_15_convert_pawn_rush_end', bt, width=3, height=6)

        scene.board.set_piece(0, 1, piece=PieceType.Rook)
        scene.board.set_piece(1, 1, piece=PieceType.Pawn)
        scene.board.set_piece(1, 0, piece=PieceType.King)
        scene.board.set_piece(2, 3, piece=-PieceType.Pawn)
