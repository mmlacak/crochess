...
class ColorsItem(object):
    def __init__(self, piece, star, monolith, field, arrow, text, marker):
    ...
    def from_tuple(tpl):
        return  ColorsItem( piece=ColorsShade.from_tuple( (tpl[0], tpl[1], tpl[2], tpl[3]) ), \
                            ...
                            field=ColorsShade.from_tuple( (tpl[10], tpl[11], tpl[12], tpl[13]) ), \
                            arrow=ColorsMark.from_tuple( (tpl[14], tpl[15], tpl[16], tpl[17], tpl[18], tpl[19], tpl[20], tpl[21]) ), \
                            text=ColorsMark.from_tuple( (tpl[22], tpl[23], tpl[24], tpl[25], tpl[26], tpl[27], tpl[28], tpl[29]) ), \
                            marker=ColorsMark.from_tuple( (tpl[30], tpl[31], tpl[32], tpl[33], tpl[34], tpl[35], tpl[36], tpl[37]) ) )
