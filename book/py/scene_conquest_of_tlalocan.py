...
class SceneConquestOfTlalocanMixin:
    ...
    def scn_cot_011_step_activated_wave_step_fields( self, bt=BoardType.ConquestOfTlalocan ):

        scene = Scene( 'scn_cot_011_step_activated_wave_step_fields', bt )
    ...
    def scn_cot_012_step_activated_wave_capture_fields( self, bt=BoardType.ConquestOfTlalocan ):

        scene = Scene( 'scn_cot_012_step_activated_wave_capture_fields', bt )
    ...
    def scn_cot_014_capture_activated_wave_step_fields( self, bt=BoardType.ConquestOfTlalocan ):

        scene = Scene( 'scn_cot_014_capture_activated_wave_step_fields', bt )
    ...
    def scn_cot_015_capture_activated_wave_capture_fields( self, bt=BoardType.ConquestOfTlalocan ):

        scene = Scene( 'scn_cot_015_capture_activated_wave_capture_fields', bt )
    ...
    def scn_cot_030_own_shaman_is_divergent_init(self, bt=BoardType.ConquestOfTlalocan):
        ...
        # scene.append_text( "Q", *start_Q, mark_type=MarkType.Blocked, corner=Corner.UpperRightFieldMarker ) # TODO :: DELETE
    ...
    def scn_cot_031_own_shaman_is_divergent_end(self, bt=BoardType.ConquestOfTlalocan):
        ...
        for rel in GS.DEFAULT_KING_REL_MOVES:
            ...
            for i, arrow in enumerate( coords_W__Q() ):
                if rel in [ (-1, -1), (1, 1), ]:
                    ...
                    # mark_type = MarkType.Illegal if i == 4 else # TODO :: DELETE
        ...
        # scene.append_text( "Q", *start_Q, mark_type=MarkType.Illegal, corner=Corner.UpperRightFieldMarker ) # TODO :: DELETE
    ...
    def scn_cot_051_diverging_shaman_from_opponents( self, bt=BoardType.ConquestOfTlalocan ):

        scene = Scene( 'scn_cot_051_diverging_shaman_from_opponents', bt )
    ...
    def scn_cot_052_wave_divergence_init(self, bt=BoardType.ConquestOfTlalocan):
        ...
        # scene.append_text( "Q", *start_Q, mark_type=MarkType.Legal, corner=Corner.UpperRight ) # TODO :: DELETE
    ...
    def scn_cot_053_wave_divergence_1(self, bt=BoardType.ConquestOfTlalocan):
        ...
        # scene.append_text( "Q", *start_Q, mark_type=MarkType.Illegal, corner=Corner.UpperRight ) # TODO :: DELETE
    ...
    # def scn_cot_059_diverging_first_piece(self, bt=BoardType.ConquestOfTlalocan):

    #     scene = Scene( 'scn_cot_059_diverging_first_piece', bt, width=8, height=8 )
    ...
    # def scn_cot_060_diverged_first_piece_illegal(self, bt=BoardType.ConquestOfTlalocan):

    #     scene = Scene( 'scn_cot_060_diverged_first_piece_illegal', bt, width=8, height=8 )
    ...
    # def scn_cot_061_diverging_activated_piece(self, bt=BoardType.ConquestOfTlalocan):

    #     scene = Scene( 'scn_cot_061_diverging_activated_piece', bt, width=8, height=8 )
    ...
    # def scn_cot_062_diverged_activated_piece_legal(self, bt=BoardType.ConquestOfTlalocan):

    #     scene = Scene( 'scn_cot_062_diverged_activated_piece_legal', bt, width=8, height=8 )
