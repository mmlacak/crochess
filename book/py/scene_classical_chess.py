...
class SceneClassicalChessMixin:
    ...
    def scn_mv_99_en_passant_legal_init( self, bt=BoardType.MirandasVeil ):

        scene = Scene( 'scn_mv_99_en_passant_legal_init', bt, height=8.3, width=6.3 )
    ...
    def scn_mv_100_en_passant_legal_end( self, bt=BoardType.MirandasVeil ):

        scene = Scene( 'scn_mv_100_en_passant_legal_end', bt, height=8.3, width=6.3 )
