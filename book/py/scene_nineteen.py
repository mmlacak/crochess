...
class SceneNineteenMixin:
    ...
    def scn_n_31_only_one_queen(self, bt=BoardType.Nineteen):

        scene = Scene('scn_n_31_only_one_queen', bt)
    ...
    def scn_n_32_new_castling_init( self, bt=BoardType.Nineteen ):
        ...
        scene = Scene( 'scn_n_32_new_castling_init', bt, height=2.3 )
    ...
    def scn_n_33_new_castling_end( self, bt=BoardType.Nineteen ):

        scene = Scene( 'scn_n_33_new_castling_end', bt, height=2.3 )
