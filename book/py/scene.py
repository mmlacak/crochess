...
class Scene(ScenePegasusMixin, \
    ...
    TEXT_COLORS_DICT =  { BoardType.none:                    ("#FF00FF", "#303030", "#303030", "#808080"),
                          ...
                          BoardType.OddMayanAscendancy:      ("#FF00FF", "#303030", "#303030", "#7F007F"), # ("#FF00FF", "#303030", "#303030", "#808080"), # ("#FF00FF", "#303030", "#7F007F", "#7F007F"),
                          BoardType.MayanAscendancy:         ("#FF00FF", "#303030", "#303030", "#7F007F"), # ("#FF00FF", "#303030", "#303030", "#808080"), # ("#FF00FF", "#303030", "#7F007F", "#7F007F"),
