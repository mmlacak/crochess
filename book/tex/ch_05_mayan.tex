...
\huge{}
TODO :: remove castling of converted Rook \
...
Moving Bishop out of the way, King can now castle to any numbered field. Rook would be
moved next to the King, onto the inner field, i.e. closer to King's initial position.
...
To actually perform castling, all the other requirements from Classical Chess has to be
satisfied as well.
