...
Momentum is count of step fields traveled over by piece. Pyramid receives
...
\textbf{\huge{TODO : finish this}}

* activated by any own piece
* activating piece captures field at which Pyramid stands
* moves as Rook
* restricted by momentum
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_move_pyramid_cascading_init.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/17_move_pyramid_cascading_activated_1.png}
