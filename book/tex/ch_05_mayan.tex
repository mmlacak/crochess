...
\label{sec:Mayan Ascendancy/Pyramid/Activation/Activation by Pawn}
...
Pawns can activate Pyramid on own capture-field giving it 1 momentum, see Pawn A.
Pawns can't activate Pyramids on step-fields, and are blocked from moving further,
see Pawns B and rushing C.
