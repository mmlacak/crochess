...
even if Pyramid would capture any other piece on the same field.
...
% \centering
\end{figure}
Bellow, King is not under attack from Pyramid.
...
% \centering
\end{figure}
Bishop, for example, can be captured without any hindrance.
