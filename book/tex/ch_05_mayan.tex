...
if special move has a step crossing two fields at once. When rushing, Pawn's
first step is always across 2 fields; still, both fields are counted towards
momentum, since rushing Pawn can be blocked by a piece on both fields.
