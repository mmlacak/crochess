...
In the example to the left, rush fields are numbered. Longer rush also opens more opportunity
for opponent to perform en passant.
...
Castling is essentially the same as it is in Classical Chess, only difference is that King can
move either 2 or 3 fields across. All other constraints from Classical Chess still applies,
described in detail here: \href{http://en.wikipedia.org/wiki/Castling}{http://en.wikipedia.org/wiki/Castling}.
...
field next to it, i.e. closer to center.
