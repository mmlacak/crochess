...
step-fields, so e.g. Pyramid cannot be activated on them (green arrows). \newline
\indent
Presence of opponent's pieces is relevant only at the start of Grenadier's ply.
Movement limits depends on size of a chessboard. Grenadier can capture only at
closest neighboring fields at all 4 diagonals (red arrows).
