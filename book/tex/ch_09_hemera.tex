...
\addcontentsline{toc}{section}{Umbrella Pawns}

\vspace*{-1.2\baselineskip}
\noindent
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_08_umbrella_pawns.png}
...
% In this variant, Pawns (own or converted opponent's Pawns) can be rushed 7 or 8 fields, depending if they
% were in first or second Pawn row. Opponent's Pawns converted in own figure row can be rushed up to 9 fields.
% Umbrella Pawns can be rushed 5 or 6 fields, depending how close their starting position is to opponent.
In this variant, Pawns can be rushed 7 (Pawn A) or 8 (B) fields, depending if they were in first or second Pawn row.
Umbrella Pawns can be rushed 5 (Pawn C) or 6 (D) fields, depending how close their starting position is to opponent.

% Opponent's Pawns converted in umbrella rows or in starting fields of umbrella Pawns cannot be rushed.
