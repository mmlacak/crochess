...
\hyperref[fig:scn_n_16_sideways_pawn_activated_wave]{Wave activated by sideways Pawn}.
Direction, once chosen, cannot be changed for duration of a ply. Wave is not
limited by received momentum, and so can move until end of a chessboard is
reached. Wave activated on step-fields cannot activate Pyramid.
...
duration of a ply. Wave is not limited by received momentum, and so can move until
end of a chessboard is reached. Wave activated on a capture-field can activate a
Pyramid.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_26_stepping_scout_does_not_activate_pyramid.png}
\vspace*{-1.3\baselineskip}
\caption{Pyramid can't be activated}
\label{fig:scn_hd_26_stepping_scout_does_not_activate_pyramid}
\end{figure}

\vspace*{-0.5\baselineskip}
. . .

\TODO :: Activating Pyramid
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_27_stepping_scouts_cascade_pyramids.png}
\vspace*{-1.3\baselineskip}
\caption{Pyramids cascaded by stepping Scouts}
\label{fig:scn_hd_27_stepping_scouts_cascade_pyramids}
\end{figure}
...
\addcontentsline{toc}{subsubsection}{Transitions}
