...
% \begin{wrapfigure}[1]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_60_multiple_rushes_init.png}
% \vspace*{-0.4\baselineskip}
% \caption{Rushing multiple pieces}
% \label{fig:scn_hd_60_multiple_rushes_init}
% \end{wrapfigure}
% . . .
%
...
% \begin{wrapfigure}[1]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_61_multiple_rushes_end.png}
% \vspace*{-0.4\baselineskip}
% \caption{Capturing one by en passant}
% \label{fig:scn_hd_61_multiple_rushes_end}
% \end{wrapfigure}
% . . .
%
% \vspace*{12.9\baselineskip}
