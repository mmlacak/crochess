...
\centering
\includegraphics[width=0.35\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_17_scout_forking_steps_major.png}
\vspace*{-0.3\baselineskip}
\caption{Forking steps}
\label{fig:scn_hd_17_scout_forking_steps_major}
\end{wrapfigure}
...
\end{wrapfigure}
Scout's horizontal and vertical steps are not capture-steps, and so can be blocked.
...
the other, after choice (forking step) is being made.
