...
% \centering
% \includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_24_grenadier_extended_capture_fields.png}
% \vspace*{-0.5\baselineskip}
% \caption{Additional capture-fields}
% \label{fig:scn_hd_24_grenadier_extended_capture_fields}
% \end{wrapfigure}
...
% \begin{wrapfigure}[8]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_25_grenadier_extended_captures.png}
% \vspace*{-0.5\baselineskip}
% \caption{Capturing}
% \label{fig:scn_hd_25_grenadier_extended_captures}
% \end{wrapfigure}
...
% \begin{wrapfigure}[8]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_26_grenadier_blocked_capture.png}
% \vspace*{-0.5\baselineskip}
% \caption{Blocked}
% \label{fig:scn_hd_26_grenadier_blocked_capture}
% \end{wrapfigure}
...
% \noindent
% \begin{figure}[!h]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_27_grenadier_complete_extended_pattern.png}
% \vspace*{-1.3\baselineskip}
% \caption{Complete movement pattern}
% \label{fig:scn_hd_27_grenadier_complete_extended_pattern}
% \end{figure}
