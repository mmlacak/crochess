...
in all subsequent steps, until move is done.

Note, for Centaur move to be legal, all steps must end up on the chessboard.
...
\begin{wrapfigure}{l}{0.4\textwidth}
\centering
\includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_01_centaur_same_color.png}
...
\subsubsection*{Out of board step}
\addcontentsline{toc}{subsubsection}{Out of board step}
...
Here, light grey fields surrounding chessboard are virtual fields made as an
extension of the grid imposed by said chessboard. It's illegal to step outside
chessboard, and all subsequent steps are also illegal. That means, Centaur
cannot reach fields 1 and 2 from starting position with selected directions,
