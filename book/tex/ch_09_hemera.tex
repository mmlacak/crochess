...
\TODO :: limited by both steps count (5), and momentum received
...
opponent's piece to capture (here, dark Bishop). Grenadier can also take any diagonal
capture-step, before taking any other step (here, capturing dark Knight).
...
\vspace*{-0.7\baselineskip}
In close quarters, Grenadier can also take one step more than count of opponent's
pieces on its grenadier-fields either to the left, or to the right; here, three
opponent's pieces grants four horizontal steps. After each step Grenadier can
optionally capture opponent's piece with its associated forked capture-step (here,
dark Queen).
