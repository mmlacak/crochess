...
here, light Scout can capture dark Knight by left-down step.
...
\begin{wrapfigure}[1]{l}{0.41\textwidth}
\centering
\includegraphics[width=0.4\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_23_scout_close_quarters_end.png}
\vspace*{-0.5\baselineskip}
