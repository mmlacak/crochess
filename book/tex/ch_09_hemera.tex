...
to the sides. Forward movement is the same as Pawn's; light Scout moves upward,
while dark Scout move downward. Count of steps Scout can make depends on size of
a chessboard; in this variant Scout can make up to 5 steps.
...
\TODO :: make example for capture after movement

Like Pawn, Scout can capture only on its first step in a ply, and cannot capture
after a few steps has been made; for instnce, Scout cannot capture after it's made
...
% \centering
% \includegraphics[width=0.4\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_19_scout_close_quarters_init.png}
% \vspace*{-0.5\baselineskip}
% \caption{Close quarters start}
% \label{fig:scn_hd_19_scout_close_quarters_init}
% \end{wrapfigure}
% For a first step, Scout can choose any scout-field, if opponent's piece is present
% on its scout-field. Steps can be blocked by e.g. opponent's piece (here, Bishop).
% Scout can also capture on \hyperref[fig:scn_hd_15_scout_movement]{backward diagonals};
% here, light Scout can capture dark Knight by left-down step, thus ending its ply.
...
% \centering
% \includegraphics[width=0.4\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_22_scout_close_quarters_step_3.png}
% \vspace*{-0.5\baselineskip}
% \caption{Close quarters step 3}
% \label{fig:scn_hd_22_scout_close_quarters_step_3}
% \end{wrapfigure}
% . . .
...
% \begin{wrapfigure}[1]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.35\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_23_scout_close_quarters_end.png}
% \vspace*{-0.5\baselineskip}
% \caption{Close quarters end}
% \label{fig:scn_hd_23_scout_close_quarters_end}
% \end{wrapfigure}
% . . .
