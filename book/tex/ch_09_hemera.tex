...
\label{fig:13_scout}
\end{wrapfigure}
Scout is a more mobile relative of a Pawn. Like Pawn, Scout can rush, and can be
captured by en passant. Unlike Pawn, Scout cannot be promoted. Pawns can be pomoted
to Scouts.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_15_scout_initial_positions.png}
\caption{Scouts}
\label{fig:scn_hd_15_scout_initial_positions}
\end{figure}
