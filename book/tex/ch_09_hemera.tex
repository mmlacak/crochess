...
\vspace*{-0.5\baselineskip}
Wave activated by Scout on its step-fields can move as Scout does: left, right,
or forward (towards opponent's initial positions); the same as
...
\vspace*{-0.5\baselineskip}
Wave activated by Scout on its capture-fields can move as Scout does: diagonally
left, or right, towards own initial positions. This is similar to
