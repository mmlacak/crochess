...
limit depends on size of a chessboard. \newline
\indent
Here, light Scout is activated by own Queen via Wave. Wave C is out of reach for
light Scout, even though it received 11 momentum.

Activated Scout uses received momentum for movement, and transfers all of
remaining momentum to the piece it activates. \newline
\indent
Here, light Scout can activate Wave B, and transfer to it remaining 7 momentum.
...
\hyperref[fig:scn_mv_21_wave_activation_by_capture_pawn]{Wave activated by Pawn on its capture-field},
