...
% \noindent
% \begin{figure}[!h]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_19_grenadier_extended_steps.png}
% \vspace*{-1.3\baselineskip}
...
% \begin{wrapfigure}[1]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_20_grenadier_capture_fields.png}
% \vspace*{-0.5\baselineskip}
% \caption{Capture-fields}
% \label{fig:scn_hd_20_grenadier_capture_fields}
% \end{wrapfigure}
% . . .
...
\centering
\includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_21_grenadier_extended_capture_fields.png}
\vspace*{-0.5\baselineskip}
\caption{Additional capture-fields}
\label{fig:scn_hd_21_grenadier_extended_capture_fields}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_22_grenadier_extended_captures.png}
\vspace*{-0.5\baselineskip}
\caption{Capturing}
\label{fig:scn_hd_22_grenadier_extended_captures}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_23_grenadier_blocked_capture.png}
\vspace*{-0.5\baselineskip}
\caption{Blocked}
\label{fig:scn_hd_23_grenadier_blocked_capture}
\end{wrapfigure}
