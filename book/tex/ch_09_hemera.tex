...
\centering
\includegraphics[width=0.4\textwidth, keepaspectratio=true]{pieces/13_centaur.png}
\caption{Centaur}
\label{fig:13_centaur}
\end{wrapfigure}
...
\label{sec:Hemera's Dawn/Centaur/Centaur cannot diverge}

\vspace*{-1.2\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_12_centaur_cannot_diverge.png}
\caption{Centaur cannot diverge}
\label{fig:scn_hd_12_centaur_cannot_diverge}
\end{figure}
...
\label{sec:Hemera's Dawn/Centaur/Wave cannot diverge}

\vspace*{-1.2\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_13_wave_cannot_diverge.png}
\caption{Wave cannot diverge}
\label{fig:scn_hd_13_wave_cannot_diverge}
\end{figure}

\TODO

... if activated by Centaur.
