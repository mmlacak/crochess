...
\hyperref[fig:scn_mv_030_wave_off_board]{Wave activated by Unicorn}. Here,
...
\addcontentsline{toc}{subsubsection}{... in close quarters}
...
\centering
\includegraphics[width=0.41\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_59_en_passant_grenadier_in_close_quarters.png}
\vspace*{-1.4\baselineskip}
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.41\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_60_en_passant_grenadier_activated_in_close_quarters.png}
\vspace*{-1.4\baselineskip}
...
% \label{sec:Hemera's Dawn/Rush, en passant/Cascading rushes, en passants}
%
% \vspace*{-1.1\baselineskip}
% \noindent
% \begin{wrapfigure}[1]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_62_multiple_rushes_init.png}
% \vspace*{-0.4\baselineskip}
% \caption{Rushing multiple pieces}
% \label{fig:scn_hd_62_multiple_rushes_init}
% \end{wrapfigure}
% . . .
%
% \vspace*{12.9\baselineskip}
% \noindent
% \begin{wrapfigure}[1]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_63_multiple_rushes_end.png}
% \vspace*{-0.4\baselineskip}
% \caption{Capturing one by en passant}
% \label{fig:scn_hd_63_multiple_rushes_end}
% \end{wrapfigure}
% . . .
%
% \vspace*{12.9\baselineskip}
