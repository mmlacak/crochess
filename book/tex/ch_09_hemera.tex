...
laterally, to the left or to the right.
...
includes any capturing step, even if destination fields are empty. Activated Wave
cannot change direction once it starts moving; so, light Pawn in this example would
remain out of reach.
