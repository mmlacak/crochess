...
opponent's piece present on its grenadier-fields. Grenadier's movement forward
and backwards are symetrical, thus light and dark Grenadier move in the same
way; so, in following examples only light Grenadier movement is shown.
