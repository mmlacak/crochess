...
\centering
\includegraphics[width=0.4\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_17_scout_rerouting.png}
\vspace*{-0.3\baselineskip}
\caption{Rerouting Scout}
\label{fig:scn_hd_17_scout_rerouting}
\end{wrapfigure}
. . .
...
\centering
\includegraphics[width=0.35\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_18_scout_rerouting_first_step.png}
\vspace*{-0.3\baselineskip}
\caption{Rerouting first step}
\label{fig:scn_hd_18_scout_rerouting_first_step}
\end{wrapfigure}
. . .

\vspace*{9.3\baselineskip}
\TODO :: Rerouting Scout
...
\addcontentsline{toc}{subsection}{Transitions}
\label{sec:Hemera's Dawn/Grenadier/Transitions}

\TODO :: Grenadier / Transitions
