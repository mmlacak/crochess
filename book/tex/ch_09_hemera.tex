...
\centering
\includegraphics[width=0.35\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_43_grenadier_forking_steps.png}
\vspace*{-0.5\baselineskip}
\caption{Forking steps}
...
\centering
\includegraphics[width=0.41\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_59_grenadier_en_passant.png}
\vspace*{-1.4\baselineskip}
\caption{En passant}
...
\begin{wrapfigure}[15]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.41\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_60_grenadier_en_passant_self_extended.png}
\vspace*{-1.4\baselineskip}
