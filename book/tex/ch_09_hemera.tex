...
\centering
\includegraphics[width=0.28\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_01_centaur_same_color.png}
\vspace*{-0.7\baselineskip}
...
\centering
\includegraphics[width=0.48\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_02_centaur_opposite_color.png}
\vspace*{-0.7\baselineskip}
...
Scout can also capture opponent's pieces with its diagonal steps. The same as Pawn's,
these steps are capture-only, i.e. if destination field is empty, capture-step is
unavailable. Also like Pawn, Scout can make only one step in chosen diagonal, regardless
of size of a chessboard. Unlike Pawn's, these are backwards steps, i.e. towards own
initial positions.\newline
\indent
...
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_16_scout_capturing.png}
...
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_17_scout_forking_steps.png}
\vspace*{-0.6\baselineskip}
...
use forking step after left, up, or right steps are taken; dark Scout would choose
...
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_20_scout_rerouting.png}
...
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_21_scout_rerouting_first_step.png}
\vspace*{-0.5\baselineskip}
...
\noindent
\begin{wrapfigure}[10]{l}{0.4\textwidth} % 10 = enough
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_22_scout_rerouting_pawn_wall.png}
\vspace*{-0.5\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_24_activating_scout_init.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_25_activating_scout_end.png}
\vspace*{-1.3\baselineskip}
...
\vspace*{-0.5\baselineskip}
Here, activated Scout (now "in-the-air") can make at most 2 steps, since this
is momentum it received. Activated Scout cannot make any diagonal steps, since
these steps are only for capturing, but destination fields are empty.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_26_scout_activating_wave_step_fields_init.png}
\vspace*{-1.4\baselineskip}
\caption{Activating Wave on step-fields}
\label{fig:scn_hd_26_scout_activating_wave_step_fields_init}
\end{figure}

\vspace*{-0.5\baselineskip}
Scout can activate Wave on its step-fields. Activated Wave can choose any direction
Scout would be able to take, including any capturing step, even if associated fields
are empty. Wave cannot take any
\hyperref[fig:scn_hd_17_scout_forking_steps]{forking steps}, or use
\hyperref[fig:scn_hd_20_scout_rerouting]{rerouting}.\newline
\indent
Direction, once chosen, cannot be changed in a ply; so, light Pawn in this example
would remain out of reach. Activated Wave can move straight forward, towards
opponent's initial positions, or laterally, to the left or to the right.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_27_scout_activating_wave_step_fields_end.png}
\vspace*{-1.4\baselineskip}
\caption{Wave activated on step-fields}
\label{fig:scn_hd_27_scout_activating_wave_step_fields_end}
\end{figure}

\vspace*{-0.5\baselineskip}
Activated Wave can also choose Scout's capture-step as its direction, and make
multiple steps diagonally backwards, towards own initial positions, even though
Scout can make only a single capturing step. Wave is not limited by received
momentum, and so can move until end of a chessboard is reached. Wave
\hyperref[fig:scn_mv_009_not_activating_pyramid_by_wave]{cannot activate a Pyramid},
but can use
\hyperref[fig:scn_mv_011_wave_is_transparent]{its own transparency} to reach pieces
behind.\newline
\indent
...
\subsubsection*{Activating Wave on capture-fields}
\addcontentsline{toc}{subsubsection}{Activating Wave on capture-fields}
\label{sec:Hemera's Dawn/Scout/Activating Wave/Activating Wave on capture-fields}

\vspace*{-1.4\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_28_scout_activating_wave_capture_fields_init.png}
\vspace*{-1.4\baselineskip}
\caption{Activating Wave on capture-fields}
\label{fig:scn_hd_28_scout_activating_wave_capture_fields_init}
\end{figure}

\vspace*{-0.5\baselineskip}
Wave activated by Scout on its capture-field moves and behaves exactly the same
as the one
\hyperref[fig:scn_hd_26_scout_activating_wave_step_fields_init]{activated on Scout's step-field}.\newline
\indent
Again, activated Wave can choose any direction Scout would be able to take; this
includes any capturing step, even if destination fields are empty; but no
\hyperref[fig:scn_hd_17_scout_forking_steps]{forking steps}, or use
\hyperref[fig:scn_hd_20_scout_rerouting]{rerouting}.
Activated Wave cannot change direction once it starts moving; so, light Pawn
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_29_scout_activating_wave_capture_fields_end.png}
\vspace*{-1.4\baselineskip}
\caption{Wave activated on capture-fields}
\label{fig:scn_hd_29_scout_activating_wave_capture_fields_end}
\end{figure}

\vspace*{-0.5\baselineskip}
Activated Wave can also take Scout's capture-step as its direction, and make multiple
steps diagonally backwards, even though Scout can make only a single capturing step.
Wave is not limited by received momentum, and so can move until end of a chessboard
is reached.\newline
\indent
Wave
\hyperref[fig:scn_mv_009_not_activating_pyramid_by_wave]{cannot activate a Pyramid},
...
\indent
This is similar to
\hyperref[fig:scn_mv_027_wave_activation_by_capture_pawn]{Wave activated by Pawn on its capture-field}.
...
\begin{wrapfigure}[14]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.265\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_30_scout_en_passant.png}
\vspace*{-0.3\baselineskip}
\caption{En passant}
\label{fig:scn_hd_30_scout_en_passant}
\end{wrapfigure}
\indent
...
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.265\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_40_grenadier_fields.png}
\vspace*{-0.5\baselineskip}
...
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_42_grenadier_movement_transition.png}
\vspace*{-0.5\baselineskip}
\caption{Transition}
...
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_43_grenadier_forking_steps.png}
\vspace*{-0.5\baselineskip}
\caption{Forking steps}
...
\begin{wrapfigure}[10]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.265\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_44_grenadier_vertical_steps.png}
\vspace*{-0.5\baselineskip}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_46_grenadier_close_quarters_transition.png}
\vspace*{-0.5\baselineskip}
\caption{Transition}
...
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_47_grenadier_blocked_steps.png}
\vspace*{-0.5\baselineskip}
...
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_48_grenadier_not_blocked_steps.png}
\vspace*{-0.5\baselineskip}
...
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_50_grenadier_activated.png}
\vspace*{-0.5\baselineskip}
\caption{Activated}
...
\subsection*{Activating Pyramid}
\addcontentsline{toc}{subsection}{Activating Pyramid}
\label{sec:Hemera's Dawn/Grenadier/Activating Pyramid}

Grenadier can activate own Pyramid only on capture-fields, regardless if immediate
or after forking step, both in close quarters and out.

\vspace*{-0.3\baselineskip}
\noindent
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_53_grenadier_activates_pyramid.png}
\vspace*{-0.5\baselineskip}
\caption{Activating Pyramid}
\label{fig:scn_hd_53_grenadier_activates_pyramid}
\end{wrapfigure}
When not in close quarters, Grenadier can activate own Pyramid only on immediate
capture-field (here, Pyramid B). Grenadier cannot activate Pyramid on its step-fields,
and is blocked from moving any further (Pyramid A).

\vspace*{0.7\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_54_grenadier_close_quarters_activates_pyramid.png}
\vspace*{-1.4\baselineskip}
\caption{Activating Pyramid in close quarters}
\label{fig:scn_hd_54_grenadier_close_quarters_activates_pyramid}
\end{figure}

\vspace*{-0.3\baselineskip}
When in close quarters, Grenadier can activate own Pyramid on its immediate capture-field
(here, Pyramid C), or on a capture-field after forking step (here, Pyramid A, after using
\hyperref[fig:scn_mv_011_wave_is_transparent]{transparency of Wave} to reach it).\newline
\indent
Grenadier cannot activate Pyramid on its step-fields, and is blocked from moving any further
(Pyramid B).
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_55_grenadier_activating_wave_step_field.png}
\vspace*{-1.4\baselineskip}
\caption{Activating Wave on step-fields}
\label{fig:scn_hd_55_grenadier_activating_wave_step_field}
\end{figure}

\vspace*{-0.5\baselineskip}
Grenadier can activate Wave on its step-fields. Activated Wave can choose any
direction Grenadier would be able to take, including any immediate capturing step,
even if associated fields are empty. Wave cannot take any
\hyperref[fig:scn_hd_43_grenadier_forking_steps]{forking steps}, i.e. no capturing
steps in
\hyperref[fig:scn_hd_49_grenadier_close_quarters_pattern]{close quarters}.\newline
\indent
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_56_grenadier_activated_wave_step_field.png}
\vspace*{-1.4\baselineskip}
\caption{Wave activated on step-fields}
\label{fig:scn_hd_56_grenadier_activated_wave_step_field}
\end{figure}

\vspace*{-0.5\baselineskip}
Activated Wave (now "in-the-air") can move up, down, left or right. Wave can also
choose Grenadier's immediate capture-step as its direction, and move diagonally.
So, activated Wave moves the same as if activated by Queen.\newline
\indent
Activated Wave is not limited by received momentum, and so can move until end of
a chessboard is reached. Wave
\hyperref[fig:scn_mv_009_not_activating_pyramid_by_wave]{cannot activate a Pyramid},
but can use
\hyperref[fig:scn_mv_011_wave_is_transparent]{its own transparency} to reach pieces
behind it.\newline
...
\subsubsection*{Activating Wave on capture-fields}
\addcontentsline{toc}{subsubsection}{Activating Wave on capture-fields}
\label{sec:Hemera's Dawn/Grenadier/Activating Wave/Activating Wave on capture-fields}

\vspace*{-1.4\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_57_grenadier_activating_wave_capture_field.png}
\vspace*{-1.4\baselineskip}
\caption{Activating Wave on capture-fields}
\label{fig:scn_hd_57_grenadier_activating_wave_capture_field}
\end{figure}

\vspace*{-0.5\baselineskip}
Wave activated by Grenadier on its capture-field moves and behaves exactly the same
as the one
\hyperref[fig:scn_hd_55_grenadier_activating_wave_step_field]{activated on a step-field},
regardless if activating Grenadier was in close quarters, or not.\newline
\indent
Again, activated Wave can choose any direction Grenadier would be able to take; this
includes any immediate capturing step, even if destination fields are empty; but no
\hyperref[fig:scn_hd_43_grenadier_forking_steps]{forking steps}, i.e. no capturing
steps in
\hyperref[fig:scn_hd_49_grenadier_close_quarters_pattern]{close quarters}.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_58_grenadier_activated_wave_capture_field.png}
\vspace*{-1.4\baselineskip}
\caption{Wave activated on capture-fields}
\label{fig:scn_hd_58_grenadier_activated_wave_capture_field}
\end{figure}

\vspace*{-0.5\baselineskip}
Activated Wave (now "in-the-air") can also take Grenadier's immediate capture-step as
its direction, and make multiple steps diagonally, even though Grenadier can make only
a single capturing step. So, activated Wave moves the same as if activated by Queen.
Activated Wave cannot change direction once it starts moving; so, light Pawn here remains
out of reach. Wave
\hyperref[fig:scn_mv_009_not_activating_pyramid_by_wave]{cannot activate a Pyramid},
but can use
\hyperref[fig:scn_mv_011_wave_is_transparent]{its own transparency} to reach pieces
behind it. This is similar to
\hyperref[fig:scn_mv_027_wave_activation_by_capture_pawn]{Wave activated by Pawn on its capture-field}.
...
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_59_grenadier_en_passant.png}
\vspace*{-0.4\baselineskip}
\caption{En passant}
\label{fig:scn_hd_59_grenadier_en_passant}
\end{wrapfigure}
...
\begin{wrapfigure}[15]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.365\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_60_grenadier_en_passant_self_extended.png}
\vspace*{-0.4\baselineskip}
\caption{En passant, extended}
\label{fig:scn_hd_60_grenadier_en_passant_self_extended}
\end{wrapfigure}
