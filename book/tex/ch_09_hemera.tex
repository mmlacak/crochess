...
\centering
\includegraphics[width=0.35\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_21_grenadier_blocked_steps.png}
\vspace*{-0.5\baselineskip}
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.35\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_22_grenadier_not_blocked_steps.png}
\vspace*{-0.5\baselineskip}
