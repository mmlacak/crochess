...
fields to the left, or right, and at most 2 fields forwards (up, for light Grenadier)
or backwards (down); these are step-fields, so e.g. Pyramid cannot be activated on
them (green arrows). Grenadier can capture only at closest neighboring fields at all
4 diagonals (red).
...
\vspace*{-0.5\baselineskip}
\caption{Extended capture-fields}
