...
\centering
\includegraphics[width=0.35\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_19_scout_forking_steps_major.png}
\vspace*{-0.3\baselineskip}
\caption{Forking steps}
\label{fig:scn_hd_19_scout_forking_steps_major}
\end{wrapfigure}
