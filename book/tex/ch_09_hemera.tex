...
called umbrella Pawns. Note, umbrella Pawns do not make a Pawns ranks, and so are not located on Pawns rows.
So, opponent’s Pawns converted in those rows cannot be rushed, even if converted in starting fields of umbrella
Pawns.
