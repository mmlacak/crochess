...
\vspace*{-0.7\baselineskip}
\noindent
\begin{wrapfigure}[10]{l}{0.4\textwidth} % 9 is minimum
\centering
...
Steps (arrows) are referred to by relative position of its end point. \newline
\indent
Capture-steps available are extension of first step; so, e.g. after left
...
% \vspace*{-2.3\baselineskip}
\subsubsection*{Extended steps}
\addcontentsline{toc}{subsubsection}{Extended steps}
\label{sec:Hemera's Dawn/Grenadier/Movement/Extended steps}
...
\vspace*{-1.3\baselineskip}
\caption{Complete extended pattern}
...
% \centering
% \includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_25_grenadier_extended_capture_fields.png}
% \vspace*{-0.5\baselineskip}
% \caption{Additional capture-fields}
% \label{fig:scn_hd_25_grenadier_extended_capture_fields}
% \end{wrapfigure}
...
% \begin{wrapfigure}[8]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_26_grenadier_extended_captures.png}
% \vspace*{-0.5\baselineskip}
% \caption{Capturing}
% \label{fig:scn_hd_26_grenadier_extended_captures}
% \end{wrapfigure}
...
% \begin{wrapfigure}[8]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.25\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_27_grenadier_blocked_capture.png}
% \vspace*{-0.5\baselineskip}
% \caption{Blocked}
% \label{fig:scn_hd_27_grenadier_blocked_capture}
% \end{wrapfigure}
...
% \noindent
% \begin{figure}[!h]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/14_hd/scn_hd_28_grenadier_complete_extended_pattern.png}
% \vspace*{-1.3\baselineskip}
% \caption{Complete movement pattern}
% \label{fig:scn_hd_28_grenadier_complete_extended_pattern}
% \end{figure}
