...
\clearpage % ..........................................................
% Converting opponent's Pawn ------------------------------------------

\subsection*{Converting opponent's Pawn}
\addcontentsline{toc}{subsection}{Converting opponent's Pawn}

\vspace*{-1.1\baselineskip}
\noindent
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/08_aoa/scn_aoa_11_opponents_pawn_conv_init.png}
\caption{Dark Pawns approaching}
\label{fig:scn_aoa_11_opponents_pawn_conv_init}
% \centering
\end{figure}

Converting any opponent's Pawns (regardless if tagged for promotion, or not) in own Pawn or
figure row grants them ability to be rushed, and subjects them to opponent's en passant move.
...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/08_aoa/scn_aoa_12_opponents_pawn_conv_tagged.png}
\caption{Dark Pawns to be converted}
\label{fig:scn_aoa_12_opponents_pawn_conv_tagged}
% \centering
\end{figure}

Note, dark Pawn in light figure row is just tagged for promotion.
...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/08_aoa/scn_aoa_13_opponents_pawn_converted.png}
\caption{Rushing converted Pawn}
\label{fig:scn_aoa_13_opponents_pawn_converted}
% \centering
\end{figure}
