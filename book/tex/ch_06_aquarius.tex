...
Rush row is any row from which Pawn can be rushed, they are the same as
piece rows.
...
Here, rows are marked green (light figure row), blue (light Pawn row),
red (dark Pawn row) and grey (dark figure row).
