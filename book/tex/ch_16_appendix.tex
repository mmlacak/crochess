...
<capturing-active-figure> =
  <classic-figure> | <new-active-figure>

<capturing-active-piece> =
  <pawn> | <capturing-active-figure>

<active-figure> =
  \alg{I} | <capturing-active-figure>

<active-piece> =
  <pawn> | <active-figure>

<capturing-piece> =
  \alg{A} | <capturing-active-piece>
...
<terminal-ply> =
  <capturing-active-piece-losing-tag>
    <stepping>[<capturing-side-effect>]
...
% <cascading-plies> =
%   \{\alg{~W}<wave-stepping>\}\alg{~}<cascaded-ply>
% | [\{\alg{~W}<wave-stepping>\}]\{\alg{~A}<stepping>\}
