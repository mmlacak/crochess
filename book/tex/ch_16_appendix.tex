...
\algfmt{FIDE~C.9.3}.
If \hyperref[fig:scn_mv_23_wave_activation_by_capture_pawn]{Wave activated by Pawn example} had
...
Note, diverging from opponent's Starchild is mandatory to write, otherwise it's
captured; capture is default interaction between opposing pieces. For instance,
in \hyperref[fig:scn_o_19_starchild_divergence_end]{this example} light Queen
could either capture or diverge from either first or second dark Starchild, due
to almost complete
\hyperref[fig:scn_o_15_starchild_is_transparent]{Starchild transparency}.
If diverging from a second dark Starchild, and capturing Pegasus, it would be
written as \alg{Q..k6/..m8*}, or in \algfmt{XAN} with transparency as
\alg{Qo2..m4\^{}I..k6/I..m8*E}.
...
(if \hyperref[fig:scn_mv_21_wave_activation_by_step_pawn]{activated on a step-field}),
or diagonally (if
\hyperref[fig:scn_mv_23_wave_activation_by_capture_pawn]{activated on a capture-field});
