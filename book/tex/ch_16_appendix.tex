...
\begin{alltt}
<abc> = \alg{a} [ \alg{b} | \alg{f} ] \alg{g} | \alg{h}
\end{alltt}
has two choices. Choice inside option group has 2 distinct values, \alg{b} or \alg{f}.
Global choice (not contained in any group) has values
\alg{a}\algfmt{[}\alg{b}\algfmt{|}\alg{f}\algfmt{]}\alg{g} or \alg{h}. This gives
\alg{abg}, \alg{afg}, \alg{ag} and \alg{h} as possible values for \algfmt{<abc>}.
