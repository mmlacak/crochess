...
\begin{tabular}{ rlrr }
\toprule
\textbf{Id} & \textbf{Variant}      & \multicolumn{2}{c}{ \textbf{Light scout Pawn ranks} } \\ \cmidrule{3-4}
...
\bottomrule
\end{tabular}
\caption{Light scout Pawn ranks}
\label{tbl:Appendix/Summary/Light scout Pawn ranks}
\end{table}
