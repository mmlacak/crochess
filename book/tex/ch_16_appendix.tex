...
\hyperref[fig:scn_mv_22_wave_activated_by_step_pawn]{Wave activated by Pawn}
can take diagonal step, even if Pawn would not be able to because diagonal field
does not host opponent's piece.
