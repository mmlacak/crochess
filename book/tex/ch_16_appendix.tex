...
wrtten as well. In previous example, if Serpent stopped at \alg{m17}, at least 2 differrent paths are possible.
...
path might inadvertently also denote others. Care must also be taken to properly use step separator \alg{.} (dot),
and multiple step separator \alg{..} (two dots). For instance, first, short path in previous paragraph might also
be confused with \alg{Sm15\~{}Am11::S..l16..m17*}, which is a shorthand for\\
...
\midrule
1           & \alg{...}            & placeholder for a move         \\
2           & \alg{(=)}            & draw offer                     \\ \cmidrule{1-3}
3           & \alg{+}              & check                          \\
4           & \alg{\#}             & checkmate                      \\
\bottomrule
\end{tabular}
...
\midrule
 1           & \alg{!}              & an excellent move                                     \\
 2           & \alg{!!}             & a particularly good,                                  \\
             &                      & and usually surprising move                           \\
 3           & \alg{?}              & a bad move; a mistake                                 \\
 4           & \alg{??}             & a blunder                                             \\
 5           & \alg{!?}             & an interesting move that may not be best              \\
 6           & \alg{?!}             & a dubious move or                                     \\
             &                      & move that may turn out to be bad                      \\
%  7           & \alg{()}             & a better move than the one played                     \\
%  8           & \alg{[]}             & the only reasonable move,                             \\
%              &                      & or the only move available                            \\
%  9           & \alg{\^{}\^{}}       & a theoretical novelty                                 \\
\bottomrule
\end{tabular}
