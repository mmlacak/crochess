...
a chessboard. So, destination ranks when rushing reachable by light and dark
players do not overlap.
...
forward positions cannot rush quite as far as limits above, because rush is
always movement forward, for at least two fields. \newline
\indent
