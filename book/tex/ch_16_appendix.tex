...
\end{tabular}
\caption{Notation}
\label{tbl:Appendix/Summary/Notation}
\end{table}
...
<side-effects> = \alg{*}[<piece>]
               | \alg{:}[<rank>]
               | \alg{&}[<file>]
               | [\alg{=}]<promote-to-piece>
               | \alg{==}
               | \alg{%}[<piece>]
               | \alg{%%}
               | \alg{<}[<piece>]<field>
               | \alg{>}[<piece>]<disambiguation>
               | \alg{$}<piece>
               | \alg{$W}<field>
               | \alg{$I}<field>
               | \alg{$$}

<ply> = <movable-piece><movement>
          [<side-effects>]
...
<trance-journey> =
    \alg{@}<piece>[<disambiguation>]
      (.[.]<field>\alg{<}[<piece>]<field>)<field>
  | \alg{@}<piece>[<disambiguation>]
      (.[.]<field>\alg{*}[<piece>])<field>
  | \alg{@}\alg{@}[<piece>]
...
<pawn-sacrifice> =
  ...
  | \alg{::[S}[<disambiguation>]\{.[.]<field>[*]\}\alg{]}
...
<move-new> =
    <ply>(\alg{~}<ply>)
  | <ply>(\alg{~}<ply>)<trance-journey>
  | <ply>(\alg{~}<ply>)<teleportation>
  | <ply>(\alg{~}<ply>)<pawn-sacrifice>
  | (<ply>\alg{~})<move-star>
...
% <piece> = ? | \alg{P} | \alg{N} | \alg{B} | \alg{R} | \alg{Q} | \alg{K} | \alg{G} | \alg{A}
%         | \alg{U} | \alg{W} | \alg{T} | \alg{C} | \alg{S} | \alg{H} | \alg{M} | \alg{I}
...
%   | <compatibility-move>
%   | <ply>(\alg{~}<ply>)<status>
%   | <ply>(\alg{~}<ply>)<trance-journey><status>
%   | <ply>(\alg{~}<ply>)<teleportation><status>
%   | <ply>(\alg{~}<ply>)<pawn-sacrifice><status>
...
\label{tbl:Appendix/Movement limits}
\end{table}
...
\label{tbl:Appendix/Monolith initial positions}
\end{table}
