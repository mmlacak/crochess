...
Draw offer can be accepted, as long as draw offer is valid, i.e. not canceled, by writing
\alg{(==)} (two equal signs in brackets) as a complete move, which ends a game, like so:
...
a cascade. Every inheritance chain starts with a non-Wave piece, such a piece is
called activator.
