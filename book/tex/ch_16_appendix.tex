...
Only \hyperref[fig:scn_mv_34_activated_piece_checking]{last piece in a cascade can check or checkmate}
opponent's King in the same move, because all pieces prior transfer any remaining momentum to next piece
in a cascade.
% TODO :: and add example after
