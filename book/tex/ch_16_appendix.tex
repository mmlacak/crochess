...
\begin{tabular}{ llcc }
\toprule % ========================================================================================
\textbf{Variant}                 & \textbf{Pieces}   & \textbf{Delay?}      & \textbf{Mono?}     \\
\midrule % ----------------------------------------------------------------------------------------
...
\emph{Delay?} column holds \emph{+} if particular variant supports
...
\indent
\emph{Mono?} column holds \emph{+} if a variant allows only
\hyperref[sec:Nineteen/Sideways Pawns/Only one Queen]{monogamous royalty}
(i.e. if it allows only one Queen in the same color on a chessboard at the same
time); holds \emph{-} otherwise.
