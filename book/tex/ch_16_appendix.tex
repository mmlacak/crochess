...
\midrule
 ...
 2          & \algfmt{( )}         & grouping of options                        \\
 3          & \algfmt{|}           & option between 2 values, can be chained    \\
 ...
 9          & \alg{value}          & verbatim value                             \\
10          & \algcty{value}       & compatibility value, for \algfmt{CAN}      \\
\bottomrule
\end{tabular}
\caption{Notation}
...
<movement> =
    <piece>[<disambiguation>]<field>
  | <piece>[<disambiguation>]\{.[.]<field>\}
  | <piece><field>\alg{-}<field>
...
<ply> = <movement>[<side-effects>]
      | \alg{[}<movement>[<side-effects>]\alg{]}
...
<move> =
  ...
  | \alg{...}
  | <ply>[\alg{~}<ply>]<status>
  | <ply>[\alg{~}<ply>]\alg{@}<piece>[<disambiguation>]
      [.[.]<field>\alg{<}[<piece>]<field>]<field><status>
  | <ply>[\alg{~}<ply>]\alg{@}<piece>[<disambiguation>]
      [.[.]<field>\alg{*}]<field><status>
