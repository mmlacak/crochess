...
Note, optional entity might also contain optional value. For instance, pieces
loose their tags when e.g. captured, but most of the time they don't have any;
writing losing tag is also completely optional.
