...
\multirow{5}{*}{Serpent}    & \multirow{5}{*}{any\footnotemark[2]}
                                                        & \parbox[b][1pt][s]{12ex}{step,\\transparency,\\divergence,\\displacement\footnotemark[3]}
                                                                                        & step, capture,            \\
                            &                           &                               & teleport,                 \\
...
\footnotetext[2]{For materiel pieces capture-fields are the same as step-fields, except for privates, Shaman.}
