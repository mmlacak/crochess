...
\hyperref[fig:scn_o_18_starchild_conversion_immunity_init]{conversion immunity} would be
...
(tilde), before \hyperref[fig:scn_o_19_trance_journey_init_starchild]{entranced piece} takes
...
\hyperref[fig:scn_o_26_trance_journey_failed_2]{failed trance-journey example} all
...
In case \hyperref[fig:scn_o_29_syzygy_starchild_init]{resurrection example} ended by
\hyperref[fig:scn_o_30_syzygy_starchild_end]{resurrecting Queen}, this would be written
as \alg{It9\$Q}, and in \algfmt{XAN} it would be \alg{Ii23-t9\$Q}.

If previous example ended by
\hyperref[fig:scn_o_31_syzygy_starchild_resurrection]{resurrecting Starchild}, it would
