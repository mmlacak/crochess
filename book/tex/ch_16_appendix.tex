...
Losing tag is a side-effect of a tagged piece being moved, captured, etc. As such, losing
tag can accompany most other side-effects. So, losing tag is denoted immediately after piece
symbol, but before any positional, or movement notation, depending on what is available.
...
Revisiting this \hyperref[fig:scn_mv_22_activating_rush_pawn_init]{activating Pawns example}, light Pawn
...
\midrule
1           & \alg{+}              & check                          \\
2           & \alg{\#}             & checkmate, resign              \\ \cmidrule{1-3}
...
\midrule
 ...
 7          & Pegasus               & Pegasus                                   \\
 8          & Pyramid               & Rook                                      \\
 9          & Unicorn               & Centaur, unrestricted step choices        \\
...
\midrule
 ...
 9          & \alg{\_}             & space                                      \\
10          & \alg{value}          & verbatim \algfmt{AN} value                 \\
