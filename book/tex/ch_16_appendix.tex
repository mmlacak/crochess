...
Displacements are written the same way Serpent displacing Pawns is written, i.e. by writing
\alg{<} (less-than) immediately after step in which a piece is reached, followed by field
of displacement. Optionally, displaced piece can be written before displacement-field. The
same \hyperref[fig:scn_cot_57_light_light_shaman_interaction_end]{trance-journey example},
...
\hyperref[fig:scn_cot_60_dark_dark_shaman_interaction_start]{this dark Shaman's trance-journey}
