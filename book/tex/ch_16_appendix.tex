...
e.g. \alg{m17} is initial position of a dark Pawn in Nineteen variant.
...
\algfmt{FIDE~C.9.3}.\newline
\indent
If \hyperref[fig:scn_mv_027_wave_activation_by_capture_pawn]{Wave activated by Pawn example} had
...
\hyperref[fig:age_of_aquarius_castling_left_00_04]{castling example} would be written as \alg{Kd\&},
and this \hyperref[fig:one_castling_right_24_04]{castling example} as \alg{Kr\&}. File at which
...
This \hyperref[fig:scn_tr_31_pawn_sacrifice_init]{Pawn-sacrifice} followed by % TODO :: FIX :: hyperref
\hyperref[fig:scn_tr_33_pawn_sacrifice_end]{tagged light Serpent's ply} is % TODO :: FIX :: hyperref
...
In \hyperref[fig:scn_tr_05_serpent_end]{this Serpent's movement example}, starting
position is \alg{c3}, and destination \alg{g3}, depicted complete path is
\alg{Sc3.d4.c5.d6.e5.f6.g5.f4.g3}. Even with as few steps as possible, to have
unique path it would still need to be written as \alg{S..d6..f6..g3}.
...
\algcycpar
\algcyc{81.}{Qb2\textasciitilde{}Wh2\textasciitilde{}Wl6\textasciitilde{}Ro6(===)}{}{Draw by the rules, \hyperref[fig:scn_mv_071_cascade_double_checkmate_end]{both Kings are checkmated} by light player.}
\algcycparend
...
\algcycpar
\algcyc{82.}{...}{(===)}{Draw forced, by arbiters.}
\algcycparend

In \algfmt{NAN} checks are optional; checkmates, self-checkmates, resigns, and all
draws are mandatory, to set game score end. Draw offers, cancelations are mandatory
to set limits within which draw offer is valid, and can be accepted by opponent.
...
\footnotetext[2]{Rook destination is optional.}
\footnotetext[3]{Promotion symbol is optional.}
...
\addcontentsline{toc}{subsubsection}{Rushing limits}
...
\addcontentsline{toc}{subsubsection}{Castling limits}
...
\hyperref[fig:one_castling_right_24_04]{King-side castling} \alg{Kr\&q} is a
...
\midrule % -----------------------------------------------------------------------------------------------
any\footnotemark[1]                     & capture-                      & own Pyramid\footnotemark[2]   \\
any\footnotemark[1]                     & any                           & own Wave                      \\
\cmidrule{1-3} % .........................................................................................
\multirow{2}{*}{Wave}                   & \multirow{2}{*}{any}          & opponent's Wave, any own\footnotemark[3] \\
                                        &                               & except King, Pyramid          \\
\cmidrule{1-3} % .........................................................................................
...
\cmidrule{1-3} % .........................................................................................
\multirow{2}{*}{Starchild}              & \multirow{2}{*}{uplifting-}   & any\footnotemark[4] except King, Pyramid, \\
                                        &                               & Wave, Monolith, any Star      \\
\bottomrule % ============================================================================================
\end{tabular}
...
\footnotetext[1]{Any piece, except Waves, Stars, Monolith, Starchild.}
\footnotetext[2]{Activating piece has to have momentum, i.e. $>0$.}
\footnotetext[3]{Wave has to have momentum, if activating anything other than a Wave or Starchild.}
\footnotetext[4]{Uplifted Starchild cannot take sense-journey, only uplift other piece.}
...
or opponent's.\newline
\indent
Any piece, except Wave and Starchild, can be activated only if activating piece has
momentum (i.e. if it's larger than 0); both Wave and Starchild do not spend their
momentum when moving, and transfer it entirely to next piece in a cascade.
...
can take diagonal step, even if Scout itself would not be able to because e.g.
diagonal field does not host opponent's piece.
...
\hyperref[fig:scn_hd_56_grenadier_activated_wave_step_field]{Wave activated by Grenadier}
moves like a Queen.
...
\subsection*{Piece steps}
\addcontentsline{toc}{subsection}{Piece steps}
\label{sec:Appendix/Piece steps}

% \begin{table}[!h]
% \centering
% \begin{tabular}{ ll }
% \toprule % ===============================================================
% \textbf{Piece}              & \textbf{Steps}                            \\
% \midrule % ---------------------------------------------------------------
% Pawn                        & capture-\footnotemark[1]                  \\
% Knight                      & capture-                                  \\
% Bishop                      & capture-                                  \\
% Rook                        & capture-                                  \\
% Queen                       & capture-                                  \\
...
% Star                        & ---                                       \\
% Centaur                     & capture-                                  \\
% Scout                       & capture-\footnotemark[1]                  \\
% Grenadier                   & capture-\footnotemark[1]                  \\
% Serpent                     & capture-                                  \\
% \cmidrule{1-2} % .........................................................
% \multirow{3}{*}{Shaman}     & capture-\footnotemark[1],                 \\
%                             & entrancing-,                              \\
%                             & entranced-                                \\
% \cmidrule{1-2} % .........................................................
% Monolith                    & ---                                       \\
% \cmidrule{1-2} % .........................................................
% \multirow{2}{*}{Starchild}  & miracle-,                                 \\
%                             & uplifting-                                \\
% \bottomrule % ============================================================
% \end{tabular}
% \caption{Piece steps}
% \label{tbl:Appendix/Piece steps}
% \end{table}
...
Grenadier                   & capture-\footnotemark[1]                  \\
Serpent                     & capture-                                  \\
Shaman                      & capture-\footnotemark[1], entrancing-, entranced- \\
Monolith                    & ---                                       \\
Starchild                   & miracle-, uplifting-                      \\
\bottomrule % ============================================================
\end{tabular}
\caption{Piece steps (beside movement)}
\label{tbl:Appendix/Piece steps}
\end{table}

\footnotetext[1]{Movement and capture-steps are separated.}

Table above lists all different steps a piece have in addition to movement step;
Wave, Star and Monolith don't have any beside movement, and so are denoted with
\emph{---} (long dash).

Displacement steps are not listed, as those are not voluntarily performed; e.g.
Pawn can be displaced when encountered by opponent's Serpent, Pawn on its own
cannot take displacement step.
...
\textbf{Piece}              & \textbf{Fields}           & \multicolumn{2}{c}{ \textbf{Action at ... step} }         \\
                            ...
                            &                           & \emph{any}\footnotemark[1]    & \emph{last}               \\
\midrule % -----------------------------------------------------------------------------------------------------------
\multirow{5}{*}{Wave}       & \parbox[b][1pt][s]{7ex}{~\vspace*{0.7\baselineskip}\\step-,\\capture-} % \multirow{5}{*}{step\footnotemark[2]-}
                                                        &                               & step, teleport,           \\
                            &                           & step,                         & activate any              \\
                            &                           & transparency,                 & Wave, own                 \\
                            &                           & divergence\footnotemark[3]    & pieces except             \\
                            &                           &                               & King, Pyramid             \\
\cmidrule{1-4} % .....................................................................................................
\multirow{4}{*}{Wave}       & \multirow{4}{*}{step\footnotemark[2]-}
                                                        & \multirow{4}{*}{---}          & step, teleport,           \\
                            &                           &                               & activate any              \\
                            &                           &                               & Wave, own                 \\
                            &                           &                               & Starchild                 \\
\cmidrule{1-4} % .....................................................................................................
...
\footnotetext[1]{Any step, except the last one.}
\footnotetext[2]{Activated by a Starchild.}
\footnotetext[3]{Cannot diverge if activated by Unicorn, Centaur, or Serpent.}
...
activating piece was traveling; Wave behaves the same, regardless on which field
it was activated.
...
enclosed in pair of backticks, for clarity (e.g. \algfmt{`}\alg{x}\algfmt{`}).
...
\begin{alltt}
<pawn> = [\alg{P}]
<classic-disposable-figure> = \alg{N} | \alg{B} | \alg{R} | \alg{Q}
<classic-figure> = \alg{K}
                 | <classic-disposable-figure>
<trooper> = \alg{O} | \alg{G}
...
<disposable-figure> =
<promote-to-figure> = <activateable-figure>
...
<pawn-losing-tag> = <pawn>[<losing-pawn-tag>]
...
<pawn-displacement-side-effect> =
  \alg{<}<pawn-losing-tag><disambiguation>
...
<pyramid-cascading-plies> = \{\alg{~A}<stepping>\}
\end{alltt}
