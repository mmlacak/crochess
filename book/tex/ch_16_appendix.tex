...
\hyperref[fig:scn_mv_28_wave_off_board]{Wave off-board example} is field 2, then it can be noted just as \alg{Uo3\~{}Wp12}.
...
<pawn-sacrifice-capture> =
  \alg{S}[<disambiguation>]\{.[.]<field>[\alg{*}[\alg{P}[\alg{==}]]]\}
    [<pawn-sacrifice-end>]
