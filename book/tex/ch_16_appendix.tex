...
\begin{tabular}{ lrr }
\toprule % ===================================================
\textbf{Variant}      & \textbf{Scout}  & \textbf{Serpent}  \\
\midrule % ---------------------------------------------------
Hemera's Dawn         &               5 &               --- \\
Tamoanchan Revisited  &               6 &                14 \\
Conquest of Tlalocan  &               6 &                15 \\
Discovery             &               6 &                15 \\
One                   &               7 &                16 \\
\bottomrule % ================================================
\end{tabular}
...
Movement limits table contains maximum number of steps Scouts and Serpents can make,
depending on which variant is being played.

Serpent is introduced in Tamoanchan Revisited variant, so its movement limit is not
defined for Hemera's Dawn variant.
