...
(tilde), before \hyperref[fig:scn_o_21_trance_journey_init_starchild]{entranced piece} takes
...
\hyperref[fig:scn_o_28_trance_journey_failed_2]{failed trance-journey example} all
...
In case \hyperref[fig:scn_o_31_syzygy_starchild_init]{resurrection example} ended by
\hyperref[fig:scn_o_32_syzygy_starchild_end]{resurrecting Queen}, this would be written
as \alg{It9\$Q}, and in \algfmt{XAN} it would be \alg{Ii23-t9\$Q}.

If previous example ended by
\hyperref[fig:scn_o_33_syzygy_starchild_resurrection]{resurrecting Starchild}, it would
...
\hyperref[fig:scn_o_13_starchild_not_moving_monolith_init]{this example} would be written as
