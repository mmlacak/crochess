...
In this \hyperref[fig:scn_mv_18_activating_rush_pawn_init]{activating Pawns example}, light
...
Only
\hyperref[fig:scn_mv_33_activated_piece_check_cascade]{last piece in a cascade can check or checkmate}
opponent's King in the same move, because
\hyperref[fig:scn_mv_32_activated_piece_check_init]{all pieces prior transfer any remaining momentum to next piece}
in a cascade.
