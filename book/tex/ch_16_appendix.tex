...
\hyperref[fig:scn_o_22_trance_journey_failed]{failed trance-journey example} all
...
\alg{\~{}} (tilde), before \hyperref[fig:scn_o_25_uplifting_step]{uplifted piece} takes
off. This \hyperref[fig:scn_o_28_dark_piece_sense_journey]{sense-journey example} would
...
\hyperref[fig:scn_o_29_sense_journey_failed]{failed sense-journey example} all
...
\TODO :: dark Scouts, Grenadiers on their initial positions, fix pathing
...
Grenadier's movement limits in the table above apply when there are no opponent's
pieces on its grenadier-fields. Horizontal and vertical movement limits for
Grenadier are different, and can be found in columns \emph{hor.}, and \emph{vert.},
respectively.

When there are opponent's pieces on its grenadier-fields, Grenadier can make 1
step up, or down, optionally followed by forking capture-step. In close quarters,
Grenadier can make 1 step more then the count of opponent's pieces on its
grenadier-fields to the left, or to the right. After each horizontal step,
Grenadier can take forking capture-step. \newline
\indent
...
\TODO :: transparency, divergence, sense-journey

% \TODO :: Pegasus == G --> E

\TODO :: Scout == O, Grenadier == G
...
<capturing-active-piece> =
  <classic-piece> | \alg{E} | \alg{U} | \alg{C} | \alg{S} | \alg{H}
...
<promote-to-figure> =
  <passive-figure>
| \alg{N} | \alg{B} | \alg{R} | \alg{Q} | \alg{E} | \alg{U} | \alg{C} | \alg{S} | \alg{H} | \alg{I}
