...
3           & \algfmt{[ ]}         & optional item(s), zero or more times       \\
4           & \algfmt{\{ \}}       & optional item(s), one or more times        \\
5           & \algfmt{..}          & option from range of values                \\
6           & \algfmt{?}           & empty value                                \\
7           & \alg{value}          & verbatim value                             \\
\bottomrule
\end{tabular}
\caption{Notation}
