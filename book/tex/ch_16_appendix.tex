...
% \midrule % -----------------------------------------------------------------------------------------------------------
%                             & \multirow{3}{*}{any\footnotemark[3]}
%                                                         & \multirow{3}{*}{---}          & step, capture,            \\
% King                        &                           &                               & activate own              \\
%                             &                           &                               & Wave, Pyramid             \\
% \cmidrule{1-4} % .....................................................................................................
...
\textbf{Piece}              & \textbf{Fields}           & \multicolumn{2}{c}{ \textbf{Action at ... step} }         \\
                            ...
                            &                           & \emph{any}\footnotemark[1]    & \emph{last}               \\
\midrule % -----------------------------------------------------------------------------------------------------------
\multirow{4}{*}{Pawn}       & \multirow{4}{*}{step-}    & \parbox[b][1pt][s]{12ex}{step\footnotemark[3],\\transparency\footnotemark[3],\\divergence\footnotemark[3]}
                                                                                        & step, teleport,           \\
                            &                           &                               & promotion,                \\
                            &                           &                               & activate own              \\
                            &                           &                               & Wave                      \\
...
\multirow{7}{*}{Pyramid}    & \multirow{7}{*}{any\footnotemark[2]}
                            ...
                            &                           &                               & teleport,                 \\
                            &                           & step,                         & Pawn-sacrifice,           \\
                            &                           & transparency,                 & promoting\footnotemark[5], \\
...
\footnotetext[1]{Any step except the last one.}
\footnotetext[2]{Step- and capture-fields are the same.}
\footnotetext[3]{Only when rushing.}
\footnotetext[4]{Including capture + promotion.}
\footnotetext[5]{Including tagging for promotion.}
...
\multirow{5}{*}{Wave\footnotemark[2]}
                            ...
                            &                           & step,                         & activate any              \\
                            &                           & transparency\footnotemark[5], & Wave, own                 \\
...
\footnotetext[5]{Depends on activator.}
...
\multirow{5}{*}{Serpent}    & \multirow{5}{*}{any\footnotemark[2]}
                                                        & \parbox[b][1pt][s]{13ex}{step,\\transparency,\\displacement\footnotemark[3],\\capture\footnotemark[4]}
                                                                                        & step, capture,            \\
                            &                           &                               & teleport,                 \\
...
\footnotetext[4]{After Pawn-sacrifice, Serpent can only capture Pawns.}
