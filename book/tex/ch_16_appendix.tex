...
\hyperref[fig:scn_o_26_syzygy_starchild_end]{ressurecting Queen}, this would be written as \alg{It9\$Q},
...
Initial setups table above contains complete row of pieces for light player, at the beginning
of a match. In this table, lower case letters are used to denote dark pieces. In latter variants,
...
For instance, \alg{cgnr} for \emph{row 4} in Hemera's Dawn variant means that scout Pawns are located
at \alg{c4}, \alg{g4}, \alg{n4} and \alg{r4}.
