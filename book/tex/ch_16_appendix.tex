...
\algfmt{FIDE~C.9.3}.
If \hyperref[fig:scn_mv_25_wave_activation_by_capture_pawn]{Wave activated by Pawn example} had
...
In this \hyperref[fig:scn_mv_21_activating_rush_pawn_init]{activating Pawns example}, light Pawn on
...
\hyperref[fig:scn_mv_32_wave_off_board]{Wave off-board example} is field 2, then it can be noted just as \alg{Uo3\~{}Wp12}.
...
Revisiting this \hyperref[fig:scn_mv_21_activating_rush_pawn_init]{activating Pawns example}, light Pawn
...
straight line (if
\hyperref[fig:scn_mv_23_wave_activation_by_step_pawn]{activated on a Pawn's step-field}),
or diagonally (if
\hyperref[fig:scn_mv_25_wave_activation_by_capture_pawn]{activated on a Pawn's capture-field});
