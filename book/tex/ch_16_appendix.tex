...
\subsection*{Effects on pieces}
\addcontentsline{toc}{subsection}{Effects on pieces}
\label{sec:Appendix/Effects on pieces}

\huge{}
TODO
\normalsize()

table(s): pieces | can be captured? | promoted-to? | displaced? | teleported? | converted? | oblationed? | ressurected?
