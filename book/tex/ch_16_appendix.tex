...
Displacing a piece is noted by using \alg{<} (less-than), followed by displacement field.
Optionally, displaced piece can be written before displacement-field.
...
(tilde), before \hyperref[fig:scn_cot_52_light_shaman_trance_journey]{entranced piece} takes
off. This \hyperref[fig:scn_cot_56_light_light_shaman_interaction_start]{trance-journey example},
