...
to have opponent's King checked, checkmated. If opponent's King is checkmated on
opponent's turn, only checkmated status is noted, like so:

\noindent
\algmov{91.}{...}{\#}{Checkmated on own turn.}
