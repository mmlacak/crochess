...
enclosed in pair of back-ticks, for clarity (e.g. \algfmt{`}\alg{x}\algfmt{`}).
...
% \TODO :: FIX :: REWRITE :: difference between optional notation and
%       status present sometimes --> see <losing-promotion-tag> vs.
