...
Description mostly covers short notation, and is writen in monospaced font, e.g. \texttt{Nc3}.
...
compatibility with its classic form.

For instance, \texttt{0-0}, \texttt{O-O} and their Queen's side siblings for castling had
to go in extended algebraic notation, since there are multiple castling choices available.
Another example, \texttt{x} as annotation for a capturing move, e.g. \texttt{Nxv3}, since
...
e.g. \texttt{m2} is initial position of light Pawn in Nineteen variant.
