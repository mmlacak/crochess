...
\footnotetext[1]{Unlike other disposable pieces, Starchild cannot be teleported,
nor converted.}
...
could be diverted; that is, if last active piece preceeding those Waves in a cascade
could be diverted.}
