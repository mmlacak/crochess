...
For instance, \algc{0-0}, \algc{O-O} and their Queen's side siblings for castling had
...
In this example of \hyperref[fig:scn_ct_03_define_step_ply]{moving Pegasus to destination field 3},
