...
Activated own piece means it belongs to the same player (light or dark) as
activating piece, otherwise it can be opponent's piece. For instance, any piece
can activate own Wave, but only Wave can activate opponent's Wave.
