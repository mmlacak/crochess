...
and immediately to the left in King-side castling. This can be seen in
\hyperref[sec:Appendix/Notation/Castling]{previous castling} examples, if they are
rewritten in full notation.
For instance, \hyperref[fig:age_of_aquarius_castling_left_04]{Queen-side castling}
\alg{Kd\&e} could be written as \alg{Kh1-d1\&Ra1-e1}, and
\hyperref[fig:one_castling_right_04]{King-side castling} \alg{Kr\&q} could be written
as \alg{Kn1-r1\&Ry1-q1}.
