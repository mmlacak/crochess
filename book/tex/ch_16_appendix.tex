...
for the rest of chapter), piece (always writen upper case) + destination position, which
consists of rank (always writen in lower case) + file.
...
Pawn symbol can be ommitted, but doesn't have to. In this example of
...
Just make sure you write step which really differentiate paths, otherwise \alg{C..j9..p15} might also
denote \alg{C.b4.f5..p15}, which happens to cross \alg{j9} as well.

\clearpage % ..........................................................

\subsection*{Field separators}
\addcontentsline{toc}{subsection}{Field separators}
\label{sec:Appendix/Field separators}
...
1           & .               & single step                    \\
2           & ..              & multiple steps                 \\
3           & -               & starting and destination field \\
4           & \~{}            & plies                          \\
\bottomrule
\end{tabular}
