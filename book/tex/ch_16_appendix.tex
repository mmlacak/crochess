...
Note that Serpent can capture at any step, but only after Pawn-sacrifice, and only
Pawns. Otherwise, Serpent (without Pawn-sacrifice tag) can capture any opponent's
