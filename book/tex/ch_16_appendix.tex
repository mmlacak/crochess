...
For instance, in \hyperref[fig:scn_cot_09_own_shaman_is_divergent_init]{this example} light
...
off. This \hyperref[fig:scn_cot_43_light_light_shaman_interaction_start]{trance-journey example},
...
\hyperref[fig:scn_cot_44_light_light_shaman_interaction_end]{trance-journey example},
...
\hyperref[fig:scn_cot_46_dark_light_shaman_interaction_end]{trance-journey example with captures}
would be written as \\
...
\hyperref[fig:scn_cot_47_dark_dark_shaman_interaction_start]{this dark Shaman's trance-journey}
...
\hyperref[fig:scn_cot_49_dark_dark_shaman_double_interaction_start]{dark Shaman's dual trance-journey}
...
This \hyperref[fig:scn_tr_23_pawn_sacrifice_init]{Pawn-sacrifice} followed by
\hyperref[fig:scn_tr_24_pawn_sacrifice_end]{capturing opponent's Pawns} is written as \\
...
as well. In this \hyperref[fig:scn_tr_28_serpent_activated_wave_ply]{Wave activated by Serpent}
...
if in this
\hyperref[fig:scn_tr_29_wave_out_of_board]{Wave off-board example} dark Knight were located at
...
\hyperref[fig:scn_tr_25_serpent_activating_wave]{Wave activated by Serpent} is an
