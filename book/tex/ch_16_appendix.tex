...
<active-piece> =
  <classic-piece> | \alg{G} | \alg{U} | \alg{C} | \alg{S} | \alg{H} | \alg{I}
...
<pawn-tag-losing-movement> =
  [<disambiguation>]\alg{==}<field>
| [<disambiguation>]\alg{==}\{<step>\}
| <field>[\alg{-}]\alg{==}<field>

<pawn-tag-losing-ply> =
  <pawn><pawn-tag-losing-movement>
  <side-effects>
...
<starting-ply> =
  <active-piece><movement><side-effects>
| <pawn-tag-losing-ply>
| <shaman-capturing-ply>
...
<cascade> = <starting-ply>(\alg{~}<cascading-ply>)
\end{alltt}
