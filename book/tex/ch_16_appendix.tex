...
% \subsection*{Side-effects on pieces}
% \addcontentsline{toc}{subsection}{Side-effects on pieces}
% \label{sec:Appendix/Summary/Side-effects on pieces}
...
% \end{tabular}
% \caption{Side-effects on pieces}
% \label{tbl:Appendix/Summary/Side-effects on pieces}
% \end{table}
