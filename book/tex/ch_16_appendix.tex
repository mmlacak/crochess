...
\algfmt{FIDE~C.9.3}.
If \hyperref[fig:scn_mv_20_wave_activation_by_capture_pawn]{Wave activated by Pawn example} had
...
For instance, in \hyperref[fig:scn_cot_020_own_shaman_is_divergent_init]{this example}
...
(tilde), before \hyperref[fig:scn_cot_062_entrancement_step]{entranced piece} takes off. This
\hyperref[fig:scn_cot_076_light_light_shaman_interaction_start]{trance-journey example},
...
\hyperref[fig:scn_cot_077_light_light_shaman_interaction_end]{trance-journey example},
...
\hyperref[fig:scn_cot_079_dark_light_shaman_interaction_end]{trance-journey example with captures}
would be written as \newline
...
\hyperref[fig:scn_cot_080_dark_dark_shaman_interaction_start]{dark Shaman's trance-journey}
...
\hyperref[fig:scn_cot_082_dark_dark_shaman_double_interaction_start]{dark Shaman's dual trance-journey}
...
destination in this \hyperref[fig:scn_mv_27_wave_off_board]{Wave off-board example} is field 2,
...
In this \hyperref[fig:scn_mv_33_activating_rush_pawn_init]{activating Pawns example},
...
(if \hyperref[fig:scn_mv_18_wave_activation_by_step_pawn]{activated on a step-field}),
or diagonally (if
\hyperref[fig:scn_mv_20_wave_activation_by_capture_pawn]{activated on a capture-field});
