...
<cascading> =
  <cascading-start>[\alg{~}<terminating-ply>]

<teleportation> =
  \alg{|}<field>
| \{\alg{|W}<stepping>\}[\alg{~}<move-cascading>]
...
<move-cascading> =
  <cascading>
| [<cascading-start>\alg{~}]<teleportation>
| [<cascading-start>\alg{~}]<trance-journey>
| [<cascading-start>\alg{~}]<pawn-sacrifice>
    [<pawn-sacrifice-capture>]
| [<cascading-start>\alg{~}]<move-star>
