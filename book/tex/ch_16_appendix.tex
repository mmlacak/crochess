...
piece which was resurrected. If Wave or Starchild has been resurrected on empty field,
...
rushing, and then it can use transparency to e.g. pass over Wave as if not
present.
