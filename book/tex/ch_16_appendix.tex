...
these are optional in \algfmt{CAN}, see \algfmt{FIDE C.13}, and so are in \algfmt{NAN}.
Placeholder for a move is \alg{...} (ellipsis), usually used to resume game score after
commentary, see \href{https://en.wikipedia.org/wiki/Algebraic\_notation\_(chess)\#Notation\_for\_a\_series\_of\_moves}
...
Check and checkmate status are optional in \algfmt{NAN}, just like in \algfmt{CAN},
see \algfmt{FIDE C.9}.
...
<terminal-ply> =
  <capturing-active-piece><stepping>
    [<capturing-side-effect>]
| \alg{R\&\&}<stepping>[<capturing-side-effect>]
| <pawn-losing-tag><stepping>
    [<capturing-side-effect>]
| <pawn-losing-tag><stepping>
    <en-passant-side-effect>
...
% TODO :: <pawn-sacrifice> ugly as sin Sxx~AxxP::::: (!!!)
\begin{alltt}
<pawn-sacrifice> =
...
TODO
\normalsize
\algfmt{<pawn-sacrifice>} ugly as sin
Sxx\~{}Axx*P::::: (!!!) $\rightarrow$ Sxx\~{}Axx*P::;; (?)
