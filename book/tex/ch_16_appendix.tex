...
Here, own piece means in the same (dark, or light) color, opponent's piece means
it's in the opposite color.

Wave does not have any of step-, capture-, or miracle-fields on its own; fields are
inherited from an activating piece, in the moment of activation. Activated Wave has
to move over inherited (step-, capture-, or miracle-) fields for the remainder of a
ply.

For instance, Wave activated by Pawn on its step-field has to move over that Pawn's
step-fields, i.e. from activating field straight forward, towards opponent. Later,
a sideways step-fields are added to Pawn's repertoire; from now on, Wave activated
by a Pawn on its step-field can also choose to move laterally, regardless if Wave
was activated on a forward, or side step-field.
...
For instance, Wave can activate own Pyramid on capture- (or miracle-) fields, that
actually means Wave was activated on capture- (or miracle-) field of activating
piece.

This
is so regardless activating piece started a cascade, or if Wave was activated by
a Wave activated by such a piece in a cascade.

In a cascade, that activating piece can itself be an activated Wave which
inherited capture- (or miracle-) fields from further up the chain; all inheritance
chains starts with a non-Wave piece.

Generally, activations are made on step-, capture-, and
miracle-fields, most own pieces can be activated there.
Own Pyramid can be activated
only on capture-, and miracle-fields. Kings, Monoliths cannot be activated at all.
...
% \hyperref[fig:scn_o_06_starchild_activating_on_miracle_fields]{Starchild on its miracle-fields}.
% This excludes
