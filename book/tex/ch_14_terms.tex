...
portal-fields can be used as a destination after a non-Wave piece teleported.
...
Activator is any non-Wave piece in a cascade.
...
Usually, activator refers to last activator in a cascade, preceding Wave from
which that Wave ultimately inherited (step-, capture-, or miracle-) fields.

\section*{Step}
\addcontentsline{toc}{section}{Step}
\label{sec:Terms/Step}
Step is a movement of a piece from one step- or capture-field to the next
(of the same kind).
