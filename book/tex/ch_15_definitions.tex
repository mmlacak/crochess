...
In canonical representation, which is used for all examples in this book,
light player starts from bottom of a chessboard, while dark player starts
from top.
...
Queen's side is left half of chessboard, King's side is right half of chessboard.

\section*{Rush}
\addcontentsline{toc}{section}{Rush}
\label{sec:Definitions/Rush}

Rush is always allowed for Pawns which haven't moved, to the maximum extent
of own side of chessboard. This doesn't apply to converted opponent's Pawns.
