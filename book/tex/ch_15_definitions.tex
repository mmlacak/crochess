...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/04_ct/scn_ct_05_def_odd_variants_start_even.png}
\caption{Odd variant 1}
\label{fig:scn_ct_05_def_odd_variants_start_even}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/04_ct/scn_ct_06_def_odd_variants_remove_queens_empty_row.png}
\caption{Odd variant 2}
\label{fig:scn_ct_06_def_odd_variants_remove_queens_empty_row}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/03_oct/scn_oct_07_def_odd_variants_clamp_all_together.png}
\caption{Odd variant 3}
\label{fig:scn_oct_07_def_odd_variants_clamp_all_together}
% \centering
\end{figure}
