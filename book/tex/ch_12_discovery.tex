...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_06_teleport_1.png}
\caption{Teleporting piece via Monolith}
\label{fig:scn_d_06_teleport_1}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_07_teleport_2.png}
\caption{Teleporting piece via Star}
\label{fig:scn_d_07_teleport_2}
% \centering
\end{figure}
