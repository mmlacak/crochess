...
\hspace*{\fill}{\textasciitilde{} Arthur C. Clarke} } }
\end{flushright}

\noindent
Discovery is chess variant which is played on 24~$\times$~24 board, with
...
Knight-like jump than in a previous step. Monolith can make one step more than
the number of Pawns owned by a player moving that Monolith.
...
\indent
Number of steps Monolith can make is one more than count of Pawns owned by a player
moving that Monolith. Here, Monolith moved by light player could take fifth step;
should it be moved by dark player only three steps would be allowed.
...
No piece can move past (step over) Monolith; neither material pieces, nor Waves.
...
\centering
\includegraphics[width=0.3875\textwidth, keepaspectratio=true]{examples/20_d/scn_d_10_monolith_rerouting_scout.png}
...
\vspace*{-0.4\baselineskip}
All pieces, except Waves, teleporting from a Star can reappear on empty portal-field
...
\vspace*{-0.4\baselineskip}
Wave, \hyperref[fig:scn_mv_031_wave_activation_by_unicorn_first_step]{activated by Unicorn}
...
No piece can prevent demoting to Pawn, even if placed on a syzygy-field. Unlike
promotion, demoting to Pawn cannot be saved for later. If player chooses to demote
own figure, it must happen in the very same move in which Monolith has stepped into
a syzygy.
...
Demoting to Pawn can only be done immediately after Monolith stepped into alignment;
once in it, no additional figures can be demoted on subsequent turns. To demote
again, the same Monolith has to step outside of alignment in one move and then
back in another (or the other Monolith has to step into the same syzygy).
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_26_syzygy_existing.png}
\vspace*{-1.4\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_27_syzygy_reentering_same_move.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_28_syzygy_reentering_independent.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_29_syzygy_in_opponents_figure_row.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{castlings/20_d/discovery_castling_01.png}
\vspace*{-1.4\baselineskip}
\caption{Castling}
\label{fig:discovery_castling_01}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{castlings/20_d/discovery_castling_left_01_07.png}
\vspace*{-1.4\baselineskip}
\caption{Castling long left}
\label{fig:discovery_castling_left_01_07}
\end{figure}
