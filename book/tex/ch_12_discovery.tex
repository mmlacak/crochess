...
\vspace*{-0.4\baselineskip}
All pieces, except Waves, teleporting from a Star can reappear on an empty portal-field
...
\vspace*{-0.4\baselineskip}
Wave, \hyperref[fig:scn_mv_25_wave_activation_by_unicorn_first_step]{activated by Unicorn}
