...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_12_teleporting_monolith_via_star.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_13_teleporting_monolith_via_monolith.png}
\caption{Teleporting Monolith via Monolith}
\label{fig:scn_d_13_teleporting_monolith_via_monolith}
% \centering
\end{figure}
