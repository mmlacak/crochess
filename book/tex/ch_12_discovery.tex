...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_03_monolith_step_2.png}
\caption{Monolith step 2}
\label{fig:scn_d_03_monolith_step_2}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_04_monolith_step_3.png}
\caption{Monolith step 3}
\label{fig:scn_d_04_monolith_step_3}
% \centering
\end{figure}
