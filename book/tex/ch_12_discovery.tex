...
has to follow initially chosen steps; two-step pattern is the same, only steps are
reversed, i.e. first step after emerging is the same as last step before teleporting.
