...
Step-fields of four Monolith's steps are marked, each step in its own color; blue
for first step, grey for second, red for third, and green for fourth. Taken together,
step-fields of a single step form a diamond-shaped pattern. Step-fields of all
patterns (steps) are always in a color opposite to the color of Monolith's current
field. Each consecutive step has slightly larger pattern, pattern growth is not
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_01_monolith_first_step.png}
\vspace*{-1.3\baselineskip}
\caption{Monolith's first step}
\label{fig:scn_d_01_monolith_first_step}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_02_monolith_second_step.png}
\vspace*{-1.3\baselineskip}
\caption{Monolith's second step}
\label{fig:scn_d_02_monolith_second_step}
\end{figure}

\vspace*{-0.5\baselineskip}
For Monolith's second step, step-fields are identical to
\hyperref[fig:scn_aoa_02_unicorn_opposite_color]{Unicorn's long jump}. \newline
\indent
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_03_monolith_third_step.png}
\vspace*{-1.3\baselineskip}
\caption{Monolith's third step}
\label{fig:scn_d_03_monolith_third_step}
\end{figure}

\vspace*{-0.5\baselineskip}
Here, step-fields of a Monolith's third step are marked; step-fields of a previous
pattern are enumerated. New diamond-shaped pattern contains fields neighbouring
previous pattern, and is larger by two fields on all of its sides. \newline
\indent
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_04_monolith_fourth_step.png}
\vspace*{-1.3\baselineskip}
\caption{Monolith's fourth step}
\label{fig:scn_d_04_monolith_fourth_step}
\end{figure}

\vspace*{-0.5\baselineskip}
Here, step-fields of a Monolith's fourth step are marked; step-fields of a previous
pattern are enumerated. Again, new pattern is larger than previous by two fields.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_05_monolith_off_board.png}
\vspace*{-1.3\baselineskip}
\caption{Monolith off-board}
\label{fig:scn_d_05_monolith_off_board}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_07_monolith_shaman_interaction.png}
\vspace*{-1.3\baselineskip}
\caption{Trance-journey interaction}
\label{fig:scn_d_07_monolith_shaman_interaction}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_08_monolith_is_opaque.png}
\vspace*{-1.3\baselineskip}
\caption{Monolith is opaque}
\label{fig:scn_d_08_monolith_is_opaque}
\end{figure}
...
Here, light Wave could activate own Bishop after teleporting with 2 momentum. \newline
Since \hyperref[fig:scn_d_08_monolith_is_opaque]{Monolith is opaque}, Wave cannot
