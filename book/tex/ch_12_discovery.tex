...
\end{wrapfigure}
Like in a \hyperref[fig:scn_cot_13_knight_directions]{Conquest of Tlalocan variant},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_06_monolith_is_noble.png}
\caption{Monolith is noble}
\label{fig:scn_d_06_monolith_is_noble}
\end{figure}

Monolith cannot be captured

Monolith cannot be converted

Monolith cannot be activated

Monolith cannot be displaced by Serpent, Shaman
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_18_monolith_shaman_interaction.png}
\caption{Trance-journey interaction}
\label{fig:scn_d_18_monolith_shaman_interaction}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_06_monolith_is_opaque.png}
\vspace*{-1.3\baselineskip}
\caption{Monolith is opaque}
\label{fig:scn_d_06_monolith_is_opaque}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_07_monolith_off_board.png}
\caption{Monolith off-board}
\label{fig:scn_d_07_monolith_off_board}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_08_teleport_via_monolith.png}
\caption{Teleporting piece via Monolith}
\label{fig:scn_d_08_teleport_via_monolith}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_09_teleport_via_star.png}
\caption{Teleporting piece via Star}
\label{fig:scn_d_09_teleport_via_star}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_10_teleport_wave_via_star.png}
\caption{Teleporting Wave via Star}
\label{fig:scn_d_10_teleport_wave_via_star}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_11_teleport_wave_via_monolith.png}
\caption{Teleporting Wave via Monolith}
\label{fig:scn_d_11_teleport_wave_via_monolith}
\end{figure}
...
Since \hyperref[fig:scn_d_06_monolith_is_opaque]{Monolith is opaque}, Wave cannot
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_12_teleported_wave_blocked.png}
\caption{Teleported Wave blocked}
\label{fig:scn_d_12_teleported_wave_blocked}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_13_wave_teleported_off_board.png}
\caption{Wave teleported off-board}
\label{fig:scn_d_13_wave_teleported_off_board}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_14_wave_teleport_on_and_off_board.png}
\caption{Teleporting Wave on- and off-board}
\label{fig:scn_d_14_wave_teleport_on_and_off_board}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_15_teleporting_wave_cascade.png}
\caption{Cascading teleportations}
\label{fig:scn_d_15_teleporting_wave_cascade}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_16_steps_after_teleport_init.png}
\caption{Steps before teleportation}
\label{fig:scn_d_16_steps_after_teleport_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_17_steps_after_teleport_end.png}
\vspace*{-1.4\baselineskip}
\caption{Steps after teleportation}
\label{fig:scn_d_17_steps_after_teleport_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_19_syzygy_explain.png}
\caption{Syzygy with Stars}
\label{fig:scn_d_19_syzygy_explain}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_20_syzygy_2_stars_init.png}
\caption{2-Stars syzygy start}
\label{fig:scn_d_20_syzygy_2_stars_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_21_syzygy_2_stars_steps.png}
\caption{2-Stars syzygy steps}
\label{fig:scn_d_21_syzygy_2_stars_steps}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_22_syzygy_2_monoliths_init.png}
\caption{2-Monoliths syzygy init}
\label{fig:scn_d_22_syzygy_2_monoliths_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_23_syzygy_2_monoliths_steps.png}
\caption{2-Monoliths syzygy steps}
\label{fig:scn_d_23_syzygy_2_monoliths_steps}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_24_syzygy_reentering_same_move.png}
\caption{Reentering syzygy in the same move}
\label{fig:scn_d_24_syzygy_reentering_same_move}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_25_syzygy_reentering_independent.png}
\caption{Reentering independent syzygy}
\label{fig:scn_d_25_syzygy_reentering_independent}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_26_syzygy_in_opponents_figure_row.png}
\caption{Syzygy ends with Pawn tagged for promotion}
\label{fig:scn_d_26_syzygy_in_opponents_figure_row}
\end{figure}
