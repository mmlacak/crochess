...
$\rightarrow$ 1 Monolith moved to opposite color field \\
$\rightarrow$ Wave activated by Unicorn/Centaur \\
$\rightarrow$ Wave teleported at 1st Monolith \\
$\rightarrow$ Wave emerging from 2nd Monolith \\
$\rightarrow$ emerging Wave step is the same as teleporing Wave step \\
$\rightarrow$ still alternating between 2 chosen steps \\

$\rightarrow$ same for pair of the same color Stars
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_15_monolith_shaman_interaction.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_16_syzygy_explain.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_21_syzygy_reentering_same_move.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_22_syzygy_reentering_independent.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/20_d/scn_d_23_syzygy_in_oppo_figure_row.png}
