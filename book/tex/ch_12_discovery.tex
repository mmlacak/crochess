...
steps, from its starting field M; step-fields of immediately preceding step are also
enumerated. For Monolith's second step, step-fields are identical to
...
diamond-shaped pattern has its sides longer by two.
