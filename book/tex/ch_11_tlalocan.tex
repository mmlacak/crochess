...
It's possible to displace piece between 2 fields closest to Shaman's starting position.
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_27_forward_interaction_start.png}
\caption{Forward displacement start}
\label{fig:scn_cot_27_forward_interaction_start}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_28_forward_interaction_end.png}
\caption{Forward displacement end}
\label{fig:scn_cot_28_forward_interaction_end}
% \centering
\end{figure}
