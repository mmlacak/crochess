...
\subsection*{Diverging to start}
\addcontentsline{toc}{subsection}{Diverging to start}
\label{sec:Conquest of Tlalocan/Divergence/Diverging to start}
...
\vspace*{-0.7\baselineskip}
\subsubsection*{... illegal, if first in cascade}
\addcontentsline{toc}{subsubsection}{... illegal, if first in cascade}
\label{sec:Conquest of Tlalocan/Divergence/Diverging to start/... illegal, if first in cascade}
...
\vspace*{-0.4\baselineskip}
\caption{Diverging first piece}
\label{fig:scn_cot_36_diverging_first_piece}
\end{wrapfigure}
. . .

% \vspace*{-0.9\baselineskip}
\vspace*{8.9\baselineskip}
\noindent
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
...
\vspace*{8.9\baselineskip}
\TODO :: illegal to diverge back to starting position, if first piece in a cascade (or, only one in a move)

\clearpage % ..........................................................

\subsubsection*{... legal, if activated}
\addcontentsline{toc}{subsubsection}{... legal, if activated}
\label{sec:Conquest of Tlalocan/Divergence/Diverging to start/... legal, if activated}
...
\vspace*{8.9\baselineskip}
\TODO :: legal to diverge back to starting position, if activated, i.e. not first piece in a cascade
