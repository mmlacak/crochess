...
Multiple pieces, if not too far away, can share displacement fields. So, an piece
displaced earlier can block one later on from being displaced onto specific field.
...
step-fields (light Pawns) of entranced Shaman can't be displaced
either.
