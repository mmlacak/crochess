...
mere existance of preceding Shaman in a cascade is enough to grant trance-journey
option.
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_16_light_shaman_interaction_start.png}
\caption{Light Shaman interaction start}
\label{fig:scn_cot_16_light_shaman_interaction_start}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_17_light_shaman_interaction_end.png}
\caption{Light Shaman interaction end}
\label{fig:scn_cot_17_light_shaman_interaction_end}
% \centering
\end{figure}
