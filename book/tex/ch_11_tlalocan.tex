...
Shaman can activate Wave on its step-field; Wave activated on step-fields cannot
activate Pyramids.\newline
\indent
...
%  Even though light
% Wave moves over capture-fields, it was activated on a step-field, and so it cannot
% activate Pyramid B, only light Bishop with 3 momentum.
