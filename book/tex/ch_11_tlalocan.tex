...
% \hyperref[fig:scn_cot_004_light_shaman_capture_ply]{light Shaman's capture-field},
...
a step (ordinary step, or capture-step) Shaman had in the moment of activation. \newline
\indent
...
\end{wrapfigure}
On the left, Wave is about to be activated by light Shaman on its capture-field,
so Wave would move using Unicorn's (long) jump as a step.

\vspace*{6.7\baselineskip} % 6.7
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_012_shaman_is_semi_transparent.png}
\vspace*{-1.4\baselineskip}
\caption{Shaman is semi-transparent}
\label{fig:scn_cot_012_shaman_is_semi_transparent}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_013_unicorn_is_transparent_to_shamans.png}
\vspace*{-1.4\baselineskip}
\caption{Unicorn is transparent to Shamans}
\label{fig:scn_cot_013_unicorn_is_transparent_to_shamans}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_014_teleport_shaman_all.png}
\caption{Teleporting Shaman}
\label{fig:scn_cot_014_teleport_shaman_all}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_015_teleport_pawn_init.png}
\caption{Teleporting Pawn}
\label{fig:scn_cot_015_teleport_pawn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_020_own_shaman_is_divergent_init.png}
\vspace*{-1.3\baselineskip}
\caption{Own Shaman is divergent}
\label{fig:scn_cot_020_own_shaman_is_divergent_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_021_own_shaman_is_divergent_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Queen}
\label{fig:scn_cot_021_own_shaman_is_divergent_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_022_diverging_activated_piece_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Rook}
\label{fig:scn_cot_022_diverging_activated_piece_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_023_diverging_activated_piece_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging activated Rook}
\label{fig:scn_cot_023_diverging_activated_piece_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_024_diverging_pawn_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Pawns start}
\label{fig:scn_cot_024_diverging_pawn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_025_diverging_pawn_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Pawns end}
\label{fig:scn_cot_025_diverging_pawn_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_026_diverging_rushing_pawn.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging rushing Pawn}
\label{fig:scn_cot_026_diverging_rushing_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_027_diverging_unicorn_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Unicorn start}
\label{fig:scn_cot_027_diverging_unicorn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_028_diverging_unicorn_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Unicorn end}
\label{fig:scn_cot_028_diverging_unicorn_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_029_activated_unicorn_divergence_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Unicorn}
\label{fig:scn_cot_029_activated_unicorn_divergence_init}
\end{figure}
...
\hyperref[fig:scn_cot_027_diverging_unicorn_init]{only one additional step}; this also
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_030_activated_unicorn_divergence_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging activated Unicorn}
\label{fig:scn_cot_030_activated_unicorn_divergence_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_031_centaur_cannot_diverge.png}
\vspace*{-1.3\baselineskip}
\caption{Centaur cannot diverge}
\label{fig:scn_cot_031_centaur_cannot_diverge}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_032_serpent_cannot_diverge.png}
\vspace*{-1.3\baselineskip}
\caption{Serpent cannot diverge}
\label{fig:scn_cot_032_serpent_cannot_diverge}
\end{figure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_033_king_cannot_diverge.png}
% \vspace*{-1.3\baselineskip}
\caption{King cannot diverge}
\label{fig:scn_cot_033_king_cannot_diverge}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_034_diverging_shaman_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Shamans}
\label{fig:scn_cot_034_diverging_shaman_init}
\end{figure}
...
similarly to \hyperref[fig:scn_cot_024_diverging_pawn_init]{diverging Pawns}.
\hyperref[fig:scn_cot_022_diverging_activated_piece_init]{Like before}, activated
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_035_diverging_shaman_steps.png}
\vspace*{-1.3\baselineskip}
\caption{Steps after divergence}
\label{fig:scn_cot_035_diverging_shaman_steps}
\end{figure}
...
\hyperref[fig:scn_cot_021_own_shaman_is_divergent_end]{limited by momentum it had when own Shaman was encountered}. \newline
\indent
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_036_diverging_shaman_captures.png}
\vspace*{-1.4\baselineskip}
\caption{Capture-steps after divergence}
\label{fig:scn_cot_036_diverging_shaman_captures}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_037_diverging_shaman_from_opponents.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging from opponent's Shaman}
\label{fig:scn_cot_037_diverging_shaman_from_opponents}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_038_wave_divergence_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Wave}
\label{fig:scn_cot_038_wave_divergence_init}
\end{figure}
...
Again, \hyperref[fig:scn_cot_020_own_shaman_is_divergent_init]{divergence is optional},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_039_wave_divergence_1.png}
\vspace*{-1.3\baselineskip}
\caption{Wave diverted}
\label{fig:scn_cot_039_wave_divergence_1}
\end{figure}
...
\hyperref[fig:scn_cot_021_own_shaman_is_divergent_end]{illegal to return to its starting field} Q.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_040_wave_cannot_diverge_if_activated_by_unicorn.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Unicorn}
\label{fig:scn_cot_040_wave_cannot_diverge_if_activated_by_unicorn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_041_wave_cannot_diverge_if_activated_by_centaur.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Centaur}
\label{fig:scn_cot_041_wave_cannot_diverge_if_activated_by_centaur}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_042_wave_cannot_diverge_if_activated_by_serpent.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Serpent}
\label{fig:scn_cot_042_wave_cannot_diverge_if_activated_by_serpent}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_043_multiple_divergences.png}
\vspace*{-1.3\baselineskip}
\caption{Multiple divergences}
\label{fig:scn_cot_043_multiple_divergences}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_044_diverging_opponents_pieces.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging opponent's pieces}
\label{fig:scn_cot_044_diverging_opponents_pieces}
\end{figure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_045_diverging_first_piece.png}
\vspace*{-0.4\baselineskip}
\caption{Diverging move starter}
\label{fig:scn_cot_045_diverging_first_piece}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_046_diverged_first_piece_illegal.png}
\vspace*{-0.4\baselineskip}
\caption{Diverged move starter}
\label{fig:scn_cot_046_diverged_first_piece_illegal}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_047_diverging_activated_piece.png}
\vspace*{-0.4\baselineskip}
\caption{Diverging activated piece}
\label{fig:scn_cot_047_diverging_activated_piece}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_048_diverged_activated_piece_legal.png}
\vspace*{-0.4\baselineskip}
\caption{Diverged activated piece}
\label{fig:scn_cot_048_diverged_activated_piece_legal}
\end{wrapfigure}
...
\begin{wrapfigure}[5]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_060_trance_fields.png}
\vspace*{-0.4\baselineskip}
\caption{Trance-fields}
\label{fig:scn_cot_060_trance_fields}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_061_entrancement_init.png}
\vspace*{-0.4\baselineskip}
\caption{Entrancement preparation}
\label{fig:scn_cot_061_entrancement_init}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_062_entrancement_step.png}
\vspace*{-0.4\baselineskip}
\caption{Entrancement step}
\label{fig:scn_cot_062_entrancement_step}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_063_entrancement_activated.png}
\vspace*{-0.4\baselineskip}
\caption{Entrancement by activated Shaman}
\label{fig:scn_cot_063_entrancement_activated}
\end{wrapfigure}
...
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_064_entrancement_repositioning.png}
\vspace*{-0.4\baselineskip}
\caption{Repositioning light Shaman}
\label{fig:scn_cot_064_entrancement_repositioning}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_065_entrancement_cascade.png}
\vspace*{-0.4\baselineskip}
\caption{Entrancing dark Shaman}
\label{fig:scn_cot_065_entrancement_cascade}
\end{wrapfigure}
...
\begin{wrapfigure}[10]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_066_knight_directions.png}
\vspace*{-0.4\baselineskip}
\caption{Knight directions}
\label{fig:scn_cot_066_knight_directions}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_067_stop_sign_pattern.png}
\vspace*{-0.4\baselineskip}
\caption{Stop sign pattern}
\label{fig:scn_cot_067_stop_sign_pattern}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_070_stop_sign_pattern_unwind.png}
\caption{Stop sign pattern unwinded}
\label{fig:scn_cot_070_stop_sign_pattern_unwind}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_072_light_shaman_trance_journey.png}
\vspace*{-1.3\baselineskip}
\caption{Light Shaman trance-journey}
\label{fig:scn_cot_072_light_shaman_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_073_light_shaman_trance_journey_offset.png}
\caption{Light Shaman trance-journey with offset}
\label{fig:scn_cot_073_light_shaman_trance_journey_offset}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_074_dark_shaman_trance_journey.png}
\vspace*{-1.4\baselineskip}
\caption{Dark Shaman trance-journey}
\label{fig:scn_cot_074_dark_shaman_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_075_displacement_fields.png}
\caption{Displacement-fields}
\label{fig:scn_cot_075_displacement_fields}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_076_light_light_shaman_interaction_start.png}
\caption{Light $\rightarrow$ light Shaman interaction start}
\label{fig:scn_cot_076_light_light_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_077_light_light_shaman_interaction_end.png}
\caption{Light $\rightarrow$ light Shaman interaction end}
\label{fig:scn_cot_077_light_light_shaman_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_078_dark_light_shaman_interaction_start.png}
\caption{Dark $\rightarrow$ light Shaman interaction start}
\label{fig:scn_cot_078_dark_light_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_079_dark_light_shaman_interaction_end.png}
\caption{Dark $\rightarrow$ light Shaman interaction end}
\label{fig:scn_cot_079_dark_light_shaman_interaction_end}
\end{figure}

Like in
\hyperref[fig:scn_cot_076_light_light_shaman_interaction_start]{the previous example},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_080_dark_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
\caption{Dark $\rightarrow$ dark Shaman interaction start}
\label{fig:scn_cot_080_dark_dark_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_081_dark_dark_shaman_interaction_end.png}
\caption{Dark $\rightarrow$ dark Shaman interaction end}
\label{fig:scn_cot_081_dark_dark_shaman_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_082_dark_dark_shaman_double_interaction_start.png}
\caption{Dark $\rightarrow$ dark Shaman double start}
\label{fig:scn_cot_082_dark_dark_shaman_double_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_083_dark_dark_shaman_double_interaction_end.png}
\caption{Dark $\rightarrow$ dark Shaman double end}
\label{fig:scn_cot_083_dark_dark_shaman_double_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_084_light_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
\caption{Light $\rightarrow$ dark Shaman interaction start}
\label{fig:scn_cot_084_light_dark_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_085_light_dark_shaman_interaction_end.png}
\caption{Light $\rightarrow$ dark Shaman interaction end}
\label{fig:scn_cot_085_light_dark_shaman_interaction_end}
\end{figure}

Here, displacement-fields of light Knight are marked (blue), while for dark Pawn
they are enumerated (green).
\hyperref[fig:scn_cot_077_light_light_shaman_interaction_end]{Again}, displacements
...
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_086_backward_displacement_start.png}
\caption{Backward displacement start}
\label{fig:scn_cot_086_backward_displacement_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_087_backward_displacement_end.png}
\caption{Backward displacement end}
\label{fig:scn_cot_087_backward_displacement_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_088_forward_displacement_start.png}
\caption{Forward displacement start}
\label{fig:scn_cot_088_forward_displacement_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_089_forward_displacement_step_2.png}
\caption{Forward displacement, step 2}
\label{fig:scn_cot_089_forward_displacement_step_2}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_090_forward_displacement_end.png}
\caption{Forward displacement end}
\label{fig:scn_cot_090_forward_displacement_end}
\end{figure}
