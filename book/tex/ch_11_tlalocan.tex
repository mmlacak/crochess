...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_010_activating_wave_step_field.png}
\vspace*{-1.4\baselineskip}
\caption{Activating Wave on a step-fields}
\label{fig:scn_cot_010_activating_wave_step_field}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_011_activated_wave_step_fields.png}
\vspace*{-1.4\baselineskip}
\caption{Activated Wave moving over step-fields}
\label{fig:scn_cot_011_activated_wave_step_fields}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_012_activated_wave_capture_fields.png}
\vspace*{-1.4\baselineskip}
\caption{Activated Wave moving over capture-fields}
\label{fig:scn_cot_012_activated_wave_capture_fields}
\end{figure}
...
% \centering
% \includegraphics[width=0.391666667\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_013_activating_wave_capture_field.png}
% \vspace*{-1.4\baselineskip}
% \caption{Activating Wave on capture-fields}
% \label{fig:scn_cot_013_activating_wave_capture_field}
% \end{wrapfigure}
...
% \indent
% Above, activated light Wave can step over Pyramid (since it's transparent to Wave),
% skip over an empty field, and e.g. activate light Knight on a distant field. \newline
% \indent
% The same as \hyperref[fig:scn_mv_21_wave_activation_by_step_pawn]{Wave activated by Pawn},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_013_activating_wave_capture_field.png}
\vspace*{-1.4\baselineskip}
\caption{Activating Wave on capture-fields}
\label{fig:scn_cot_013_activating_wave_capture_field}
\end{figure}
...
\TODO :: ADD :: example: light Wave activated by dark Shaman --> inherited steps vs. capture-steps
