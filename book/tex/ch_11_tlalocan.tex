...
It's possible to displace piece between 2 step-fields of an entranced Shaman. In the example
above, dark Bishop could be displaced from field 2 back onto field 1 (i.e. displacement
field 37). Such a displacement (when piece is displaced onto field already travelled over
...
Entranced Shaman can only continue to move forward (green), backward displaced piece
(here, dark Bishop) is on a travelled-over path (grey), and thus out of reach.
