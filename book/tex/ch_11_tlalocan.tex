...
If teleported to opponent's figure row (field 1), Pawn has to be promoted immediately.
Pawn teleported onto own side of a board (portal-fields 4, 5, 6) loses option to promote,
but gains opportunity to rush on an initial move, similar to
...
\begin{wrapfigure}{l}{0.4\textwidth}
\centering
\includegraphics[width=0.291666667\textwidth, keepaspectratio=true]{en_passants/18_conquest_of_tlalocan_en_passant.png}
\caption{En passant}
