...
\TODO :: link-back to \begin{verbatim*}label{fig:scn_mv_46_static_move_is_illegal_init}\end{verbatim*}
( \begin{verbatim*}label{sec:Miranda's veil/Wave/Cascading Waves/Static move is illegal}\end{verbatim*} )
...
\TODO :: legal to diverge back to starting position, if activated in a cascade (i.e. not first piece in a cascade)
