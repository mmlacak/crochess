...
\vspace*{-0.7\baselineskip}
\hyperref[fig:scn_tr_31_checking_king_pawns]{Again}, if King is in check (or,
checkmated) is determined after a move has finished, but before next one starts.\newline
\indent
King is in check only if there are no material pieces between a King and an attacking
piece on its capture-fields; Waves cannot block check, since
...
in one ply, if they're aligned on it's capture-fields; King participating in such an
alignment behind a material piece is still not in check.

\vspace*{-1.1\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_025_checking_king_immediate.png}
\vspace*{-1.5\baselineskip}
\caption{Dark King is in check}
\label{fig:scn_cot_025_checking_king_immediate}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_026_checking_king_gap.png}
\vspace*{-1.5\baselineskip}
\caption{Dark King not in check, by gap}
\label{fig:scn_cot_026_checking_king_gap}
\end{figure}

\vspace*{-0.7\baselineskip}
Shaman cannot cross over empty capture-fields; so, dark King here is not in check.

\vspace*{-1.1\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_027_checking_king_blocked.png}
\vspace*{-1.5\baselineskip}
\caption{Dark King not in check, by block}
\label{fig:scn_cot_027_checking_king_blocked}
\end{figure}

\vspace*{-0.7\baselineskip}
Shaman is also \hyperref[fig:scn_cot_005_light_shaman_capture_ply_passives]{blocked from moving any further}
...
% \TODO :: Shaman does not check opponent's King, even if in alignement over capture-fields; only if directly on the very first capture-field
...
\hyperref[fig:scn_mv_053_static_move_is_illegal_init]{cannot end its move on a starting field}.
...
\hyperref[fig:scn_mv_053_static_move_is_illegal_init]{as with any piece starting a cascade}, it's
...
\vspace*{-0.5\baselineskip}
Wave cannot diverge, if
\hyperref[fig:scn_tr_33_serpent_activating_wave]{activated by Serpent},
neither from own, nor from opponent's Shaman.
...
\hyperref[fig:scn_mv_053_static_move_is_illegal_init]{cannot return to its starting field},
if it's first piece in a cascade (or, the only one in a move). Diverging piece which was
\hyperref[fig:scn_mv_055_static_piece_is_legal_init]{not the first in a cascade can return}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_059_diverging_first_piece.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_060_diverged_first_piece_illegal.png}
\vspace*{-0.4\baselineskip}
...
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_061_diverging_activated_piece.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_062_diverged_activated_piece_legal.png}
\vspace*{-0.4\baselineskip}
