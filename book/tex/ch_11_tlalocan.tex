...
\vspace*{-0.7\baselineskip}
Any interuption of capturing also ends Shaman's capturing ply. Shaman cannot cross
...
So, Shaman cannot use Wave's transparency to move over, and continue capturing
afterwards; King beyond the end of such a ply is not in check.\newline
\indent
Here, light Shaman can capture dark Wave, and activate light Wave; dark King is
still not in check.
