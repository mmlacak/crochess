...
\indent
Pawn, in this and all subsequent variants, can diverge from own Shaman by making
forward-, sideways-, or capture-step, or by rushing. After divergence, steps are
available as if starting a new ply; forward- and sideways-steps if not blocked;
capture-steps if opponent's piece is placed on a Pawn's capture-field behind own,
divergent Shaman.
...
Diverging Pawn is limited by momentum it had when own Shaman was encountered;
