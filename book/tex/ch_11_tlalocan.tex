...
% TODO :: currently illegal :: move whole divergence section after trance-journey :: change to trance-journey own, divergent Shaman
%
% ... Shaman has to have momenum to be able to diverge; otherwise it could only activate Shaman.
%
% TODO :: currently illegal :: move whole divergence section after trance-journey :: change to trance-journey own, divergent Shaman
...
\vspace*{-0.5\baselineskip}
After divergence, Shaman can also capture all opponent's pieces positioned in one
uninterrupted string (here, dark Pawns), capture dark Knight, or activate own pieces
(light Pyramid, Wave B), provided that it has enough momentum. \newline
\indent
Here, single-step Shamans (B, D) can capture dark Knight, only one dark Pawn, or
activate Wave B (blue arrows); multi-step Shamans (A, C) can also capture two more
Pawns, or activate light Pyramid (blue, green arrows).

\clearpage % ..........................................................

\TODO

Shaman can diverge from opponent's Shaman (???)
...
\addcontentsline{toc}{subsubsection}{Can't diverge, if activated by Unicorn}
...
\addcontentsline{toc}{subsubsection}{Can't diverge, if activated by Centaur}
...
\addcontentsline{toc}{subsubsection}{Can't diverge, if activated by Serpent}
\label{sec:Conquest of Tlalocan/Divergence/Can't diverge, if activated by Serpent}

\vspace*{-1.4\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_30_wave_cannot_diverge_if_activated_by_serpent.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_31_multiple_divergences.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_32_diverging_opponents_pieces.png}
\vspace*{-1.3\baselineskip}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_33_trance_journey_init.png}
\caption{Start}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_34_knight_directions.png}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_35_stop_sign_pattern.png}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_36_stop_sign_pattern_unwind.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_38_light_shaman_trance_journey.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_39_light_shaman_trance_journey_offset.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_40_dark_shaman_trance_journey.png}
\vspace*{-1.4\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_41_displacement_fields.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_42_light_light_shaman_interaction_start.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_43_light_light_shaman_interaction_end.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_44_dark_light_shaman_interaction_start.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_45_dark_light_shaman_interaction_end.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_46_dark_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_47_dark_dark_shaman_interaction_end.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_48_dark_dark_shaman_double_interaction_start.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_49_dark_dark_shaman_double_interaction_end.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_50_light_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_51_light_dark_shaman_interaction_end.png}
...
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_52_backward_displacement_start.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_53_backward_displacement_end.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_54_forward_displacement_start.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_55_forward_displacement_step_2.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_56_forward_displacement_end.png}
...
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_57_push_pull_entrancement_start.png}
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_58_push_pull_entrancement_2.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_59_push_pull_entrancement_end.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_60_scout_pawns.png}
\caption{Scout Pawns}
