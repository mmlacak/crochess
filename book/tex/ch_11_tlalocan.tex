...
Shaman taking on trance-journey is called entranced Shaman (in this example, dark Shaman),
...
So, starting step (green) has both legs with length of 1. Next step (blue) has up and up-left
...
symetrical pattern starting with left leg, i.e. rotated by 180$^{\circ}$. % degrees.
...
position outwards. Shaman can access all step-fields on chosen colored pattern, and can stop
at any of them, even if previous step-fields lays outside of chessboard.
