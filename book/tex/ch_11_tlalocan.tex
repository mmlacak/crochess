...
% \noindent
% \begin{figure}[!h]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_010_wave_activated.png}
% \caption{Shaman activated Wave}
% \label{fig:scn_cot_010_wave_activated}
% \end{figure}
...
\vspace*{-1.4\baselineskip}
\caption{Activating on step-fields}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_011_shaman_is_semi_transparent.png}
\vspace*{-1.4\baselineskip}
\caption{Shaman is semi-transparent}
\label{fig:scn_cot_011_shaman_is_semi_transparent}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_012_unicorn_is_transparent_to_shamans.png}
\vspace*{-1.4\baselineskip}
\caption{Unicorn is transparent to Shamans}
\label{fig:scn_cot_012_unicorn_is_transparent_to_shamans}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_013_teleport_shaman_all.png}
\caption{Teleporting Shaman}
\label{fig:scn_cot_013_teleport_shaman_all}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_014_teleport_pawn_init.png}
\caption{Teleporting Pawn}
\label{fig:scn_cot_014_teleport_pawn_init}
\end{figure}
