...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_26_wave_divergence_init.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_27_wave_divergence_1.png}
\vspace*{-1.3\baselineskip}
...
\subsubsection*{Wave cannot diverge, if activated by Unicorn}
\addcontentsline{toc}{subsubsection}{Wave cannot diverge, if activated by Unicorn}
\label{sec:Conquest of Tlalocan/Divergence/Wave cannot diverge, if activated by Unicorn/1}

\vspace*{-1.4\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_28_wave_cannot_diverge_if_activated_by_unicorn.png}
\vspace*{-1.3\baselineskip}
...
\subsubsection*{Wave cannot diverge, if activated by Centaur}
\addcontentsline{toc}{subsubsection}{Wave cannot diverge, if activated by Centaur}
\label{sec:Conquest of Tlalocan/Divergence/Wave cannot diverge, if activated by Centaur/2}

\vspace*{-1.2\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_29_wave_cannot_diverge_if_activated_by_centaur.png}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_30_trance_journey_init.png}
\caption{Start}
\label{fig:scn_cot_30_trance_journey_init}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_31_knight_directions.png}
\caption{Knight directions}
\label{fig:scn_cot_31_knight_directions}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_32_stop_sign_pattern.png}
\caption{Stop sign pattern}
\label{fig:scn_cot_32_stop_sign_pattern}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_33_stop_sign_pattern_unwind.png}
\caption{Stop sign pattern unwinded}
\label{fig:scn_cot_33_stop_sign_pattern_unwind}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_35_light_shaman_trance_journey.png}
\caption{Light Shaman trance-journey}
\label{fig:scn_cot_35_light_shaman_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_36_light_shaman_trance_journey_offset.png}
\caption{Light Shaman trance-journey with offset}
\label{fig:scn_cot_36_light_shaman_trance_journey_offset}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_37_dark_shaman_trance_journey.png}
\vspace*{-1.4\baselineskip}
\caption{Dark Shaman trance-journey}
\label{fig:scn_cot_37_dark_shaman_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_38_displacement_fields.png}
\caption{Displacement-fields}
\label{fig:scn_cot_38_displacement_fields}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_39_light_light_shaman_interaction_start.png}
\caption{Light $\rightarrow$ light Shaman interaction start}
\label{fig:scn_cot_39_light_light_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_40_light_light_shaman_interaction_end.png}
\caption{Light $\rightarrow$ light Shaman interaction end}
\label{fig:scn_cot_40_light_light_shaman_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_41_dark_light_shaman_interaction_start.png}
\caption{Dark $\rightarrow$ light Shaman interaction start}
\label{fig:scn_cot_41_dark_light_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_42_dark_light_shaman_interaction_end.png}
\caption{Dark $\rightarrow$ light Shaman interaction end}
\label{fig:scn_cot_42_dark_light_shaman_interaction_end}
\end{figure}

Like in
\hyperref[fig:scn_cot_39_light_light_shaman_interaction_start]{the previous example},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_43_dark_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
\caption{Dark $\rightarrow$ dark Shaman interaction start}
\label{fig:scn_cot_43_dark_dark_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_44_dark_dark_shaman_interaction_end.png}
\caption{Dark $\rightarrow$ dark Shaman interaction end}
\label{fig:scn_cot_44_dark_dark_shaman_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_45_dark_dark_shaman_double_interaction_start.png}
\caption{Dark $\rightarrow$ dark Shaman double start}
\label{fig:scn_cot_45_dark_dark_shaman_double_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_46_dark_dark_shaman_double_interaction_end.png}
\caption{Dark $\rightarrow$ dark Shaman double end}
\label{fig:scn_cot_46_dark_dark_shaman_double_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_47_light_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
\caption{Light $\rightarrow$ dark Shaman interaction start}
\label{fig:scn_cot_47_light_dark_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_48_light_dark_shaman_interaction_end.png}
\caption{Light $\rightarrow$ dark Shaman interaction end}
\label{fig:scn_cot_48_light_dark_shaman_interaction_end}
\end{figure}

Here, displacement-fields of light Knight are marked (blue), while for dark Pawn
they are enumerated (green).
\hyperref[fig:scn_cot_40_light_light_shaman_interaction_end]{Again}, displacements
...
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_49_backward_displacement_start.png}
\caption{Backward displacement start}
\label{fig:scn_cot_49_backward_displacement_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_50_backward_displacement_end.png}
\caption{Backward displacement end}
\label{fig:scn_cot_50_backward_displacement_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_51_forward_displacement_start.png}
\caption{Forward displacement start}
\label{fig:scn_cot_51_forward_displacement_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_52_forward_displacement_step_2.png}
\caption{Forward displacement, step 2}
\label{fig:scn_cot_52_forward_displacement_step_2}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_53_forward_displacement_end.png}
\caption{Forward displacement end}
\label{fig:scn_cot_53_forward_displacement_end}
\end{figure}
...
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_54_push_pull_entrancement_start.png}
\caption{Push-pull entrancement start}
\label{fig:star/scn_cot_54_push_pull_entrancement_start}
\end{wrapfigure}
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_55_push_pull_entrancement_2.png}
\caption{Push-pull entrancement step}
\label{fig:star/scn_cot_55_push_pull_entrancement_2}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_56_push_pull_entrancement_end.png}
\caption{Push-pull entrancement end}
\label{fig:scn_cot_56_push_pull_entrancement_end}
\end{figure}

When entrancing and entranced Shamans are the same, their colors are the same, and so only: \newline
\hyperref[fig:scn_cot_39_light_light_shaman_interaction_start]{light $\rightarrow$ light Shaman}, \newline
\hyperref[fig:scn_cot_43_dark_dark_shaman_interaction_start]{dark $\rightarrow$ dark Shaman}, and \newline
\hyperref[fig:scn_cot_45_dark_dark_shaman_double_interaction_start]{dark $\rightarrow$ dark Shaman double}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_57_scout_pawns.png}
\caption{Scout Pawns}
\label{fig:scn_cot_57_scout_pawns}
\end{figure}
