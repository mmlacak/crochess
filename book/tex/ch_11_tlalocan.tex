...
\end{wrapfigure}
Shaman starting a cascade can also be activated later during the very same cascade, and go onto
trance-journey. That cascade features push-pull entrancement. This is basically
...
\end{wrapfigure}
If not starting a cascade, Shaman can be activated twice in the same cascade, to self-entrance itself
into a trance-journey.

In all cases, to qualify as a self-entrancement, there should be no other Shamans in a cascade between
starting a cascade/first activation and final activation of our Shaman.
