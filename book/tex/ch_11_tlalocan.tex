...
neither in other step- nor any capture-field.
...
\centering
\includegraphics[width=0.4\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_03_light_shaman_step_ply_no_capture.png}
\vspace*{-1.4\baselineskip}
\caption{No capture}
\label{fig:scn_cot_03_light_shaman_step_ply_no_capture}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_04_light_shaman_capture_ply.png}
\vspace*{-1.4\baselineskip}
\caption{Light Shaman's capture-ply}
\label{fig:scn_cot_04_light_shaman_capture_ply}
\end{figure}
...
there. Empty capture-fields cannot be overstepped, any piece at a distant capture-field
is out of reach.

\noindent
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.391666667\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_05_light_shaman_capture_ply_passives.png}
\vspace*{-1.4\baselineskip}
\caption{Activation}
\label{fig:scn_cot_05_light_shaman_capture_ply_passives}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_06_dark_shaman_step_ply.png}
\vspace*{-1.4\baselineskip}
\caption{Dark Shaman's step-ply}
\label{fig:scn_cot_06_dark_shaman_step_ply}
\end{figure}

\vspace*{-0.4\baselineskip}
Dark Shaman's stepping ply is the same as
\hyperref[fig:scn_cot_02_light_shaman_step_ply]{light Shaman's}, except it uses
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_08_dark_shaman_capture_ply.png}
\vspace*{-1.4\baselineskip}
\caption{Dark Shaman's capture-ply}
\label{fig:scn_cot_08_dark_shaman_capture_ply}
\end{figure}

\vspace*{-0.4\baselineskip}
Dark Shaman's capturing ply is the same as
\hyperref[fig:scn_cot_04_light_shaman_capture_ply]{light Shaman's}, except it uses
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_10_wave_activated.png}
\caption{Shaman activated Wave}
\label{fig:scn_cot_10_wave_activated}
\end{figure}

Activated Wave moves the same as activating piece in the moment of activation.
So, if activated on, say,
\hyperref[fig:scn_cot_04_light_shaman_capture_ply]{light Shaman's capture-field},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_11_shaman_is_semi_transparent.png}
\vspace*{-1.4\baselineskip}
\caption{Shaman is semi-transparent}
\label{fig:scn_cot_11_shaman_is_semi_transparent}
\end{figure}
...
and to opponent's Shaman. Here, light Bishop encountering own Shaman A cannot interact
with it, but can move behind it. Dark Bishop encountering opponent's Shaman B can
capture it, but is blocked from moving any further. Dark Shaman encountering opponent's
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_12_unicorn_is_transparent_to_shamans.png}
\vspace*{-1.4\baselineskip}
\caption{Unicorn is transparent to Shamans}
\label{fig:scn_cot_12_unicorn_is_transparent_to_shamans}
\end{figure}

\vspace*{-0.5\baselineskip}
Image above have four examples presented in parallel featuring light Unicorns A, B,
C and D; each in its own corner. \newline
\indent
Unicorn \hyperref[fig:scn_mv_07_wave_is_transparent]{is transparent} only to Shamans,
both own, and opponent's. Here, dark pieces can capture light Unicorn, light pieces
cannot interact with it. Both Bishops are blocked from moving any further by Unicorn
they encountered, as would be all the other pieces, except Shamans; both Shamans can
continue their movement past Unicorn.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_13_teleport_shaman_all.png}
\caption{Teleporting Shaman}
\label{fig:scn_cot_13_teleport_shaman_all}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_14_teleport_pawn_init.png}
\caption{Teleporting Pawn}
\label{fig:scn_cot_14_teleport_pawn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_20_own_shaman_is_divergent_init.png}
\vspace*{-1.3\baselineskip}
\caption{Own Shaman is divergent}
\label{fig:scn_cot_20_own_shaman_is_divergent_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_21_own_shaman_is_divergent_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Queen}
\label{fig:scn_cot_21_own_shaman_is_divergent_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_22_diverging_activated_piece_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Rook}
\label{fig:scn_cot_22_diverging_activated_piece_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_23_diverging_activated_piece_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging activated Rook}
\label{fig:scn_cot_23_diverging_activated_piece_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_24_diverging_pawn_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Pawns start}
\label{fig:scn_cot_24_diverging_pawn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_25_diverging_pawn_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Pawns end}
\label{fig:scn_cot_25_diverging_pawn_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_26_diverging_rushing_pawn.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging rushing Pawn}
\label{fig:scn_cot_26_diverging_rushing_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_27_diverging_unicorn_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Unicorn start}
\label{fig:scn_cot_27_diverging_unicorn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_28_diverging_unicorn_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Unicorn end}
\label{fig:scn_cot_28_diverging_unicorn_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_29_activated_unicorn_divergence_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Unicorn}
\label{fig:scn_cot_29_activated_unicorn_divergence_init}
\end{figure}
...
\hyperref[fig:scn_cot_27_diverging_unicorn_init]{only one additional step}; this also
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_30_activated_unicorn_divergence_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging activated Unicorn}
\label{fig:scn_cot_30_activated_unicorn_divergence_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_31_centaur_cannot_diverge.png}
\vspace*{-1.3\baselineskip}
\caption{Centaur cannot diverge}
\label{fig:scn_cot_31_centaur_cannot_diverge}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_32_serpent_cannot_diverge.png}
\vspace*{-1.3\baselineskip}
\caption{Serpent cannot diverge}
\label{fig:scn_cot_32_serpent_cannot_diverge}
\end{figure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_33_king_cannot_diverge.png}
% \vspace*{-1.3\baselineskip}
\caption{King cannot diverge}
\label{fig:scn_cot_33_king_cannot_diverge}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_34_diverging_shaman_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Shamans}
\label{fig:scn_cot_34_diverging_shaman_init}
\end{figure}
...
similarly to \hyperref[fig:scn_cot_24_diverging_pawn_init]{diverging Pawns}.
\hyperref[fig:scn_cot_22_diverging_activated_piece_init]{Like before}, activated
Shaman has to have momentum to be able to diverge.

\TODO :: simplify \& add example for capture-ply containing divergence
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_35_diverging_shaman_steps.png}
\vspace*{-1.3\baselineskip}
\caption{Steps after divergence}
\label{fig:scn_cot_35_diverging_shaman_steps}
\end{figure}
...
\hyperref[fig:scn_cot_21_own_shaman_is_divergent_end]{limited by momentum it had when own Shaman was encountered}. \newline
\indent
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_36_diverging_shaman_captures.png}
\vspace*{-1.4\baselineskip}
\caption{Capture-steps after divergence}
\label{fig:scn_cot_36_diverging_shaman_captures}
\end{figure}

\vspace*{-0.6\baselineskip}
After divergence, Shaman can also capture opponent's pieces on its capture-fields,
\hyperref[fig:scn_cot_04_light_shaman_capture_ply]{lined in one direction, with no gaps}.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_37_diverging_shaman_from_opponents.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging from opponent's Shaman}
\label{fig:scn_cot_37_diverging_shaman_from_opponents}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_38_wave_divergence_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Wave}
\label{fig:scn_cot_38_wave_divergence_init}
\end{figure}
...
Again, \hyperref[fig:scn_cot_20_own_shaman_is_divergent_init]{divergence is optional},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_39_wave_divergence_1.png}
\vspace*{-1.3\baselineskip}
\caption{Wave diverted}
\label{fig:scn_cot_39_wave_divergence_1}
\end{figure}
...
\hyperref[fig:scn_cot_21_own_shaman_is_divergent_end]{illegal to return to its starting field} Q.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_40_wave_cannot_diverge_if_activated_by_unicorn.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Unicorn}
\label{fig:scn_cot_40_wave_cannot_diverge_if_activated_by_unicorn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_41_wave_cannot_diverge_if_activated_by_centaur.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Centaur}
\label{fig:scn_cot_41_wave_cannot_diverge_if_activated_by_centaur}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_42_wave_cannot_diverge_if_activated_by_serpent.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Serpent}
\label{fig:scn_cot_42_wave_cannot_diverge_if_activated_by_serpent}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_43_multiple_divergences.png}
\vspace*{-1.3\baselineskip}
\caption{Multiple divergences}
\label{fig:scn_cot_43_multiple_divergences}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_44_diverging_opponents_pieces.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging opponent's pieces}
\label{fig:scn_cot_44_diverging_opponents_pieces}
\end{figure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_45_diverging_first_piece.png}
\vspace*{-0.4\baselineskip}
\caption{Diverging move starter}
\label{fig:scn_cot_45_diverging_first_piece}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_46_diverged_first_piece_illegal.png}
\vspace*{-0.4\baselineskip}
\caption{Diverged move starter}
\label{fig:scn_cot_46_diverged_first_piece_illegal}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_47_diverging_activated_piece.png}
\vspace*{-0.4\baselineskip}
\caption{Diverging activated piece}
\label{fig:scn_cot_47_diverging_activated_piece}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_48_diverged_activated_piece_legal.png}
\vspace*{-0.4\baselineskip}
\caption{Diverged activated piece}
\label{fig:scn_cot_48_diverged_activated_piece_legal}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_60_trance_fields.png}
\vspace*{-0.4\baselineskip}
\caption{Trance-fields}
\label{fig:scn_cot_60_trance_fields}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_61_entrancement_init.png}
\vspace*{-0.4\baselineskip}
\caption{Entrancement preparation}
\label{fig:scn_cot_61_entrancement_init}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_62_entrancement_step.png}
\vspace*{-0.4\baselineskip}
\caption{Entrancement step}
\label{fig:scn_cot_62_entrancement_step}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_63_entrancement_activated.png}
\vspace*{-0.4\baselineskip}
\caption{Entrancement by activated Shaman}
\label{fig:scn_cot_63_entrancement_activated}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_64_entrancement_repositioning.png}
\vspace*{-0.4\baselineskip}
\caption{Repositioning light Shaman}
\label{fig:scn_cot_64_entrancement_repositioning}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_65_entrancement_cascade.png}
\vspace*{-0.4\baselineskip}
\caption{Entrancing dark Shaman}
\label{fig:scn_cot_65_entrancement_cascade}
\end{wrapfigure}
...
\begin{wrapfigure}[10]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_66_knight_directions.png}
\vspace*{-0.4\baselineskip}
\caption{Knight directions}
\label{fig:scn_cot_66_knight_directions}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_67_stop_sign_pattern.png}
\vspace*{-0.4\baselineskip}
\caption{Stop sign pattern}
\label{fig:scn_cot_67_stop_sign_pattern}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_70_stop_sign_pattern_unwind.png}
\caption{Stop sign pattern unwinded}
\label{fig:scn_cot_70_stop_sign_pattern_unwind}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_72_light_shaman_trance_journey.png}
\vspace*{-1.3\baselineskip}
\caption{Light Shaman trance-journey}
\label{fig:scn_cot_72_light_shaman_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_73_light_shaman_trance_journey_offset.png}
\caption{Light Shaman trance-journey with offset}
\label{fig:scn_cot_73_light_shaman_trance_journey_offset}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_74_dark_shaman_trance_journey.png}
\vspace*{-1.4\baselineskip}
\caption{Dark Shaman trance-journey}
\label{fig:scn_cot_74_dark_shaman_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_75_displacement_fields.png}
\caption{Displacement-fields}
\label{fig:scn_cot_75_displacement_fields}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_76_light_light_shaman_interaction_start.png}
\caption{Light $\rightarrow$ light Shaman interaction start}
\label{fig:scn_cot_76_light_light_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_77_light_light_shaman_interaction_end.png}
\caption{Light $\rightarrow$ light Shaman interaction end}
\label{fig:scn_cot_77_light_light_shaman_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_78_dark_light_shaman_interaction_start.png}
\caption{Dark $\rightarrow$ light Shaman interaction start}
\label{fig:scn_cot_78_dark_light_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_79_dark_light_shaman_interaction_end.png}
\caption{Dark $\rightarrow$ light Shaman interaction end}
\label{fig:scn_cot_79_dark_light_shaman_interaction_end}
\end{figure}

Like in
\hyperref[fig:scn_cot_76_light_light_shaman_interaction_start]{the previous example},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_80_dark_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
\caption{Dark $\rightarrow$ dark Shaman interaction start}
\label{fig:scn_cot_80_dark_dark_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_81_dark_dark_shaman_interaction_end.png}
\caption{Dark $\rightarrow$ dark Shaman interaction end}
\label{fig:scn_cot_81_dark_dark_shaman_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_82_dark_dark_shaman_double_interaction_start.png}
\caption{Dark $\rightarrow$ dark Shaman double start}
\label{fig:scn_cot_82_dark_dark_shaman_double_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_83_dark_dark_shaman_double_interaction_end.png}
\caption{Dark $\rightarrow$ dark Shaman double end}
\label{fig:scn_cot_83_dark_dark_shaman_double_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_84_light_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
\caption{Light $\rightarrow$ dark Shaman interaction start}
\label{fig:scn_cot_84_light_dark_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_85_light_dark_shaman_interaction_end.png}
\caption{Light $\rightarrow$ dark Shaman interaction end}
\label{fig:scn_cot_85_light_dark_shaman_interaction_end}
\end{figure}

Here, displacement-fields of light Knight are marked (blue), while for dark Pawn
they are enumerated (green).
\hyperref[fig:scn_cot_77_light_light_shaman_interaction_end]{Again}, displacements
...
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_86_backward_displacement_start.png}
\caption{Backward displacement start}
\label{fig:scn_cot_86_backward_displacement_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_87_backward_displacement_end.png}
\caption{Backward displacement end}
\label{fig:scn_cot_87_backward_displacement_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_88_forward_displacement_start.png}
\caption{Forward displacement start}
\label{fig:scn_cot_88_forward_displacement_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_89_forward_displacement_step_2.png}
\caption{Forward displacement, step 2}
\label{fig:scn_cot_89_forward_displacement_step_2}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_90_forward_displacement_end.png}
\caption{Forward displacement end}
\label{fig:scn_cot_90_forward_displacement_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_100_troopers_initial_positions.png}
\caption{Initial positions of Scouts, Grenadiers}
\label{fig:scn_cot_100_troopers_initial_positions}
\end{figure}
