...
\vspace*{-0.4\baselineskip}
\caption{Pawn rushing to diverge}
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.220833333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_037_diverged_rushing_pawn.png}
\vspace*{-0.4\baselineskip}
\caption{Diverged rushing Pawn}
\label{fig:scn_cot_037_diverged_rushing_pawn}
\end{wrapfigure}
. . .
