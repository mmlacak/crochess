...
Trance-journey can be started by Shaman activating another Shaman on its trance-field,
with no other pieces between the two. Colors of Shamans do not need to match.
...
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_34_trance_fields.png}
\caption{Trance-fields}
\label{fig:scn_cot_34_trance_fields}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_35_entrancement_init.png}
\caption{Entrancement preparation}
\label{fig:scn_cot_35_entrancement_init}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_36_entrancement_step.png}
\caption{Entrancement step}
\label{fig:scn_cot_36_entrancement_step}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_37_entrancement_activated.png}
\caption{Entrancement activated}
\label{fig:scn_cot_37_entrancement_activated}
\end{wrapfigure}
. . .
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_34_trance_journey_init.png}
\caption{Start}
\label{fig:scn_cot_34_trance_journey_init}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_35_knight_directions.png}
\caption{Knight directions}
\label{fig:scn_cot_35_knight_directions}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_36_stop_sign_pattern.png}
\caption{Stop sign pattern}
\label{fig:scn_cot_36_stop_sign_pattern}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_37_stop_sign_pattern_unwind.png}
\caption{Stop sign pattern unwinded}
\label{fig:scn_cot_37_stop_sign_pattern_unwind}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_39_light_shaman_trance_journey.png}
\caption{Light Shaman trance-journey}
\label{fig:scn_cot_39_light_shaman_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_40_light_shaman_trance_journey_offset.png}
\caption{Light Shaman trance-journey with offset}
\label{fig:scn_cot_40_light_shaman_trance_journey_offset}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_41_dark_shaman_trance_journey.png}
\vspace*{-1.4\baselineskip}
\caption{Dark Shaman trance-journey}
\label{fig:scn_cot_41_dark_shaman_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_42_displacement_fields.png}
\caption{Displacement-fields}
\label{fig:scn_cot_42_displacement_fields}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_43_light_light_shaman_interaction_start.png}
\caption{Light $\rightarrow$ light Shaman interaction start}
\label{fig:scn_cot_43_light_light_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_44_light_light_shaman_interaction_end.png}
\caption{Light $\rightarrow$ light Shaman interaction end}
\label{fig:scn_cot_44_light_light_shaman_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_45_dark_light_shaman_interaction_start.png}
\caption{Dark $\rightarrow$ light Shaman interaction start}
\label{fig:scn_cot_45_dark_light_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_46_dark_light_shaman_interaction_end.png}
\caption{Dark $\rightarrow$ light Shaman interaction end}
\label{fig:scn_cot_46_dark_light_shaman_interaction_end}
\end{figure}

Like in
\hyperref[fig:scn_cot_43_light_light_shaman_interaction_start]{the previous example},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_47_dark_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
\caption{Dark $\rightarrow$ dark Shaman interaction start}
\label{fig:scn_cot_47_dark_dark_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_48_dark_dark_shaman_interaction_end.png}
\caption{Dark $\rightarrow$ dark Shaman interaction end}
\label{fig:scn_cot_48_dark_dark_shaman_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_49_dark_dark_shaman_double_interaction_start.png}
\caption{Dark $\rightarrow$ dark Shaman double start}
\label{fig:scn_cot_49_dark_dark_shaman_double_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_50_dark_dark_shaman_double_interaction_end.png}
\caption{Dark $\rightarrow$ dark Shaman double end}
\label{fig:scn_cot_50_dark_dark_shaman_double_interaction_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_51_light_dark_shaman_interaction_start.png}
\vspace*{-1.4\baselineskip}
\caption{Light $\rightarrow$ dark Shaman interaction start}
\label{fig:scn_cot_51_light_dark_shaman_interaction_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_52_light_dark_shaman_interaction_end.png}
\caption{Light $\rightarrow$ dark Shaman interaction end}
\label{fig:scn_cot_52_light_dark_shaman_interaction_end}
\end{figure}

Here, displacement-fields of light Knight are marked (blue), while for dark Pawn
they are enumerated (green).
\hyperref[fig:scn_cot_44_light_light_shaman_interaction_end]{Again}, displacements
...
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_53_backward_displacement_start.png}
\caption{Backward displacement start}
\label{fig:scn_cot_53_backward_displacement_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_54_backward_displacement_end.png}
\caption{Backward displacement end}
\label{fig:scn_cot_54_backward_displacement_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_55_forward_displacement_start.png}
\caption{Forward displacement start}
\label{fig:scn_cot_55_forward_displacement_start}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_56_forward_displacement_step_2.png}
\caption{Forward displacement, step 2}
\label{fig:scn_cot_56_forward_displacement_step_2}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_57_forward_displacement_end.png}
\caption{Forward displacement end}
\label{fig:scn_cot_57_forward_displacement_end}
\end{figure}
...
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_58_push_pull_entrancement_start.png}
\caption{Push-pull entrancement start}
\label{fig:star/scn_cot_58_push_pull_entrancement_start}
\end{wrapfigure}
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_59_push_pull_entrancement_2.png}
\caption{Push-pull entrancement step}
\label{fig:star/scn_cot_59_push_pull_entrancement_2}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_60_push_pull_entrancement_end.png}
\caption{Push-pull entrancement end}
\label{fig:scn_cot_60_push_pull_entrancement_end}
\end{figure}

When entrancing and entranced Shamans are the same, their colors are the same, and so only: \newline
\hyperref[fig:scn_cot_43_light_light_shaman_interaction_start]{light $\rightarrow$ light Shaman}, \newline
\hyperref[fig:scn_cot_47_dark_dark_shaman_interaction_start]{dark $\rightarrow$ dark Shaman}, and \newline
\hyperref[fig:scn_cot_49_dark_dark_shaman_double_interaction_start]{dark $\rightarrow$ dark Shaman double}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_61_scout_pawns.png}
\caption{Scout Pawns}
\label{fig:scn_cot_61_scout_pawns}
\end{figure}
