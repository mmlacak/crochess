...
Displacement can be performed regardless of any other surrouding pieces, it is enough
if destination field is empty. Destination field must exists on chessboard, i.e. it's
not possible to displace piece onto a virtual field outside of a board.
...
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_26_backward_interaction_start.png}
\caption{Backward displacement start}
\label{fig:scn_cot_26_backward_interaction_start}
% \centering
\end{figure}

It's possible to displace piece between 2 step-fields closest to Shaman's starting position.
In example above, dark Bishop could be displaced from field 2 back onto field 1 (i.e.
displacement field 31). Such a displacement (when piece is displaced onto field already
travelled over by entranced Shaman) is called backward displacement.
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_27_backward_interaction_end.png}
\caption{Backward displacement end}
\label{fig:scn_cot_27_backward_interaction_end}
% \centering
\end{figure}

Entranced Shaman can only continue to move forward (green), and so backward displaced piece
(here, dark Bishop) is out of reach (grey).
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_28_forward_interaction_start.png}
\caption{Forward displacement start}
\label{fig:scn_cot_28_forward_interaction_start}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_29_forward_interaction_end.png}
\caption{Forward displacement end}
\label{fig:scn_cot_29_forward_interaction_end}
% \centering
\end{figure}
