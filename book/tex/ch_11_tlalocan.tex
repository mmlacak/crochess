...
\subsection*{Wave cannot diverge}
\addcontentsline{toc}{subsection}{Wave cannot diverge}
\label{sec:Conquest of Tlalocan/Divergence/Wave cannot diverge/1}

\vspace*{-1.4\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_28_wave_cannot_diverge_init.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Unicorn}
\label{fig:scn_cot_28_wave_cannot_diverge_init}
\end{figure}
...
\subsection*{Wave cannot diverge}
\addcontentsline{toc}{subsection}{Wave cannot diverge}
\label{sec:Conquest of Tlalocan/Divergence/Wave cannot diverge/2}

\vspace*{-1.2\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_29_wave_cannot_diverge.png}
\caption{Wave cannot diverge}
\label{fig:scn_cot_29_wave_cannot_diverge}
\end{figure}
