...
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_05_stop_sign_pattern.png}
\caption{Stop sign pattern}
\label{fig:scn_cot_05_stop_sign_pattern}
\end{wrapfigure}
...
...
\begin{wrapfigure}{l}{0.4\textwidth} % [11]
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_06_stop_sign_pattern_unwind.png}
\caption{Stop sign pattern unwinded}
\label{fig:scn_cot_06_stop_sign_pattern_unwind}
\end{wrapfigure}
...
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_07_stop_sign_pattern_full.png}
\caption{Stop sign pattern on chessboard}
\label{fig:scn_cot_07_stop_sign_pattern_full}
% \centering
\end{figure}
