...
Shaman can continue capturing in the same ply, as long as there are opponent's pieces
to capture. Once capturing, Shaman cannot change direction of a ply into any step- or
other capture-field, even if opponent's piece is placed there. Empty capture-fields
cannot be oversteped, any piece at a distant capture-field is out of reach.
...
\end{wrapfigure}
Last (or, the only) action in a capture-ply can be e.g. activation, or teleportation.
% Again, once started capturing, Shaman cannot
