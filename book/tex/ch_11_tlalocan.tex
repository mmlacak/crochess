...
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_31_push_pull_entrancement_start.png}
\caption{Push-pull entrancement start}
\label{fig:star/scn_cot_31_push_pull_entrancement_start}
\end{wrapfigure}
Shaman starting a cascade can also be activated during the very same cascade. If there were no
other Shamans in between our Shaman starting a cascade and being activated, that self-entrancement
would be called push-pull entrancement, similar to
\hyperref[txt:Miranda's veil/Cascading Waves/Push-pull activation]{push-pull activation}.

\vspace*{0.1\textheight}
\noindent
\begin{wrapfigure}{l}{0.4\textwidth}
\centering
\includegraphics[width=0.208333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_32_push_pull_entrancement_2.png}
\caption{Push-pull entrancement step}
\label{fig:star/scn_cot_32_push_pull_entrancement_2}
\end{wrapfigure}
The same self-entrancement result can be obtained by activating Shaman twice within the same cascade,
again, if there were no other Shamans in a cascade between our Shaman's activations.

When entrancing and entranced Shamans are the same, their colors are the same, and so only:
\begin{itemize}[nosep]
\item \hyperref[fig:scn_cot_16_light_light_shaman_interaction_start]{light $\rightarrow$ light Shaman}
\item \hyperref[fig:scn_cot_20_dark_dark_shaman_interaction_start]{dark $\rightarrow$ dark Shaman}
\item \hyperref[fig:scn_cot_22_dark_dark_shaman_double_interaction_start]{dark $\rightarrow$ dark Shaman double}
\end{itemize}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_33_push_pull_entrancement_end.png}
