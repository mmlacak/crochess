...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_07_teleport_shaman_step_fields.png}
\caption{On step-fields}
\label{fig:scn_cot_07_teleport_shaman_step_fields}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_08_teleport_shaman_capture_fields.png}
\caption{On capture-fields}
\label{fig:scn_cot_08_teleport_shaman_capture_fields}
% \centering
\end{figure}
