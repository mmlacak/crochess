...
\indent
On its step-fields Shaman cannot capture opponent's Shaman, but it can continue
its movement past encountered Shaman.

\vspace*{1.7\baselineskip}
\noindent
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.391666667\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_015_shaman_transparency_not_heeded_while_capturing.png}
\vspace*{-1.4\baselineskip}
\caption{Not heeded while capturing}
\label{fig:scn_cot_015_shaman_transparency_not_heeded_while_capturing}
\end{wrapfigure}
Note, on its capture-fields Shaman can continue its movement only so far as it
continues capturing opponent's pieces. \newline
\indent
If opponent's Shaman transparency is heeded it's equivalent to empty capture-field,
and so capturing Shaman would be blocked from moving any further.

\clearpage % ..........................................................

% \vspace*{2.7\baselineskip}
\TODO \newline
1. activated piece must have momentum to pass-through transparent Shaman \newline
2. link 1. from sec:Conquest of Tlalocan/Divergence/... if activated
...
\end{wrapfigure}
Here, light Shaman B is activated with only two momentum, which are then used to
reach divergent Shaman A, so there will be no momentum left to diverge. \newline
\indent
While Shamans are transparent to own pieces, passing through still requires
momentum, which Shaman B here don't have, and so it's blocked by Shaman A.

% \vspace*{7.7\baselineskip}
\TODO \newline
1. back-link from sec:Conquest of Tlalocan/Shaman/Movement/Shaman is semi-transparent/TODO/2 \newline
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_050_diverging_shaman_from_opponents.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_051_wave_divergence_init.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_052_wave_divergence_1.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_053_wave_cannot_diverge_if_activated_by_unicorn.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_054_wave_cannot_diverge_if_activated_by_centaur.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_055_wave_cannot_diverge_if_activated_by_serpent.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_056_multiple_divergences.png}
\vspace*{-1.3\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_057_diverging_opponents_pieces.png}
\vspace*{-1.3\baselineskip}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_058_diverging_first_piece.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_059_diverged_first_piece_illegal.png}
\vspace*{-0.4\baselineskip}
...
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_060_diverging_activated_piece.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_061_diverged_activated_piece_legal.png}
\vspace*{-0.4\baselineskip}
