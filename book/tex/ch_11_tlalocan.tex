...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_09_stop_sign_pattern_full.png}
\caption{Stop sign pattern on chessboard}
\label{fig:scn_cot_09_stop_sign_pattern_full}
% \centering
\end{figure}
