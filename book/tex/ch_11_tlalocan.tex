...
% \centering
% \includegraphics[width=0.308333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_07_dark_shaman_step_ply_no_capture.png}
% \vspace*{-0.4\baselineskip}
% \caption{No capture}
% \label{fig:scn_cot_07_dark_shaman_step_ply_no_capture}
% \end{wrapfigure}
% Shaman can't capture opponent's pieces
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_07_shaman_is_semi_transparent.png}
\vspace*{-1.4\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_08_unicorn_is_transparent_to_shamans.png}
\vspace*{-1.4\baselineskip}
\caption{Unicorn is transparent to Shamans}
\label{fig:scn_cot_08_unicorn_is_transparent_to_shamans}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_09_teleport_shaman_all.png}
\caption{Teleporting Shaman}
\label{fig:scn_cot_09_teleport_shaman_all}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_10_teleport_pawn_init.png}
\caption{Teleporting Pawn}
\label{fig:scn_cot_10_teleport_pawn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_11_own_shaman_is_divergent_init.png}
\vspace*{-1.3\baselineskip}
\caption{Own Shaman is divergent}
\label{fig:scn_cot_11_own_shaman_is_divergent_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_12_own_shaman_is_divergent_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Queen}
\label{fig:scn_cot_12_own_shaman_is_divergent_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_13_diverging_activated_piece_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Rook}
\label{fig:scn_cot_13_diverging_activated_piece_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_14_diverging_activated_piece_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging activated Rook}
\label{fig:scn_cot_14_diverging_activated_piece_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_15_diverging_pawn_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Pawns start}
\label{fig:scn_cot_15_diverging_pawn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_16_diverging_pawn_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Pawns end}
\label{fig:scn_cot_16_diverging_pawn_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_17_diverging_rushing_pawn.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging rushing Pawn}
\label{fig:scn_cot_17_diverging_rushing_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_18_diverging_unicorn_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Unicorn start}
\label{fig:scn_cot_18_diverging_unicorn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_19_diverging_unicorn_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Unicorn end}
\label{fig:scn_cot_19_diverging_unicorn_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_20_activated_unicorn_divergence_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Unicorn}
\label{fig:scn_cot_20_activated_unicorn_divergence_init}
\end{figure}
...
\hyperref[fig:scn_cot_18_diverging_unicorn_init]{only one additional step}; this also
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_21_activated_unicorn_divergence_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging activated Unicorn}
\label{fig:scn_cot_21_activated_unicorn_divergence_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_22_centaur_cannot_diverge.png}
\vspace*{-1.3\baselineskip}
\caption{Centaur cannot diverge}
\label{fig:scn_cot_22_centaur_cannot_diverge}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_23_serpent_cannot_diverge.png}
\vspace*{-1.3\baselineskip}
\caption{Serpent cannot diverge}
\label{fig:scn_cot_23_serpent_cannot_diverge}
\end{figure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.375\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_24_king_cannot_diverge.png}
% \vspace*{-1.3\baselineskip}
\caption{King cannot diverge}
\label{fig:scn_cot_24_king_cannot_diverge}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_25_diverging_shaman_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Shamans}
\label{fig:scn_cot_25_diverging_shaman_init}
\end{figure}
...
similarly to \hyperref[fig:scn_cot_15_diverging_pawn_init]{diverging Pawns}.
\hyperref[fig:scn_cot_13_diverging_activated_piece_init]{Like before}, activated
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_26_diverging_shaman_steps.png}
\vspace*{-1.3\baselineskip}
\caption{Steps after divergence}
\label{fig:scn_cot_26_diverging_shaman_steps}
\end{figure}
...
\hyperref[fig:scn_cot_12_own_shaman_is_divergent_end]{limited by momentum it had when own Shaman was encountered}. \newline
\indent
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_27_diverging_shaman_captures.png}
\vspace*{-1.4\baselineskip}
\caption{Capture-steps after divergence}
\label{fig:scn_cot_27_diverging_shaman_captures}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_28_diverging_shaman_from_opponents.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging from opponent's Shaman}
\label{fig:scn_cot_28_diverging_shaman_from_opponents}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_29_wave_divergence_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Wave}
\label{fig:scn_cot_29_wave_divergence_init}
\end{figure}
...
Again, \hyperref[fig:scn_cot_11_own_shaman_is_divergent_init]{divergence is optional},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_30_wave_divergence_1.png}
\vspace*{-1.3\baselineskip}
\caption{Wave diverted}
\label{fig:scn_cot_30_wave_divergence_1}
\end{figure}
...
\hyperref[fig:scn_cot_12_own_shaman_is_divergent_end]{illegal to return to its starting field} Q.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_31_wave_cannot_diverge_if_activated_by_unicorn.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Unicorn}
\label{fig:scn_cot_31_wave_cannot_diverge_if_activated_by_unicorn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_32_wave_cannot_diverge_if_activated_by_centaur.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Centaur}
\label{fig:scn_cot_32_wave_cannot_diverge_if_activated_by_centaur}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_33_wave_cannot_diverge_if_activated_by_serpent.png}
\vspace*{-1.3\baselineskip}
\caption{Wave cannot diverge, if activated by Serpent}
\label{fig:scn_cot_33_wave_cannot_diverge_if_activated_by_serpent}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_34_multiple_divergences.png}
\vspace*{-1.3\baselineskip}
\caption{Multiple divergences}
\label{fig:scn_cot_34_multiple_divergences}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_35_diverging_opponents_pieces.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging opponent's pieces}
\label{fig:scn_cot_35_diverging_opponents_pieces}
\end{figure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_36_diverging_first_piece.png}
\vspace*{-0.4\baselineskip}
\caption{Diverging move starter}
\label{fig:scn_cot_36_diverging_first_piece}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_37_diverged_first_piece_illegal.png}
\vspace*{-0.4\baselineskip}
\caption{Diverged move starter}
\label{fig:scn_cot_37_diverged_first_piece_illegal}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_38_diverging_activated_piece.png}
\vspace*{-0.4\baselineskip}
\caption{Diverging activated piece}
\label{fig:scn_cot_38_diverging_activated_piece}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.333333333\textwidth, keepaspectratio=true]{examples/18_cot/scn_cot_39_diverged_activated_piece_legal.png}
\vspace*{-0.4\baselineskip}
\caption{Diverged activated piece}
\label{fig:scn_cot_39_diverged_activated_piece_legal}
\end{wrapfigure}
