...
\end{wrapfigure}
Rushing Pawn can cascade opponent's Shaman onto capture field, thus blocking en
passant; capturing Pawn can diverge from a Shaman instead.\newline
\indent
...
% \TODO :: Shaman blocks en passant on a capture-field, diverging capturing private instead
%
% \TODO :: Shaman does not block en passant if not on capture-field
