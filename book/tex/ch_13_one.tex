...
\label{sec:One/Starchild/Divergence/Diverging activated piece}

\vspace*{-0.9\baselineskip}
\noindent
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_19_diverging_activated_piece_no_momentum.png}
\vspace*{-0.4\baselineskip}
\caption{Diverging with no momentum}
\label{fig:scn_o_19_diverging_activated_piece_no_momentum}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_20_activating_piece_to_diverge.png}
\vspace*{-0.4\baselineskip}
\caption{Activating piece to diverge}
\label{fig:scn_o_20_activating_piece_to_diverge}
\end{wrapfigure}
. . .
