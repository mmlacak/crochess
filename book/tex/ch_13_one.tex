...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_28_syzygy_starchild_ressurection.png}
\caption{Starchild ressurected}
\label{fig:scn_o_28_syzygy_starchild_ressurection}
% \centering
\end{figure}
