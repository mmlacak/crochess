...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_23_starchild_is_transparent.png}
\vspace*{-1.3\baselineskip}
...
\vspace*{-0.4\baselineskip}
\hyperref[fig:scn_mv_07_wave_is_transparent]{Like Wave}, Starchild is transparent. For
instance, if \hyperref[fig:scn_o_16_starchild_divergence_init]{dark Wave in previous example}
is replaced by dark Starchild, light Queen could still continue moving past it, and
also diverge as before.

% \vspace*{-1.4\baselineskip}
\vspace*{-0.7\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_24_starchild_is_completely_transparent.png}
\vspace*{-1.3\baselineskip}
...
\vspace*{-0.4\baselineskip}
\TODO :: Starchild is completely transparent, even to Monolith
