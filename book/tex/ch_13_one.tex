...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_33_double_syzygy_pivot_piece.png}
\caption{Shared celestial piece}
\label{fig:scn_o_33_double_syzygy_pivot_piece}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_34_double_syzygy_pivot_field.png}
\caption{Shared syzygy-field}
\label{fig:scn_o_34_double_syzygy_pivot_field}
% \centering
\end{figure}
...
one for each Starchild in a separate syzygy.
