...
Starchild cannot be converted, but can be activated. Starchild can activate any own
piece, except King, and can activate opponent's Starchilds. Starchild can also activate
and move Stars, but not Monoliths.
...
\end{wrapfigure}
Starchild can't teleport. Starchild can move from starting to destination field in an
instant, without interacting with any intermediate step-fields and pieces on them.
