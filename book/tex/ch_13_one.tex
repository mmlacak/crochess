...
Sense-journey is initiated by stationary Starchild (or, Shaman) activating another
Starchild on its uplifting-field (or, trance-field); activated Starchild can then
activate a piece in its color, which then takes on sense-journey. Activated Starchild
is also called uplifting Starchild, a piece taking on sense-journey is uplifted piece.
Colors of Starchilds, Shaman do not need to match; uplifted piece has to be in the
same color as uplifting Starchild.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_23_light_starchild_init_trance_journey.png}
\caption{Light Starchild initiating}
\label{fig:scn_o_23_light_starchild_init_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_24_dark_starchild_init_trance_journey.png}
\caption{Dark Starchild initiating}
\label{fig:scn_o_24_dark_starchild_init_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_25_shaman_init_trance_journey.png}
% \vspace*{-0.6\baselineskip} # does the opposite of instruction ???
\caption{Shaman initiating}
\label{fig:scn_o_25_shaman_init_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_26_trance_journey_started_by_shaman.png}
\caption{Light-pattern trance-journey}
\label{fig:scn_o_26_trance_journey_started_by_shaman}
\end{figure}
