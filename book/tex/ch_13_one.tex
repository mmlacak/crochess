...
Starchild is transparent, and so it does not block castling when it's
positioned between castling pieces and their destination fields.
Starchild can be activated only by other Starchilds, Waves, Shamans, and
cannot be activated by castling pieces; so Starchild blocks both King and
Rook from castling onto a field it occupies.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_60_castling_not_blocked.png}
\caption{Castling not blocked}
\label{fig:scn_o_60_castling_not_blocked}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_61_castling_blocked.png}
\caption{Castling blocked}
\label{fig:scn_o_61_castling_blocked}
\end{figure}
