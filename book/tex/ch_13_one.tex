...
% \addcontentsline{toc}{subsubsection}{Starchild is divergent}
...
% Unlike Wave, Starchild is not transparent. For instance, if dark Wave is replaced
% by dark Starchild in an example above, it would block light Queen from diverging
% from own, light Starchild.
