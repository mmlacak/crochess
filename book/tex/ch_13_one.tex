...
\begin{wrapfigure}[5]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_05_starchild_moving_star_init.png}
\caption{Moving into a Star}
\label{fig:scn_o_05_starchild_moving_star_init}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_06_starchild_moving_star_end.png}
\caption{Moving a Star}
\label{fig:scn_o_06_starchild_moving_star_end}
\end{wrapfigure}
...
\begin{wrapfigure}[5]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_07_starchild_not_moving_monolith_init.png}
...
\begin{wrapfigure}[4]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_08_starchild_not_moving_monolith_end.png}
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_09_trance_journey_init_starchild.png}
\caption{Starchild initiating}
\label{fig:scn_o_09_trance_journey_init_starchild}
\end{wrapfigure}
...
Between Starchilds no other pieces are allowed. Between Shaman and a Starchild there can
be only Waves. Initiating Shaman or Starchild can themselves be activated by some other
piece(s), not necessarily in the same color.

\vspace*{-0.3\baselineskip}
\noindent
\begin{wrapfigure}[10]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_10_trance_journey_init_shaman.png}
\caption{Shaman initiating}
\label{fig:scn_o_10_trance_journey_init_shaman}
\end{wrapfigure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_11_trance_journey_started_by_shaman.png}
\caption{Trance-journey}
\label{fig:scn_o_11_trance_journey_started_by_shaman}
% \centering
\end{figure}
