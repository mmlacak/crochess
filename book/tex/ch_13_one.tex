...
Here, Starchild is about to initiate resurrecting syzygy.
...
\vspace*{-0.5\baselineskip}
Here, resurrected Queen replaced initiating Starchild.
...
\indent
Again, only captured pieces can be resurrected.
\hyperref[fig:scn_ma_08_conversion_init]{Converted pieces} cannot be resurrected
since they weren't captured, and so didn't leave chessboard; they only changed
their color.

\TODO :: only captured and oblationed pieces can be resurrected.
