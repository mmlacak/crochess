...
\addcontentsline{toc}{subsubsection}{Waves are not granted momentum}
\label{sec:One/Starchild/Divergence/Waves are not granted momentum}

\vspace*{-0.9\baselineskip}
\noindent
\begin{wrapfigure}[11]{l}{0.4\textwidth} % 10
\centering
...
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_19_activating_piece_no_momentum.png}
\vspace*{-0.4\baselineskip}
\caption{Activating with no momentum}
\label{fig:scn_o_19_activating_piece_no_momentum}
\end{wrapfigure}
Unlike \hyperref[fig:scn_cot_11_diverging_activated_piece_init]{diverging from Shaman},
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_20_diverging_piece_no_momentum.png}
\vspace*{-0.4\baselineskip}
\caption{Diverging with no momentum}
\label{fig:scn_o_20_diverging_piece_no_momentum}
\end{wrapfigure}
In previous example light Knight reached Starchild with no momentum. Here, Knight was
granted one additional momentum, and is about to diverge from light Starchild, perform
one additional step, and can e.g. reactivate light Wave with no momentum.

% \vspace*{-1.1\baselineskip}
\vspace*{0.9\baselineskip}
\subsubsection*{Diverging with surplus momentum}
\addcontentsline{toc}{subsubsection}{Diverging with surplus momentum}
...
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_21_activating_piece_surplus_momentum.png}
\vspace*{-0.4\baselineskip}
...
\indent
Similar to
\hyperref[fig:scn_mv_30_single_step_piece_momentum]{pieces activated with surplus momentum},
...
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_22_diverging_piece_surplus_momentum.png}
\vspace*{-0.4\baselineskip}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_23_starchild_is_not_transparent.png}
\vspace*{-1.3\baselineskip}
\caption{Starchild is not transparent}
\label{fig:scn_o_23_starchild_is_not_transparent}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_24_starchild_cannot_diverge.png}
\vspace*{-1.3\baselineskip}
