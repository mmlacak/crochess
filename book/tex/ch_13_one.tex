...
\hyperref[fig:scn_o_10_starchild_activated_wave_not_teleporting_init]{Activated Wave cannot teleport},
instead of teleporting, Wave would reappear on any empty portal-field around Star (or Monlith).
