...
\hyperref[fig:scn_cot_20_own_shaman_is_divergent_init]{Similar to Shaman},
...
\vspace*{-0.5\baselineskip}
\hyperref[fig:scn_cot_45_diverging_first_piece]{As before}, first piece in a move
...
\vspace*{-0.5\baselineskip}
In \hyperref[fig:scn_cot_72_light_shaman_trance_journey]{trance-journey}, entranced
...
\hyperref[fig:scn_cot_60_trance_fields]{trance-fields}. Colors of Starchilds,
...
uplifting Starchild on its \hyperref[fig:scn_cot_60_trance_fields]{trance-fields};
...
\hyperref[fig:scn_cot_72_light_shaman_trance_journey]{light Shaman's pattern},
otherwise from
\hyperref[fig:scn_cot_74_dark_shaman_trance_journey]{dark Shaman's pattern}.
