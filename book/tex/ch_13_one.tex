...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_18_trance_journey_failed.png}
\caption{Failed trance-journey}
\label{fig:scn_o_18_trance_journey_failed}
% \centering
\end{figure}

\hyperref[fig:scn_cot_09_trance_journey_init]{In Shaman initiated trance-journey},
if all step-fields are blocked by Kings, Stars or Monoliths, entranced piece is
\hyperref[sec:Terms/Oblation]{oblationed}, i.e. removed from chessboard as if captured by the opponent.
Note, light Shaman is forced on taking trance-journey, because after activation its step-fields are
blocked by entrancing Shaman and light Bishop, and there is nothing to capture or activate on its
capture-fields.
