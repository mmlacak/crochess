...
\vspace*{-0.7\baselineskip}
Starchild cannot be activated; instead, any piece which reached Starchild has to
diverge to a different destination. To that end, material (non-Wave) pieces are
granted one additional momentum; Waves are not granted any. % \newline
% \indent
