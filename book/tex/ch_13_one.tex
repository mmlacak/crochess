...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_22_trance_journey_failed.png}
\vspace*{-1.4\baselineskip}
\caption{Failed trance-journey}
\label{fig:scn_o_22_trance_journey_failed}
\end{figure}
...
\begin{wrapfigure}[5]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_23_uplifting_fields.png}
\vspace*{-0.4\baselineskip}
\caption{Uplifting-fields}
\label{fig:scn_o_23_uplifting_fields}
\end{wrapfigure}
...
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_24_uplifting_init.png}
\vspace*{-0.4\baselineskip}
\caption{Uplifting preparation}
\label{fig:scn_o_24_uplifting_init}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_25_uplifting_step.png}
\vspace*{-0.4\baselineskip}
\caption{Uplifting step}
\label{fig:scn_o_25_uplifting_step}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_26_uplifting_activated.png}
\vspace*{-0.4\baselineskip}
\caption{Activated uplifting step}
\label{fig:scn_o_26_uplifting_activated}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_27_shaman_initiated_uplifting.png}
\vspace*{-0.4\baselineskip}
\caption{Shaman initiated uplifting}
\label{fig:scn_o_27_shaman_initiated_uplifting}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_28_dark_piece_sense_journey.png}
\vspace*{-1.4\baselineskip}
\caption{Dark piece sense-journey}
\label{fig:scn_o_28_dark_piece_sense_journey}
\end{figure}

\vspace*{-0.5\baselineskip}
Uplifted piece can take on sense-journey even if it received no momentum; length of
sense-journey does not depend on received momentum, like in an example above. \newline
\indent
If uplifted piece is light, it can take trance-journey in one chosen direction from
\hyperref[fig:scn_cot_52_light_shaman_trance_journey]{light Shaman's pattern}, otherwise
from \hyperref[fig:scn_cot_54_dark_shaman_trance_journey]{dark Shaman's pattern}. \newline
\indent
Here, dark Bishop has been uplifted with no momentum by dark Starchild, which was
initiated by activated light Shaman; grey arrows show path travelled over by piece
they point to.
% \newline
% \indent
% Uplifted piece can end its sense-journey on any empty step-field, of chosen direction
% (color). If all are occupied, then it emerges on any empty uplifting or trance-field.
% If all are occupied, uplifted piece is oblationed.
...
% \noindent
% \begin{figure}[!h]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_24_uplifting_init.png}
% \caption{Light Starchild initiating}
% \label{fig:scn_o_24_uplifting_init}
% \end{figure}

% Sense-journey can be initiated by Starchild activating another Starchild;
...
% \noindent
% \begin{figure}[!h]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_25_uplifting_step.png}
...
% \noindent
% \begin{figure}[!h]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_26_uplifting_activated.png}
...
% \noindent
% \begin{figure}[!h]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_27_shaman_initiated_uplifting.png}
...
\TODO :: fix after fixing entrancement
...
In contrast to
\hyperref[fig:scn_o_22_trance_journey_failed]{failed Shaman's trance-journey},
