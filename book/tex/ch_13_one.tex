...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_21_activating_piece_to_diverge.png}
\vspace*{-0.4\baselineskip}
\caption{Activating piece to diverge}
\label{fig:scn_o_21_activating_piece_to_diverge}
\end{wrapfigure}
. . .
