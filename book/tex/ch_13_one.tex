...
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_02_starchild_activating_own_starchild.png}
...
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_03_starchild_activating_own_wave.png}
...
\TODO :: CLARIFY :: Starchild can be activated by any own Wave, which was activated by any piece, not neccessary other Starchild
...
a Star, and can only
\hyperref[fig:scn_o_03_starchild_activating_own_wave]{activate own Starchilds, own and opponent's Waves}.
