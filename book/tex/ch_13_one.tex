...
\hyperref[fig:scn_d_11_teleport_wave_via_monolith]{Monolith is the only piece Wave cannot "pass-through"},
...
the same as in
\hyperref[fig:scn_d_13_wave_teleported_off_board]{previous variant, Discovery}.

Wave is also removed from chessboard if, after teleportation, all of its step-fields
are blocked; this is again similar to
\hyperref[fig:scn_d_12_teleported_wave_blocked]{previous variant, Discovery}.
...
\hyperref[fig:scn_d_16_steps_after_teleport_init]{previous example with Monoliths},
...
\hyperref[fig:scn_d_20_syzygy_2_stars_init]{demoting-to-Pawn syzygy} in place of
Stars and Monoliths. Starchilds are also eligible to demotion.

\hyperref[fig:scn_d_19_syzygy_explain]{Again}, shortest step connecting
...
Similar to
\hyperref[fig:scn_d_24_syzygy_reentering_same_move]{Monolith reentering syzygy},
