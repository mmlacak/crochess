...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_33_syzygy_double_starchilds.png}
\caption{Double Starchild}
\label{fig:scn_o_33_syzygy_double_starchilds}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_35_two_syzygies_shared_field.png}
\caption{Shared syzygy-field}
\label{fig:scn_o_35_two_syzygies_shared_field}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_36_two_syzygies_shared_nothing.png}
\caption{Independent syzygies}
\label{fig:scn_o_36_two_syzygies_shared_nothing}
% \centering
\end{figure}
