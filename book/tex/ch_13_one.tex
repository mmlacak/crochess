...
\noindent
One is chess variant which is played on 26~$\times$~26 board, with white
and darker violet fields, and with light purple and fuchsia pieces. Star
...
\indent
Starchild cannot be converted, or diverged. Starchild is divergent piece;
it can diverge other pieces, similar to Shaman. Starchild can be activated
by own Waves, Starchilds. Starchild can activate own Waves and Starchilds
on its step-fields, or any Star on its miracle-fields. Activated Starchild
does not use momentum while moving.
...
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_01_starchild_movement.png}
\vspace*{-0.4\baselineskip}
...
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_02_wave_activating_starchild.png}
\vspace*{-0.4\baselineskip}
\caption{Activating Starchild by Wave}
\label{fig:scn_o_02_wave_activating_starchild}
\end{wrapfigure}
Wave can activate own Starchild; Wave itself can be activated by any piece (here,
light Knight).\newline
\indent
Activated Starchild does not spend momentum for its movement.

\vspace*{1.1\baselineskip}
\noindent
\begin{wrapfigure}[4]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_03_starchild_activating_own_starchild.png}
\vspace*{-0.4\baselineskip}
\caption{Activating Starchild}
\label{fig:scn_o_03_starchild_activating_own_starchild}
\end{wrapfigure}
Starchild can activate own Starchilds on its step-fields.
...
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_04_starchild_activating_own_wave.png}
\vspace*{-0.4\baselineskip}
\caption{Activating Wave}
\label{fig:scn_o_04_starchild_activating_own_wave}
\end{wrapfigure}
Starchild can activate own Waves on its step-fields. Activated Wave moves the same
as Starchild, i.e. to any empty field in opposite color to its starting field, without
being limited by distance to its destination.\newline
\indent
...
\centering
\includegraphics[width=0.203846154\textwidth, keepaspectratio=true]{examples/22_o/scn_o_05_miracle_fields.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[6]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.280769231\textwidth, keepaspectratio=true]{examples/22_o/scn_o_07_starchild_not_moving_monolith_init.png}
\vspace*{-0.4\baselineskip}
...
\centering
\includegraphics[width=0.280769231\textwidth, keepaspectratio=true]{examples/22_o/scn_o_08_starchild_not_moving_monolith_end.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[4]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.203846154\textwidth, keepaspectratio=true]{examples/22_o/scn_o_09_starchild_moving_star_init.png}
\vspace*{-0.4\baselineskip}
\caption{Moving into a Star}
\label{fig:scn_o_09_starchild_moving_star_init}
\end{wrapfigure}
Starchild can activate any Star on its miracle-field, regardless of colors of pieces.
Activated Star receives 1 momentum.

\vspace*{3.1\baselineskip}
\noindent
\begin{wrapfigure}[4]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.203846154\textwidth, keepaspectratio=true]{examples/22_o/scn_o_10_starchild_moving_star_end.png}
\vspace*{-0.4\baselineskip}
\caption{Star moving}
...
\centering
\includegraphics[width=0.203846154\textwidth, keepaspectratio=true]{examples/22_o/scn_o_11_starchild_moving_star_activating.png}
\vspace*{-0.4\baselineskip}
\caption{Activating Starchild}
...
\begin{wrapfigure}[4]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.203846154\textwidth, keepaspectratio=true]{examples/22_o/scn_o_12_star_movement_blocked_init.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.203846154\textwidth, keepaspectratio=true]{examples/22_o/scn_o_13_star_movement_blocked_end.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.396153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_14_star_rerouting_scout.png}
\vspace*{-1.4\baselineskip}
...
\vspace*{-0.4\baselineskip}
\hyperref[fig:scn_mv_011_wave_is_transparent]{Like Wave}, Starchild is transparent
...
\centering
\includegraphics[width=0.280769231\textwidth, keepaspectratio=true]{examples/22_o/scn_o_18_starchild_cannot_activate_wave_on_miracle_fields.png}
\vspace*{-0.4\baselineskip}
\caption{No activation on miracle-fields}
\label{fig:scn_o_18_starchild_cannot_activate_wave_on_miracle_fields}
\end{wrapfigure}
Wave cannot be activated by Starchild on its miracle-fields; thus, Wave cannot
activate a Star.

\vspace*{4.1\baselineskip}
\subsubsection*{... only on step-fields}
\addcontentsline{toc}{subsubsection}{... only on step-fields}
\label{sec:One/Starchild/Activating Wave/... only on step-fields}

\vspace*{-0.7\baselineskip}
\noindent
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.280769231\textwidth, keepaspectratio=true]{examples/22_o/scn_o_19_starchild_activating_wave_on_step_field.png}
\vspace*{-0.4\baselineskip}
\caption{Activating Wave on a step-field}
\label{fig:scn_o_19_starchild_activating_wave_on_step_field}
\end{wrapfigure}
Note, Starchild can activate Wave on its step-fields, which are
\hyperref[fig:scn_o_01_starchild_movement]{all fields in opposite color}
to Starchild's starting field; this includes fields immediately to the right,
up, left, and down from Starchild's position.

Wave activated by a Starchild on its neighboring step-field cannot activate
a Star, and can only
\hyperref[fig:scn_o_04_starchild_activating_own_wave]{activate own Starchilds, own and opponent's Waves}.
...
\centering
\includegraphics[width=0.319230769\textwidth, keepaspectratio=true]{examples/22_o/scn_o_20_starchild_activated_wave_not_teleporting_init.png}
\vspace*{-0.4\baselineskip}
\caption{Moving into a Star}
\label{fig:scn_o_20_starchild_activated_wave_not_teleporting_init}
\end{wrapfigure}
Wave activated by Starchild cannot teleport.

\vspace*{7.7\baselineskip}
\noindent
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.319230769\textwidth, keepaspectratio=true]{examples/22_o/scn_o_21_starchild_activated_wave_not_teleporting_end.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_32_activating_piece_surplus_momentum.png}
\vspace*{-0.4\baselineskip}
...
\indent
Similar to
\hyperref[fig:scn_mv_039_single_step_piece_momentum]{pieces activated with surplus momentum},
...
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_33_diverging_piece_surplus_momentum.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_34_starchild_cannot_diverge.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[3]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_35_wave_cannot_diverge.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[5]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.203846154\textwidth, keepaspectratio=true]{examples/22_o/scn_o_40_uplifting_fields.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_41_uplifting_init.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_42_uplifting_step.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_43_uplifting_activated.png}
\vspace*{-0.4\baselineskip}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.357692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_44_shaman_initiated_uplifting.png}
\vspace*{-0.4\baselineskip}
...
piece can belong to opponent, regardless if it's Shaman or Starchild. King, Pyramids,
Waves cannot be uplifted; Stars, Monoliths do not belong to any player; Starchilds
cannot take on sense-journey.
...
the light one; regardless if move is played by light or dark player. No piece
can prevent resurrection, even if placed on a syzygy-field.\newline
\indent
...
\hyperref[fig:scn_mv_015_wave_block_castling_rook]{The same as Wave},
...
\end{wrapfigure}
Rushing private can cascade a Starchild onto capture-field, thus blocking en
passant; capturing private can diverge from a Starchild instead.\newline
\indent
Here, light Pawn is about to rush and activate light Wave, which would then
activate light Starchild, which would end on en passant capture-field E.
...
\end{wrapfigure}
Again,
\hyperref[fig:scn_cot_112_en_passant_turned_divergence_end]{any piece on a capture-field blocks en passant};
a private can capture en passant only if it can activate blocking piece; otherwise,
it can only interact with a piece.\newline
\indent
Here, dark Pawn can either capture or diverge from light Starchild, but it cannot
capture light Pawn en passant.
...
Starchild does not block en passant if positioned on any field other than en passant
capture-field.\newline
\indent
Here is alternative end to light player's cascade, light Starchild is now on a
field between capture-field E and rushed Pawn; dark Pawn can capture light Pawn
en passant.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{castlings/22_o/one_castling_01.png}
\vspace*{-1.4\baselineskip}
\caption{Castling}
\label{fig:one_castling_01}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{castlings/22_o/one_castling_right_24_04.png}
\vspace*{-1.4\baselineskip}
\caption{Castling short right}
\label{fig:one_castling_right_24_04}
\end{figure}
