...
\label{sec:One/Starchild/Divergence/Activating Starchild}

% \vspace*{-1.3\baselineskip}
% \noindent
% \begin{figure}[!h]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_20_activating_starchild.png}
% \caption{Activating Starchild}
% \label{fig:scn_o_20_activating_starchild}
% \end{figure}
...
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_20_activating_starchild.png}
\caption{Activating Starchild}
\label{fig:scn_o_20_activating_starchild}
\end{wrapfigure}
. . .
