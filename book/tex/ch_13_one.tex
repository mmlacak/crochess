...
direction from
\hyperref[fig:scn_cot_39_light_shaman_trance_journey]{light Shaman's pattern},
otherwise from
\hyperref[fig:scn_cot_41_dark_shaman_trance_journey]{dark Shaman's pattern}.
...
\hyperref[fig:star/scn_cot_58_push_pull_entrancement_start]{previous variant, Conquest of Tlalocan}.
\end{minipage}
...
\hyperref[fig:scn_cot_34_trance_journey_init]{regular trance-journey}
