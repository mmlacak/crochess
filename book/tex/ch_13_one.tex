...
direction from
\hyperref[fig:scn_cot_17_light_shaman_trance_journey]{light Shaman's pattern},
otherwise from
\hyperref[fig:scn_cot_19_dark_shaman_trance_journey]{dark Shaman's pattern}.
...
\hyperref[fig:star/scn_cot_36_push_pull_entrancement_start]{previous variant, Conquest of Tlalocan}.
\end{minipage}
...
\hyperref[fig:scn_cot_12_trance_journey_init]{regular trance-journey}
...
\hyperref[fig:scn_mv_56_own_wave_is_divergent_init]{just like Wave can do it}.
