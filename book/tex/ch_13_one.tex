...
\TODO :: be explicit: only one step per ply !!!
...
\hyperref[fig:scn_cot_030_own_shaman_is_divergent_init]{Similar to Shaman},
...
\vspace*{-0.5\baselineskip}
\hyperref[fig:scn_cot_058_diverging_first_piece]{As before}, first piece in a move
