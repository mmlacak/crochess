...
direction from
\hyperref[fig:scn_cot_35_light_shaman_trance_journey]{light Shaman's pattern},
otherwise from
\hyperref[fig:scn_cot_37_dark_shaman_trance_journey]{dark Shaman's pattern}.
...
\hyperref[fig:star/scn_cot_54_push_pull_entrancement_start]{previous variant, Conquest of Tlalocan}.
\end{minipage}
...
\hyperref[fig:scn_cot_30_trance_journey_init]{regular trance-journey}
