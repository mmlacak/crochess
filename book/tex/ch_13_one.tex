...
direction from
\hyperref[fig:scn_cot_34_light_shaman_trance_journey]{light Shaman's pattern},
otherwise from
\hyperref[fig:scn_cot_36_dark_shaman_trance_journey]{dark Shaman's pattern}.
...
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_26_push_pull_trance_journey_init.png}
...
\hyperref[fig:star/scn_cot_53_push_pull_entrancement_start]{previous variant, Conquest of Tlalocan}.
\end{minipage}
...
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_27_push_pull_trance_journey_entrancing.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_28_push_pull_trance_journey_entranced.png}
...
\hyperref[fig:scn_cot_29_trance_journey_init]{regular trance-journey}
...
\hyperref[fig:scn_cot_09_own_shaman_is_divergent_init]{just like Wave can do it}.
...
block light Queen from moving any further, and so from diverging.
