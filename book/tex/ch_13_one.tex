...
direction from
\hyperref[fig:scn_cot_30_light_shaman_trance_journey]{light Shaman's pattern},
otherwise from
\hyperref[fig:scn_cot_32_dark_shaman_trance_journey]{dark Shaman's pattern}.
...
\hyperref[fig:star/scn_cot_49_push_pull_entrancement_start]{previous variant, Conquest of Tlalocan}.
\end{minipage}
...
\hyperref[fig:scn_cot_25_trance_journey_init]{regular trance-journey}
