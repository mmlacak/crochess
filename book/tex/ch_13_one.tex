...
Star-initiated syzygy brings no additional interactions, i.e. it neither can demote own piece to Pawn,
...
Here, Bishop can move for 1 step, after Wave transferred 1 momentum from syzygy-initiating Starchild.
...
Starchild initiating syzygy can activate another Starchild(s), creating double (triple, ...) syzygies, which
all have the same syzygy-step. In such a move, only one Starchild can have additional interactions, i.e.
in such a case only one demoting to Pawn, or only one resurrection can be performed.
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_33_double_syzygy_pivot_starchilds.png}
\caption{Double syzygy}
\label{fig:scn_o_33_double_syzygy_pivot_starchilds}
% \centering
\end{figure}

Starchild initiating syzygy can activate another Starchild(s), creating double (triple, ...) syzygies, which
share the same syzygy-field, and possibly even celestial piece on it. In such a move, only one Starchild can
have additional interactions, i.e. in such a case only one demoting to Pawn, or only one resurrection can be
performed.

\clearpage % ..........................................................

\huge{}
TODO :: cascading Starchilds-induced multiple paralel syzygies (no shared pieces, syzygy-steps), cascading other Starchild into other syzygy
\normalsize{}
