...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_14_starchild_activating_wave_on_neighboring_fields.png}
\caption{Activating Wave}
\label{fig:scn_o_14_starchild_activating_wave_on_neighboring_fields}
\end{wrapfigure}
...
\begin{wrapfigure}[4]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.307692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_15_starchild_activated_wave_not_teleporting_init.png}
...
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.307692308\textwidth, keepaspectratio=true]{examples/22_o/scn_o_16_starchild_activated_wave_not_teleporting_end.png}
\vspace*{-0.4\baselineskip}
...
\end{wrapfigure}
Wave cannot move a Star, even if activated by Starchild on its neighboring-field.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_21_light_starchild_init_trance_journey.png}
\caption{Light Starchild initiating}
\label{fig:scn_o_21_light_starchild_init_trance_journey}
\end{figure}
...
done on step-fields (here), otherwise only on neighboring-fields (next example).
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_22_dark_starchild_init_trance_journey.png}
\caption{Dark Starchild initiating}
\label{fig:scn_o_22_dark_starchild_init_trance_journey}
\end{figure}

Entrancing Starchild can activate any piece in the same color (except Kings, Waves,
Starchilds, Stars and Monoliths), on its neighboring-fields. Entranced piece can
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_23_shaman_init_trance_journey.png}
% \vspace*{-0.6\baselineskip} # wtf ???
\caption{Shaman initiating}
\label{fig:scn_o_23_shaman_init_trance_journey}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_24_trance_journey_started_by_shaman.png}
\caption{Light-pattern trance-journey}
\label{fig:scn_o_24_trance_journey_started_by_shaman}
\end{figure}
...
Starchild's neighboring-field. If there's none, then it emerges on empty initiating
Shaman's or Starchild's neighboring-fields. If all are occupied, entranced piece is
oblationed.
...
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_25_push_pull_trance_journey_init.png}
\caption{Initiating trance-journey}
\label{fig:scn_o_25_push_pull_trance_journey_init}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_26_push_pull_trance_journey_entrancing.png}
\caption{Push-pull entrancing}
\label{fig:scn_o_26_push_pull_trance_journey_entrancing}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_27_push_pull_trance_journey_entranced.png}
\caption{Dark-pattern trance-journey}
\label{fig:scn_o_27_push_pull_trance_journey_entranced}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_28_trance_journey_failed.png}
\caption{Failed trance-journey}
\label{fig:scn_o_28_trance_journey_failed}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_29_trance_journey_failed_2.png}
\caption{Failed new trance-journey}
\label{fig:scn_o_29_trance_journey_failed_2}
\end{figure}
...
In contrast to
\hyperref[fig:scn_o_28_trance_journey_failed]{failed Shaman's trance-journey},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_30_syzygy_monolith.png}
% \vspace*{-1.5\baselineskip}
\caption{Demoting-to-Pawn syzygy}
\label{fig:scn_o_30_syzygy_monolith}
\end{figure}
