...
Starchild can activate only own Waves on its step-fields. Here, both own Waves A and B can
...
Activated Starchild does not spend received momentum for moving; if Starchild activates Wave,
it transfers all of received momentum to Wave. In example similar to previous, light Starchild
is receiving 5 momentum after being activated by light Queen, received momentum is then
transfered from light Wave to dark one in its entirety.
...
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_06_starchild_activating_fields.png}
\caption{Activating piece}
\label{fig:scn_o_06_starchild_activating_fields}
\end{wrapfigure}
Fields at which Starchild can activate piece other than just own Wave are neighboring-fields.

Starchild can move only to non-empty activation fields, and only if it contains own piece,
or opponent's Starchids; Starchild cannot activate own King.
...
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_07_starchild_activating_wave_momentum_init.png}
\caption{Activating Wave}
\label{fig:scn_o_07_starchild_activating_wave_momentum_init}
\end{wrapfigure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_08_starchild_activating_wave_momentum_end.png}
\caption{Teleported Wave}
\label{fig:scn_o_08_starchild_activating_wave_momentum_end}
% \centering
\end{figure}
...
\end{wrapfigure}
Starchild's activation fields are enumerated, these are Starchild's neighboring-fields.
Starchild can move a Star by activating it, the same way as any other piece, i.e. by
capturing field at which Star is located.

On the same activation fields Starchild can also activate any own piece and opponent's
Starchild; Starchild cannot activate neither Kings (own and opponent's), nor Monoliths.
...
Note, even if activated Starchild received more than 1 momentum, Star can only be activated
on Starchild's neighboring-fields, and move for only one step.
...
\begin{wrapfigure}[5]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_11_starchild_not_moving_monolith_init.png}
...
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_12_starchild_not_moving_monolith_end.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_13_starchild_conversion_immunity_init.png}
\caption{Conversion immunity}
\label{fig:scn_o_13_starchild_conversion_immunity_init}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_14_star_moved_wave_teleportation.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_15_star_moved_wave_off_board.png}
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_16_trance_journey_init_starchild.png}
\caption{Starchild initiating}
\label{fig:scn_o_16_trance_journey_init_starchild}
\end{wrapfigure}
...
\begin{wrapfigure}[10]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_17_trance_journey_init_shaman.png}
\caption{Shaman initiating}
\label{fig:scn_o_17_trance_journey_init_shaman}
\end{wrapfigure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_18_trance_journey_started_by_shaman.png}
\caption{Trance-journey}
\label{fig:scn_o_18_trance_journey_started_by_shaman}
% \centering
\end{figure}
...
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_19_push_pull_trance_journey_init.png}
\caption{Initiating trance-journey}
\label{fig:scn_o_19_push_pull_trance_journey_init}
\end{wrapfigure}
...
\begin{wrapfigure}[10]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_20_push_pull_trance_journey_entrancing.png}
\caption{Push-pull entrancing}
\label{fig:scn_o_20_push_pull_trance_journey_entrancing}
\end{wrapfigure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_21_push_pull_trance_journey_entranced.png}
\caption{Dark-pattern trance-journey}
\label{fig:scn_o_21_push_pull_trance_journey_entranced}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_23_syzygy_monolith.png}
\caption{Demoting-to-Pawn syzygy}
\label{fig:scn_o_23_syzygy_monolith}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_24_syzygy_starchild_init.png}
\caption{Ressurection syzygy start}
\label{fig:scn_o_24_syzygy_starchild_init}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_25_syzygy_starchild_end.png}
\caption{Queen ressurected}
\label{fig:scn_o_25_syzygy_starchild_end}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_26_syzygy_starchild_ressurection.png}
\caption{Starchild ressurected}
\label{fig:scn_o_26_syzygy_starchild_ressurection}
% \centering
\end{figure}
