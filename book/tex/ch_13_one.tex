...
If all step-fields in a trance-journey are blocked by Kings, Stars or Monoliths, and all neighboring-fields
around (Shaman and) Starchild(s) are blocked, entranced piece is \hyperref[sec:Terms/Oblation]{oblationed}.

Here, dark Bishop is forced on taking trance-journey, because after activation it's blocked from performing
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_24_syzygy_monolith.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_25_syzygy_starchild_init.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_26_syzygy_starchild_end.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_27_syzygy_starchild_ressurection.png}
