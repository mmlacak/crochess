...
which all have the same syzygy-steps. In such a move, only one Starchild can have additional interactions,
i.e. only one resurrection can be performed.
...
share the same syzygy-field, and possibly even celestial piece on it. In such a case, only one Starchild can
have additional interactions, i.e. only one resurrection can be performed.
