...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_19_syzygy_starchild_init.png}
\caption{Ressurection syzygy start}
\label{fig:scn_o_19_syzygy_starchild_init}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_20_syzygy_starchild_end.png}
\caption{Queen ressurected}
\label{fig:scn_o_20_syzygy_starchild_end}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_21_syzygy_starchild_ressurection.png}
\caption{Starchild ressurected}
\label{fig:scn_o_21_syzygy_starchild_ressurection}
% \centering
\end{figure}
