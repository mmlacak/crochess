...
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_02_starchild_activating_fields.png}
...
% Note, Starchild can move only to non-empty activation fields. Starchild can activate any
% own piece, except King, and can also activate opponent's Starchids.
...
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_03_starchild_moving_star_init.png}
...
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_04_starchild_moving_star_end.png}
...
horizontally, vertically and diagonally. Those fields are the same as King's step-fields,
and are enumerated in example on the left.
...
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_05_starchild_not_moving_monolith_init.png}
...
\centering
\includegraphics[width=0.192307692\textwidth, keepaspectratio=true]{examples/22_o/scn_o_06_starchild_not_moving_monolith_end.png}
...
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_07_trance_journey_init.png}
\caption{Starting a trance-journey}
\label{fig:scn_o_07_trance_journey_init}
\end{wrapfigure}
