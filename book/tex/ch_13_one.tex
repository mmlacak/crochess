...
Here, Star received all of initial momentum gathered by the Rook, since neither Wave nor Starchild expend momentum for its movement.
Still, activated Star can move for only one field.
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_27_syzygy_starchild_init.png}
\caption{Resurrection syzygy start}
\label{fig:scn_o_27_syzygy_starchild_init}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_28_syzygy_starchild_end.png}
\caption{Queen resurrected}
\label{fig:scn_o_28_syzygy_starchild_end}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_29_syzygy_starchild_resurrection.png}
\caption{Starchild resurrected}
\label{fig:scn_o_29_syzygy_starchild_resurrection}
% \centering
\end{figure}
