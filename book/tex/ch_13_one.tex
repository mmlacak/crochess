...
\hyperref[fig:scn_cot_020_own_shaman_is_divergent_init]{Similar to Shaman},
...
\vspace*{-0.5\baselineskip}
\hyperref[fig:scn_cot_045_diverging_first_piece]{As before}, first piece in a move
...
\vspace*{-0.5\baselineskip}
In \hyperref[fig:scn_cot_072_light_shaman_trance_journey]{trance-journey}, entranced
...
\hyperref[fig:scn_cot_060_trance_fields]{trance-fields}. Colors of Starchilds,
...
uplifting Starchild on its \hyperref[fig:scn_cot_060_trance_fields]{trance-fields};
...
\hyperref[fig:scn_cot_072_light_shaman_trance_journey]{light Shaman's pattern},
otherwise from
\hyperref[fig:scn_cot_074_dark_shaman_trance_journey]{dark Shaman's pattern}.
...
Starchild can be activated on step-fields only by other Starchilds and Waves, and
cannot be activated by castling pieces; so Starchild blocks both King and Rook from
castling onto a field it occupies.
