...
to all pieces, both own and opponent's. For instance, if
...
and could also diverge as before.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_25_starchild_cannot_diverge.png}
\vspace*{-1.3\baselineskip}
