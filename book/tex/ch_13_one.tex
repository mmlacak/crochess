...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_18_activating_starchild.png}
\caption{Activating Starchild}
\label{fig:scn_o_18_activating_starchild}
\end{wrapfigure}
Starchild cannot be activated; instead, to-be-activating piece is granted one
additional momentum, and has to diverge to a different destination. \newline
\indent
