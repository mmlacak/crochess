...
% Another design that I'd like to simplify is set of potential destination fields
% for resurrecting syzygy.

Other things that desperately needs simplifying are rules regarding multiple
syzygies, be it a piece moving from one into another, or standing on a shared
