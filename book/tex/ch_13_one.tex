...
direction from
\hyperref[fig:scn_cot_32_light_shaman_trance_journey]{light Shaman's pattern},
otherwise from
\hyperref[fig:scn_cot_34_dark_shaman_trance_journey]{dark Shaman's pattern}.
...
\hyperref[fig:star/scn_cot_51_push_pull_entrancement_start]{previous variant, Conquest of Tlalocan}.
\end{minipage}
...
\hyperref[fig:scn_cot_27_trance_journey_init]{regular trance-journey}
...
\hyperref[fig:scn_cot_09_own_wave_is_divergent_init]{just like Wave can do it}.
