...
\subsubsection*{Blocked Scout}
\addcontentsline{toc}{subsubsection}{Blocked Scout}
\label{sec:One/Starchild/Movement/Blocked Scout}

\TODO :: Star blocked Scout
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/22_o/scn_o_29_sense_journey_failed.png}
\vspace*{-1.4\baselineskip}
\caption{Failed sense-journey}
\label{fig:scn_o_29_sense_journey_failed}
\end{figure}
