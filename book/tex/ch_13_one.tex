...
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_21_light_starchild_init_trance_journey.png}
\vspace*{-0.5\baselineskip}
...
done on step-fields (left example), otherwise only on neighboring-fields
(left, middle). Initiating Starchild must activate entrancing Starchild
directly, there must be no pieces between the two.
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_22_dark_starchild_init_trance_journey.png}
\vspace*{-0.5\baselineskip}
...
If entrancing Starchild is light, piece can take
\hyperref[fig:scn_cot_14_light_shaman_trance_journey]{light Shaman's pattern},
else \hyperref[fig:scn_cot_16_dark_shaman_trance_journey]{dark Shaman's pattern}.

\vspace*{-0.3\baselineskip}
\noindent
\begin{wrapfigure}[10]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.346153846\textwidth, keepaspectratio=true]{examples/22_o/scn_o_23_shaman_init_trance_journey.png}
\vspace*{-0.5\baselineskip}
...
length of trance-journey do not depend on received momentum.
