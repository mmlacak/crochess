...
(left, middle). Activated Starchild can then activate a piece in the same
color, except Kings, Waves, Starchilds, Stars and Monoliths.
...
\end{wrapfigure}
Initiating Starchild must activate entrancing Starchild directly, there must be no
pieces between the two. Entranced piece can then optionally take on trance-journey,
or take an ordinary step with one momentum. If entrancing Starchild is light, piece
can take \hyperref[fig:scn_cot_14_light_shaman_trance_journey]{light Shaman's pattern},
otherwise \hyperref[fig:scn_cot_16_dark_shaman_trance_journey]{dark Shaman's pattern}.
