...
In this and all subsequent variants Pawn can move sideways, onto a field immediately
to its left, or to its right. Destination step-field has to be empty, or it can host
own Wave.
...
Wave activated by Pawn moving sideways can move only horizontally, either to the
left, or to the right. Unlike Pawn, Wave is not limited to only one step, and so
can move until edge of chessboard is encountered.
...
. . . Pyramid can't be activated by sideways Pawn, neither directly no indirectly

\textgreater\textgreater\textgreater{} Activating Pyramid by Pawn
