...
Material (non-Wave) pieces can activate Pyramid on its capture-fields.
Pawn
\hyperref[fig:scn_ma_04_pyramid_activation_by_pawn]{can activate Pyramid only on its capture-fields},
and cannot do the same on its step-fields. Since side fields are step-fields,
Pyramid can't be activated by a sideways moving Pawn.
