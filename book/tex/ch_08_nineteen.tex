...
\vspace*{-0.7\baselineskip}
Additional difference in this variant is that King can castle between 2 and 6 fields
across.
...
TODO
\normalsize \\
+ allow checked King to castle \\
+ allow King to move over attacked fields while castling \\
+ example for both \\
- refer all castling in all subsequent variants to this entry \\
