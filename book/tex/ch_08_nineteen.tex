...
then reappears on any non-occupied portal-field near Star in opposite color. Teleportation is
not limited by matching colors of a piece and a Star, any piece can use any Star to start
teleporting.
...
Since all Stars are positioned in corners of chessboard, there are always 3
portal-fields around each one.
...
\centering
\includegraphics[width=0.1875\textwidth, keepaspectratio=true]{en_passants/12_nineteen_en_passant.png}
\caption{En passant}
