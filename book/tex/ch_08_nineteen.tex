...
Rook all portal-fields around both light Stars are blocked, and so it will be
removed from chessboard.
...
\hyperref[fig:scn_n_03_teleport_move_2]{teleported piece which had all portal-fields blocked}.
