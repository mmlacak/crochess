...
\indent
Here, all three light Pawns A, B and C are in their initial position, still tagged
for rushing (blue markers). Pawn A is about to rush forwards and activate Wave A,
which would activate Wave B, which would step-over Wave C (since
\hyperref[fig:scn_mv_07_wave_is_transparent]{Waves are transparent}), and would
activate Pawn B.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/12_n/scn_n_32_multiple_rushes_2nd_pawn.png}
\vspace*{-1.4\baselineskip}
...
\vspace*{-0.5\baselineskip}
Here, light Pawn A has been rushed to its destination in previous steps, and so
now is subject to capture by en passant (green marker).\newline
\indent
Continuing the same cascade, activated light Pawn B (now "in-the-air") is about
to rush forward and activate Wave C, which would activate Wave D, which would
then activate Pawn C.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/12_n/scn_n_33_multiple_rushes_3rd_pawn.png}
\vspace*{-1.4\baselineskip}
\caption{Pawn C rushes in the same cascade}
\label{fig:scn_n_33_multiple_rushes_3rd_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/12_n/scn_n_34_multiple_rushes_end.png}
\vspace*{-1.4\baselineskip}
\caption{Multiple rushes end}
\label{fig:scn_n_34_multiple_rushes_end}
\end{figure}

\vspace*{-0.5\baselineskip}
. . .

\TODO % :: fig:scn_mv_75_en_passant_blocked_by_wave <-- only one can be captured
