...
\subsection*{Diverging rush}
\addcontentsline{toc}{subsection}{Diverging rush}
\label{sec:Nineteen/Sideways Pawns/Diverging rush}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/12_n/scn_n_20_only_one_queen.png}
\caption{Not converting a Queen}
\label{fig:scn_n_20_only_one_queen}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/12_n/scn_n_21_new_castling_init.png}
\vspace*{-1.3\baselineskip}
\caption{New castling start}
\label{fig:scn_n_21_new_castling_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/12_n/scn_n_22_new_castling_end.png}
\vspace*{-1.3\baselineskip}
\caption{New castling end}
\label{fig:scn_n_22_new_castling_end}
\end{figure}
