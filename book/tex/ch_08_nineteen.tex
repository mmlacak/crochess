...
\hyperref[fig:scn_mv_26_activating_rush_pawn_init]{rush light Pawn for 2 fields}.
...
\hyperref[fig:scn_mv_34_wave_activation_by_unicorn_first_step]{Wave activated by Unicorn}
...
\hyperref[fig:scn_mv_37_wave_off_board]{ply ends on a chessboard}. So, light
...
\hyperref[fig:scn_mv_37_wave_off_board]{ply ends on a chessboard}. So, dark
