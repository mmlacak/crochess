...
\label{sec:Nineteen/Sideways Pawns/Diverging Pawn}

\vspace*{-1.5\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/12_n/scn_n_19_diverging_pawn_init.png}
\vspace*{-1.5\baselineskip}
\caption{Diverging Pawns start}
\label{fig:scn_n_19_diverging_pawn_init}
\end{figure}
...
\hyperref[fig:scn_mv_58_diverging_pawn]{diverge from Wave} by making forward-,
...
opponent's piece is placed on a Pawn's capture-field behind own Wave.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/12_n/scn_n_20_diverging_pawn_end.png}
% \vspace*{-1.3\baselineskip}
\caption{Diverging Pawns end}
\label{fig:scn_n_20_diverging_pawn_end}
\end{figure}

% \vspace*{-0.4\baselineskip}
Image above have all four Pawns "in the air", each can chose its next direction
