...
\hyperref[fig:scn_aoa_13_tagged_pawn_converted]{Pawns converted on own piece rows}.
...
\section*{Pawn rows}
\addcontentsline{toc}{section}{Pawn rows}
...
In this variant, Pawns in the first row can be rushed for up to 6 fields, while those
in second row can go up to 7 fields.
