...
\indent
Here, dark Pawn is about to activate light Wave C, indirectly, via dark Wave A.
...
\vspace*{-0.5\baselineskip}
Here, activated light Wave C (now "in-the-air") can choose any dark Pawn's initial
...
\vspace*{-0.5\baselineskip}
Wave \hyperref[fig:scn_mv_009_not_activating_pyramid_by_wave]{cannot activate Pyramid} at all.

\hyperref[sec:Terms/Material]{Material pieces}, including Pawn,
\hyperref[fig:scn_ma_04_pyramid_activation_by_pawn]{can activate Pyramid on its capture-fields},
and cannot do the same on its step-fields. Since side fields are step-fields, Pyramid
\hyperref[fig:scn_n_17_sideways_pawn_cannot_activate_pyramid]{can't be activated by a sideways moving Pawn}.
...
its capture-fields; even if cascade contains Wave and Pawn moving over its
step-fields.
