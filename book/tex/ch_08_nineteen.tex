...
Pawn
\hyperref[fig:scn_mv_038_activating_pyramid_by_pawn]{cannot activate Pyramid on its step-fields},
...
Pawn they point to. Now, both light Pawns are tagged as en passant opportunity
(green markers). Dark Pawn E is about to capture en passant and activate dark Wave,
which would then activate dark Pawn F, which would also capture light Pawn en passant.
