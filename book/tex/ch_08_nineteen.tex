...
For teleporting dark Rook all destination portal-field around both light Stars
are blocked. While dark Wave could be activated by dark Rook in a normal,
non-teleporting ply, it cannot be activated by teleported dark Rook, because
dark Rook will have no momentum after teleportation. Thus, dark Rook will be
sacrified.
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/12_n/scn_n_09_teleport_bishop.png}
\caption{Bishop teleportation}
\label{fig:scn_n_09_teleport_bishop}
% \centering
\end{figure}
