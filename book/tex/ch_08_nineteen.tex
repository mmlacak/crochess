...
All pieces can access a Star from own step- or capture-field. So, light Pawn in
the same column as dark Star (here, a) can step into it, and teleport away. If
destination Star is on opponent's side of a board, teleported Pawn is tagged for
