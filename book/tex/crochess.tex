...
Pegasus, the Winged Horse, moves similarly to Knight, only it can
...
its heading. In other words, Pegasus is bound by both First obstacle rule
and Continuation of direction rule.

Pegasus symbol in algebraic notation is 'G', to avoid confusion with Pawn.

In the example below we have Pegasus with all destination fields of valid
moves marked with green squares. Illegal moves are denoted with black squares.
Numbers in upper right corner of field enumerates direction of movement.
