...
% King must not be under attack, nor any field over which it would travel, nor King
% could end up under check. Also, King and Rook must not move prior to castling, and both must
% be at  .
...
\indent
In example above, all valid King's castling fields are numbered. Regardless if King performs
...
% \begin{figure}[!h]
% % \begin{figure}[!t]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{../gfx/castlings/short_right/04_croatian_ties_castling_short_right.png}
% \caption{Castling short right}
% \label{fig:cc_castling_short_right}
% % \centering
% \end{figure}
