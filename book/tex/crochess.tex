...
\noindent
\begin{wrapfigure}[10]{l}[0pt]{0.4\textwidth}
...
\end{wrapfigure}
% \hspace*{\fill}
\hspace*{1.5em}Pegasus moves similarly to Knight, but it can continue its jumpy movement
...
\noindent
\begin{wrapfigure}{l}[0pt]{0.6\textwidth} % [15]
\includegraphics[width=0.6\textwidth, keepaspectratio=true]{../gfx/examples/01_move_pegasus_initial.png}
\caption{Pegasus initial step}
\label{fig:pegasus_initial_step}
% % \centering
\end{wrapfigure}
\hspace*{1.5em}In the example below we have Pegasus with all valid jumps marked with
