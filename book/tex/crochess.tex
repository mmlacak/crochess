...
\end{wrapfigure}
\indent
In the example on the left we have Pegasus with all valid initial jump directions
marked with green arrows. Numbers in corner of each accessible field enumerates
all initial directions of movement. Pegasus movement, the same as Knight, is not
hampered by surrounding pieces, it can "jump" over them.
