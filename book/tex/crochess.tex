...
Pawn stands, both Pyramid and Pawn then leaves board as if they were captured,
...
Now that Pyramid reached Pawn, both are removed from the board and piece of
choice, in this instance Queen, is placed at captured field.
