...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_53_en_passant_turning_capture.png}
\vspace*{-1.4\baselineskip}
\caption{Rushing cascade}
\label{fig:scn_mv_53_en_passant_turning_capture}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_54_en_passant_turned_capture.png}
\vspace*{-1.4\baselineskip}
\caption{En passant turning capture}
\label{fig:scn_mv_54_en_passant_turned_capture}
\end{wrapfigure}
. . .
