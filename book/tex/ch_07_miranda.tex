...
So, pinned pieces can be moved in a cascade, because activating piece will take their
...
King is checked (or checkmated) only after cascade has finished; just like after normal,
non-cascading move.
...
B) pinned piece starting a cascade ---\textgreater ok, if some piece settles onto pinned field when cascade is finished
