...
\end{wrapfigure}
In previous example light Pawn B is blocked from moving forward by dark Wave on its
step-field; other Waves can be either activated, or captured. No Wave can be passed
over, since both Pawns can make only one step in a ply. \newline
\indent
Here, ...
