...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_99_en_passant_legal_init.png}
\vspace*{-1.4\baselineskip}
\caption{Light Pawn rushing}
\label{fig:scn_mv_99_en_passant_legal_init}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_100_en_passant_legal_end.png}
\vspace*{-1.4\baselineskip}
\caption{Activated Dark Pawn capturing en passant}
\label{fig:scn_mv_100_en_passant_legal_end}
\end{wrapfigure}
. . .
