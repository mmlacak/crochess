...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_78_wave_activation_by_opponents_pawn.png}
\vspace*{-1.4\baselineskip}
\caption{Dark Pawn activates light Wave}
\label{fig:scn_mv_78_wave_activation_by_opponents_pawn}
\end{figure}
