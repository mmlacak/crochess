...
\label{sec:Miranda's veil/Wave/Converting own pieces}
...
now that means own pieces can be converted to opponent's, if both own piece and
opponent's Pyramid are on
\hyperref[sec:Definitions/Chessboard sides, navigation]{own side of a chessboard}. \newline
\indent
