...
\vspace*{-2.9ex} % Does space after title depends on size of paragraph that follows?
\noindent
\begin{figure}[!h]
% \begin{figure}[!t]
...
% ----------------------------------------------- Activation by Unicorn
\clearpage % ..........................................................
% Checking with activated pieces --------------------------------------

\subsection*{Checking with activated pieces}
\addcontentsline{toc}{subsection}{Checking with activated pieces}
...
% \begin{figure}[!h]
% % \begin{figure}[!t]
% \includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_36_activated_piece_checking.png}
% \caption{Activated Rook to move}
% \label{fig:scn_mv_36_activated_piece_checking}
% % \centering
% \end{figure}

% Activated pieces are limited by received momentum. Here, if activated light
% Rook moves to field R, it would not pose a threat to dark King, since received
% momentum of 3 does not provide enough reach, due to 1 being spent for moving.
% If initial position of light Pegasus was G2, dark King would be checked by
% light Rook. Initial position of G3 could lead to checkmate, if all escape
% fields on second rank are blocked, or covered by other light pieces.

% After being moved in a cascade, active pieces regain full access to all their
% step- and capture-fields on the very next move. So, even if dark King was not
% checked immediately after light player's move, it will be on the very next move
% (on dark player's turn!), with all fields of first rank covered by light Rook.
...
% TODO
% \normalsize{}
% :: King not checked by Rook in the middle of a cascade (in the same move)
% $\rightarrow$ all of received momentum transferred to next Wave
