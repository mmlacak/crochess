...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_35_pinned_piece_cascade_init.png}
\vspace*{-1.3\baselineskip}
\caption{Pinned piece in a cascade}
\label{fig:scn_mv_35_pinned_piece_cascade_init}
\end{figure}

\vspace*{-0.4\baselineskip}
A
\href{https://en.wikipedia.org/wiki/Pin_(chess)#Absolute_pin}{piece pinned to its King cannot move}
in a normal, non-cascading move, since that would leave King checked. King is checked
(or checkmated) only after cascade has finished; just like after normal, non-cascading
move. In a cascade, activating piece would take place of originally pinned piece, and
so King still would not be checked.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_36_pinned_piece_cascade_start.png}
\caption{Pinned piece in a cascade}
\label{fig:scn_mv_36_pinned_piece_cascade_start}
\end{figure}
