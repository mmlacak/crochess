...
\textgreater \textgreater \textgreater Naturaly, Rook is obstructed by surrounding pieces, i.e. it can’t move past Wave 1.
...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_07_wave_cascading_opponent.png}
...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_08_wave_no_momentum_no_activating.png}
\caption{No momentum}
...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_10_wave_blocked_init.png}
...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_11_wave_blocked_end.png}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_12_cascading_rook.png}
\caption{Rook starting cascade}
\label{fig:scn_mv_12_cascading_rook}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_13_cascading_wave_1.png}
\caption{Wave 1 cascading}
\label{fig:scn_mv_13_cascading_wave_1}
\end{wrapfigure}
...
\begin{wrapfigure}[13]{l}{0.5625\textwidth}
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_14_cascading_wave_2.png}
\caption{Wave 2 cascading}
\label{fig:scn_mv_14_cascading_wave_2}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_15_cascading_rook_2nd_time.png}
\caption{Rook, 2nd cascading}
\label{fig:scn_mv_15_cascading_rook_2nd_time}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_16_cascading_wave_1_2nd_time.png}
\caption{Wave 1, 2nd cascading}
\label{fig:scn_mv_16_cascading_wave_1_2nd_time}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_17_cascading_queen.png}
\caption{Queen cascading}
\label{fig:scn_mv_17_cascading_queen}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_18_cascading_wave_2_2nd_time.png}
\caption{Wave 2, 2nd cascading}
\label{fig:scn_mv_18_cascading_wave_2_2nd_time}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_19_cascading_wave_1_3rd_time.png}
\caption{Wave 1, 3rd cascading}
\label{fig:scn_mv_19_cascading_wave_1_3rd_time}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_20_cascading_end.png}
\caption{Wave 1, end cascading}
\label{fig:scn_mv_20_cascading_end}
\end{wrapfigure}
...
\begin{wrapfigure}[10]{l}{0.5625\textwidth}
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_21_casc_oppo_light_queen.png}
\caption{Light Queen starting cascade}
\label{fig:scn_mv_21_casc_oppo_light_queen}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_22_casc_oppo_light_wave.png}
\caption{Light Wave}
\label{fig:scn_mv_22_casc_oppo_light_wave}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_23_casc_oppo_dark_wave.png}
\caption{Dark Wave}
\label{fig:scn_mv_23_casc_oppo_dark_wave}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_24_casc_oppo_dark_queen.png}
\caption{Dark Queen}
\label{fig:scn_mv_24_casc_oppo_dark_queen}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_25_casc_oppo_end.png}
\caption{Cascading opponent end}
\label{fig:scn_mv_25_casc_oppo_end}
\end{wrapfigure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_26_activating_rush_pawn_init.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_27_activating_rush_pawn_end.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_28_wave_activation_by_step_pawn.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_29_wave_activated_by_step_pawn.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_30_wave_activation_by_capture_pawn.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_31_wave_activated_by_capture_pawn.png}
...
\centering
\includegraphics[width=0.4375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_32_wave_same_color.png}
\vspace*{-0.3\baselineskip}
...
\centering
\includegraphics[width=0.6875\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_33_wave_opposite_color.png}
\vspace*{-0.3\baselineskip}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_34_wave_activation_by_unicorn_first_step.png}
\vspace*{-1.3\baselineskip}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_35_wave_activation_by_unicorn_second_step.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_36_wave_activation_by_unicorn_complete.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_37_wave_off_board.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_40_activated_piece_check_init.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_41_activated_piece_check_cascade.png}
