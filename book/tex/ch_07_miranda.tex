...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_34_activated_piece_checking.png}
\caption{Activated Rook to move}
\label{fig:scn_mv_34_activated_piece_checking}
% \centering
\end{figure}
