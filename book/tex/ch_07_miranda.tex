...
\hyperref[sec:Definitions/Movement of Wave]{'Movement of Wave'} in Definitions.
...
all cases, Wave transfers all received momentum to activated piece, which 
(if not Wave itself) is then limited by received momentum.
