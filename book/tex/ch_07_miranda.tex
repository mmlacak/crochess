...
A) moving pinned piece in a cascade ---\textgreater ok
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_35_activated_piece_check_init.png}
\caption{Activating Queen}
\label{fig:scn_mv_35_activated_piece_check_init}
\end{figure}

King is checked (or checkmated) only after cascade has finished, just like after
normal, non-cascaded move. During cascade, piece can be reactivated on a temporary
field, and thus repositioned to a new field. So, a piece can temporary be located
on a field where it would check (or checkmate) King, if that would be its final
destination for that cascade. When piece is repositioned from its temporary
location, King is not affected, and game continues.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_36_activated_piece_check_cascade.png}
\vspace*{-1.3\baselineskip}
\caption{Reactivating Queen}
\label{fig:scn_mv_36_activated_piece_check_cascade}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_37_wave_cascading_opponent.png}
% \vspace*{-1.3\baselineskip}
\caption{Cascading opponent}
\label{fig:scn_mv_37_wave_cascading_opponent}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_38_cascaded_opponent_capturing.png}
\caption{Cascaded opponent capturing piece}
\label{fig:scn_mv_38_cascaded_opponent_capturing}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_39_cascaded_opponent_promoting.png}
\caption{Cascaded opponent promoting Pawn}
\label{fig:scn_mv_39_cascaded_opponent_promoting}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_40_cascade_self_checkmate_init.png}
\vspace*{-1.4\baselineskip}
\caption{Cascading opponent's Rook}
\label{fig:scn_mv_40_cascade_self_checkmate_init}
\end{figure}
...
is reactivated and
\hyperref[fig:scn_mv_35_activated_piece_check_init]{moved away from its temporary position}.
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_41_cascade_self_checkmate_end.png}
\caption{Cascaded self-checkmate}
\label{fig:scn_mv_41_cascade_self_checkmate_end}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_42_wave_blocked_init.png}
\caption{Activating Wave}
\label{fig:scn_mv_42_wave_blocked_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_43_wave_blocked_end.png}
\caption{Activated Wave blocked}
\label{fig:scn_mv_43_wave_blocked_end}
\end{figure}
