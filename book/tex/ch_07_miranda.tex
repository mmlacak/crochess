...
Wave inherits all initial step-fields which activating piece starting a ply would
...
\vspace*{-0.5\baselineskip}
Wave activated by Pawn on its step-field (now "in-the-air") can move straight
...
Wave moves the same as if activated on Pawn's step-fields; i.e. straight forward or
...
\subsubsection*{Activated by opponent's Pawn}
\addcontentsline{toc}{subsubsection}{Activated by opponent's Pawn}
\label{sec:Miranda's veil/Wave/Movement/Activated by opponent's Pawn}

\vspace*{-1.5\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_25_wave_activation_by_opponents_pawn.png}
\vspace*{-1.4\baselineskip}
\caption{Dark Pawn activates light Wave}
\label{fig:scn_mv_25_wave_activation_by_opponents_pawn}
\end{figure}
