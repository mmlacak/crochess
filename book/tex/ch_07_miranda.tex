...
Piece can activate own Wave by simply capturing a field at which that Wave stands;
activation is optional, piece could just as well move past Wave. Activated Wave
receives any momentum activating piece had.

Here, Pegasus has opportunity to activate Wave, and transfer to it all of 5 momentum,
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_28_single_step_piece_momentum.png}
\vspace*{-1.4\baselineskip}
\caption{Single-step piece and momentum}
\label{fig:scn_mv_28_single_step_piece_momentum}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_29_activating_rush_pawn_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Pawns}
\label{fig:scn_mv_29_activating_rush_pawn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_30_activating_rush_pawn_end.png}
\caption{Pawns activated}
\label{fig:scn_mv_30_activating_rush_pawn_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_31_activating_pyramid_by_pawn.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Pyramid by Pawn}
\label{fig:scn_mv_31_activating_pyramid_by_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_32_activating_pyramid_cascade_pawn.png}
\vspace*{-1.5\baselineskip}
\caption{Activating Pyramid by cascading Pawn}
\label{fig:scn_mv_32_activating_pyramid_cascade_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_33_reactivating_piece_init.png}
% \vspace*{-1.3\baselineskip}
\caption{Start reactivating piece}
\label{fig:scn_mv_33_reactivating_piece_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_34_reactivating_piece_steps.png}
\vspace*{-1.3\baselineskip}
\caption{Reactivating piece steps}
\label{fig:scn_mv_34_reactivating_piece_steps}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_35_wave_is_transparent.png}
\vspace*{-1.3\baselineskip}
\caption{Wave is transparent}
\label{fig:scn_mv_35_wave_is_transparent}
\end{figure}

\vspace*{-0.5\baselineskip}
Wave cannot be pinned, since it's transparent, i.e. any opponent's piece can ignore
("pass-through") Wave placed on its capture-field, and still check own King.
...
- opponent can ignore Wave, and capture own piece behind it

- move the whole subsubsection just behind Movement
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_36_pinned_piece_cascaded_init.png}
\vspace*{-1.3\baselineskip}
\caption{Cascading pinned piece}
\label{fig:scn_mv_36_pinned_piece_cascaded_init}
\end{figure}
...
only after move (a cascade) has finished. So, in a cascade, one could replace
hard-pinned piece with any other non-Wave piece. During cascade, Wave can be the
only piece on a pinning path, as long as any other (non-Wave) piece is pinned,
after that cascade has been finished.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_37_pinned_piece_cascaded_1.png}
\vspace*{-1.3\baselineskip}
\caption{Cascading pinned piece}
\label{fig:scn_mv_37_pinned_piece_cascaded_1}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_38_pinned_piece_cascaded_end.png}
\vspace*{-1.3\baselineskip}
\caption{Cascading pinned piece}
\label{fig:scn_mv_38_pinned_piece_cascaded_end}
\end{figure}
...
% - in a cascade, pinned piece can be replaced with normal (non-Wave) piece

\clearpage % ..........................................................

\subsubsection*{Cascading pinned piece 2}
\addcontentsline{toc}{subsubsection}{Cascading pinned piece 2}
\label{sec:Miranda's veil/Wave/Cascading Waves/Cascading pinned piece 2}

\huge
TODO
\normalsize

- in a cascade, pinned piece cannot be replaced with Wave

- in a cascade, pinned piece can be replaced multiple times, even with Waves, as long as last piece is not Wave

- King is under check, checkmate only after move has finished
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_36_pinned_piece_cascaded_start.png}
\caption{Cascading pinned piece}
\label{fig:scn_mv_36_pinned_piece_cascaded_start}
\end{figure}

Here, light Queen is about to be activated, and moved away, leaving Wave on its field.
King, after cascade is done, won't be checked since Wave would be new pinned piece.

So, pinned piece can be moved in a cascade, because activating piece will take its
place, and all pieces which can check (or checkmate) King cannot move past (cannot
"pass-through") any piece on their step- and capture-fields.

% ........................................... Cascading pinned piece
\clearpage % ..........................................................
% Pinned piece starting a cascade .....................................

\subsubsection*{Pinned piece starting a cascade}
\addcontentsline{toc}{subsubsection}{Pinned piece starting a cascade}
\label{sec:Miranda's veil/Wave/Cascading Waves/Pinned piece starting a cascade}

\vspace*{-1.4\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_37_pinned_piece_cascading_init.png}
\vspace*{-1.3\baselineskip}
\caption{Pinned piece starting a cascade}
\label{fig:scn_mv_37_pinned_piece_cascading_init}
\end{figure}

\vspace*{-0.3\baselineskip}
King is checked (or checkmated) only after cascade has finished; just like after
normal, non-cascading move. So, pinned piece can start a cascade as long as some
other piece settles into a pinned position after cascade is done; it doesn't even
have to be the same field of originally pinned piece.

Here, pinned light Queen is starting a cascade, after which Knight will be the
newly pinned piece, on a different field.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_38_activated_piece_check_init.png}
\caption{Activating Queen}
\label{fig:scn_mv_38_activated_piece_check_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_39_activated_piece_check_cascade.png}
\vspace*{-1.3\baselineskip}
\caption{Reactivating Queen}
\label{fig:scn_mv_39_activated_piece_check_cascade}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_40_wave_cascading_opponent.png}
% \vspace*{-1.3\baselineskip}
\caption{Cascading opponent}
\label{fig:scn_mv_40_wave_cascading_opponent}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_41_cascaded_opponent_capturing.png}
\caption{Cascaded opponent capturing piece}
\label{fig:scn_mv_41_cascaded_opponent_capturing}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_42_cascaded_opponent_promoting.png}
\caption{Cascaded opponent promoting Pawn}
\label{fig:scn_mv_42_cascaded_opponent_promoting}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_43_cascade_self_checkmate_init.png}
\vspace*{-1.4\baselineskip}
\caption{Cascading opponent's Rook}
\label{fig:scn_mv_43_cascade_self_checkmate_init}
\end{figure}
...
is reactivated and
\hyperref[fig:scn_mv_38_activated_piece_check_init]{moved away from its temporary position}.
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_44_cascade_self_checkmate_end.png}
\caption{Cascaded self-checkmate}
\label{fig:scn_mv_44_cascade_self_checkmate_end}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_45_wave_blocked_init.png}
\caption{Activating Wave}
\label{fig:scn_mv_45_wave_blocked_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_46_wave_blocked_end.png}
\caption{Activated Wave blocked}
\label{fig:scn_mv_46_wave_blocked_end}
\end{figure}
