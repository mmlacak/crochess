...
initially chosen direction, if activated by a single-step piece (e.g. a Knight).
...
Even though \hyperref[fig:scn_mv_007_wave_is_transparent]{Wave is transparent},
...
\hyperref[fig:scn_mv_021_wave_activation_by_step_pawn]{activated on its step-field}.
...
a chessboard. \hyperref[fig:scn_mv_007_wave_is_transparent]{Wave is transparent}, so
