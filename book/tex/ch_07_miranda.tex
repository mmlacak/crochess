...
step away from it, in the same ply. So, single-step pieces (Pawns, Knights, Kings,
and Unicorns) are all blocked by Wave, regardless if own, or opponent's. Such a piece
can activate own, or capture opponent's Wave.
