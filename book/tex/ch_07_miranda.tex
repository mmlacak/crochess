...
Wave can choose direction on the first step(s), which cannot be changed later.
Wave can step outside of a chessboard, and only has to end its' ply on a board.
