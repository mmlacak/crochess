...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_56_diverging_rush.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging rush}
\label{fig:scn_mv_56_diverging_rush}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_57_diverging_activated_piece.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging activated piece}
\label{fig:scn_mv_57_diverging_activated_piece}
\end{figure}
...
\vspace*{-0.4\baselineskip}
As a result, activated, non-Wave piece which has no momentum when reached own Wave,
cannot diverge, only activate that Wave.
