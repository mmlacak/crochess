...
\indent
Moving over capture-fields allows Wave to activate own Pyramids. Here, Wave (now
"in-the-air") can activate light Pyramid A on capture-fields, but cannot activate
light Pyramid B on step-fields.
