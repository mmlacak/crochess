...
\indent
In both cases, Wave A can move over its step-fields, i.e. straight forward, since
it doesn't activate Pyramid directly. Also, in both examples, Pyramid A cannot be
activated since it's on Wave's step-field.
