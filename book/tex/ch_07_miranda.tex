...
destination for that cascade. When piece is moved out of temporary field, opponent's King
is not affected, and game continues.
...
\caption{Reactivated Queen captures Pawn}
