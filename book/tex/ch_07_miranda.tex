...
\begin{wrapfigure}[13]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_96_en_passant_legal_end.png}
\vspace*{-1.4\baselineskip}
\caption{Activated Dark Pawn capturing en passant}
\label{fig:scn_mv_96_en_passant_legal_end}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_97_en_passant_illegal_init.png}
\vspace*{-1.4\baselineskip}
\caption{Dark Pawn rushing after light one}
\label{fig:scn_mv_97_en_passant_illegal_init}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_98_en_passant_illegal_pawn_activated.png}
\vspace*{-1.4\baselineskip}
\caption{Activating dark Pawn}
\label{fig:scn_mv_98_en_passant_illegal_pawn_activated}
\end{wrapfigure}
...
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_99_en_passant_illegal_queen_reactivated.png}
\vspace*{-1.4\baselineskip}
\caption{Reactivating dark Queen}
\label{fig:scn_mv_99_en_passant_illegal_queen_reactivated}
\end{wrapfigure}
