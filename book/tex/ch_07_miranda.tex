...
pieces, all of its fields are steps-fields. When referring to Wave's capture-fields
...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_038_not_activating_pyramid_by_wave.png}
\vspace*{-1.4\baselineskip}
\caption{Wave cannot activate Pyramid}
\label{fig:scn_mv_038_not_activating_pyramid_by_wave}
\end{wrapfigure}
...

\vspace*{14.4\baselineskip}
% \vspace*{-0.4\baselineskip}
\noindent
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_039_activating_pyramid_cascade_pawn.png}
\vspace*{-1.4\baselineskip}
\caption{Pyramid can be activated}
\label{fig:scn_mv_039_activating_pyramid_cascade_pawn}
\end{wrapfigure}
...

% \vspace*{15.4\baselineskip}
...
% when
% \hyperref[fig:scn_mv_059_converting_opponents_piece_init]{final, conversion ply started}.
