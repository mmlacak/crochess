...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_007_wave_is_transparent.png}
\vspace*{-1.4\baselineskip}
\caption{Wave is transparent}
\label{fig:scn_mv_007_wave_is_transparent}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_008_wave_cant_be_pinned.png}
\vspace*{-1.3\baselineskip}
\caption{Wave is not pinned}
\label{fig:scn_mv_008_wave_cant_be_pinned}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_009_wave_no_block_castling_king.png}
\vspace*{-1.4\baselineskip}
\caption{Castling King}
\label{fig:scn_mv_009_wave_no_block_castling_king}
\end{figure}

\vspace*{-1.4\baselineskip}
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_010_wave_no_block_castling_rook.png}
\vspace*{-1.4\baselineskip}
\caption{Castling Rook}
\label{fig:scn_mv_010_wave_no_block_castling_rook}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_011_wave_block_castling_rook.png}
\vspace*{-1.4\baselineskip}
\caption{Castling Rook blocked}
\label{fig:scn_mv_011_wave_block_castling_rook}
\end{figure}
...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_012_pawn_blocked_by_opponents_wave.png}
\vspace*{-1.4\baselineskip}
\caption{Pawns blocked by Waves}
\label{fig:scn_mv_012_pawn_blocked_by_opponents_wave}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_013_pawn_not_blocked_by_opponents_wave.png}
\vspace*{-1.4\baselineskip}
\caption{Pawns not blocked by Waves}
\label{fig:scn_mv_013_pawn_not_blocked_by_opponents_wave}
\end{wrapfigure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_014_wave_no_activating_blocked_piece.png}
\caption{Piece blocked}
\label{fig:scn_mv_014_wave_no_activating_blocked_piece}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_015_bishop_activating_wave.png}
\vspace*{-1.4\baselineskip}
\caption{Bishop activating Wave}
\label{fig:scn_mv_015_bishop_activating_wave}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_016_wave_activated_by_bishop.png}
\vspace*{-1.4\baselineskip}
\caption{Wave activated by Bishop}
\label{fig:scn_mv_016_wave_activated_by_bishop}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_017_knight_activating_wave.png}
\caption{Knight activating Wave}
\label{fig:scn_mv_017_knight_activating_wave}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_018_wave_activated_by_knight.png}
\caption{Wave activated by Knight}
\label{fig:scn_mv_018_wave_activated_by_knight}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_019_king_activating_wave.png}
\caption{King activating Wave}
\label{fig:scn_mv_019_king_activating_wave}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_020_wave_activated_by_king.png}
% \vspace*{-1.3\baselineskip}
\caption{Wave activated by King}
\label{fig:scn_mv_020_wave_activated_by_king}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_021_wave_activation_by_step_pawn.png}
\vspace*{-1.4\baselineskip}
\caption{Pawn activates Wave on step-field}
\label{fig:scn_mv_021_wave_activation_by_step_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_022_wave_activated_by_step_pawn.png}
\vspace*{-1.4\baselineskip}
\caption{Wave activated on Pawn's step-field}
\label{fig:scn_mv_022_wave_activated_by_step_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_023_wave_activation_by_capture_pawn.png}
\vspace*{-1.4\baselineskip}
\caption{Pawn activates Wave on capture-field}
\label{fig:scn_mv_023_wave_activation_by_capture_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_024_wave_activated_by_capture_pawn.png}
\vspace*{-1.4\baselineskip}
\caption{Wave activated on Pawn's capture-field}
\label{fig:scn_mv_024_wave_activated_by_capture_pawn}
\end{figure}
...
\centering
\includegraphics[width=0.4375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_025_wave_same_color.png}
\vspace*{-0.3\baselineskip}
\caption{Wave short jump}
\label{fig:scn_mv_025_wave_same_color}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.6875\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_026_wave_opposite_color.png}
\vspace*{-0.3\baselineskip}
\caption{Wave long jump}
\label{fig:scn_mv_026_wave_opposite_color}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_027_wave_activation_by_unicorn_first_step.png}
\vspace*{-1.3\baselineskip}
\caption{Unicorn activates Wave}
\label{fig:scn_mv_027_wave_activation_by_unicorn_first_step}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_028_wave_activation_by_unicorn_second_step.png}
\caption{Wave activated by Unicorn, step 1}
\label{fig:scn_mv_028_wave_activation_by_unicorn_second_step}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_029_wave_activation_by_unicorn_complete.png}
\caption{Wave activated by Unicorn, complete ply}
\label{fig:scn_mv_029_wave_activation_by_unicorn_complete}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_030_wave_off_board.png}
\caption{Wave off-board steps}
\label{fig:scn_mv_030_wave_off_board}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_031_wave_cascading_init.png}
\caption{Cascade start}
\label{fig:scn_mv_031_wave_cascading_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_032_wave_cascading_steps.png}
\vspace*{-1.4\baselineskip}
\caption{Active piece cascaded}
\label{fig:scn_mv_032_wave_cascading_steps}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_033_wave_cascading_end.png}
\vspace*{-1.3\baselineskip}
\caption{Cascade end}
\label{fig:scn_mv_033_wave_cascading_end}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_034_wave_no_momentum_no_activating.png}
\caption{No momentum}
\label{fig:scn_mv_034_wave_no_momentum_no_activating}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_035_single_step_piece_momentum.png}
\vspace*{-1.4\baselineskip}
\caption{Single-step piece and momentum}
\label{fig:scn_mv_035_single_step_piece_momentum}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_036_activating_rush_pawn_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Pawns}
\label{fig:scn_mv_036_activating_rush_pawn_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_037_activating_rush_pawn_end.png}
\caption{Pawns activated}
\label{fig:scn_mv_037_activating_rush_pawn_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_038_activating_pyramid_by_pawn.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Pyramid by Pawn}
\label{fig:scn_mv_038_activating_pyramid_by_pawn}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_039_activating_pyramid_cascade_pawn.png}
\vspace*{-1.5\baselineskip}
\caption{Activating Pyramid by cascading Pawn}
\label{fig:scn_mv_039_activating_pyramid_cascade_pawn}
\end{figure}
...
\begin{wrapfigure}[16]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_040_cascading_wave_to_pyramid_init.png}
\vspace*{-1.4\baselineskip}
\caption{Step-fields to Pyramid}
\label{fig:scn_mv_040_cascading_wave_to_pyramid_init}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_041_cascading_wave_to_pyramid_end.png}
\vspace*{-1.4\baselineskip}
\caption{Capture-fields to Pyramid}
\label{fig:scn_mv_041_cascading_wave_to_pyramid_end}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_042_activated_by_pyramid.png}
\vspace*{-1.3\baselineskip}
\caption{Activated by Pyramid}
\label{fig:scn_mv_042_activated_by_pyramid}
\end{figure}
...
\hyperref[fig:scn_mv_007_wave_is_transparent]{it's transparent}.
...
\TODO :: RETHINK :: MAYBE :: despite transparency, Wave blocks checks on King; King is in check if and only if all capture-fields between attacker and King are empty
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_053_static_move_is_illegal_init.png}
\vspace*{-1.3\baselineskip}
\caption{Static move start}
\label{fig:scn_mv_053_static_move_is_illegal_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_054_static_move_is_illegal_end.png}
\vspace*{-1.3\baselineskip}
\caption{Static move is illegal}
\label{fig:scn_mv_054_static_move_is_illegal_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_055_static_piece_is_legal_init.png}
\vspace*{-1.3\baselineskip}
\caption{Static piece start}
\label{fig:scn_mv_055_static_piece_is_legal_init}
\end{figure}
...
\hyperref[fig:scn_mv_045_pinned_piece_cascaded_init]{Waves can't do that}.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_056_static_piece_is_legal_end.png}
\vspace*{-1.3\baselineskip}
\caption{Static piece is legal}
\label{fig:scn_mv_056_static_piece_is_legal_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_057_delayed_promotion_is_legal_init.png}
% \vspace*{-1.3\baselineskip}
\caption{Pawn is tagged for promotion}
\label{fig:scn_mv_057_delayed_promotion_is_legal_init}
\end{figure}

\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_058_delayed_promotion_is_legal_end.png}
% \vspace*{-1.3\baselineskip}
\caption{Pawn was promoted to Queen}
\label{fig:scn_mv_058_delayed_promotion_is_legal_end}
\end{figure}

% \vspace*{-0.4\baselineskip}
While \hyperref[fig:scn_mv_053_static_move_is_illegal_init]{static move is illegal},
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_059_converting_opponents_piece_init.png}
\vspace*{-1.3\baselineskip}
\caption{Starting conversion cascade}
\label{fig:scn_mv_059_converting_opponents_piece_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_060_converting_opponents_piece_end.png}
\vspace*{-1.3\baselineskip}
\caption{Converting opponent's piece}
\label{fig:scn_mv_060_converting_opponents_piece_end}
\end{figure}
...
% \hyperref[fig:scn_mv_033_wave_cascading_end]{cascade with all own pieces}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_070_wave_blocked_init.png}
\caption{Activating Wave}
\label{fig:scn_mv_070_wave_blocked_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_071_wave_blocked_end.png}
\caption{Activated Wave blocked}
\label{fig:scn_mv_071_wave_blocked_end}
\end{figure}
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_076_converting_own_piece_init.png}
\vspace*{-1.4\baselineskip}
\caption{Converting own piece}
\label{fig:scn_mv_076_converting_own_piece_init}
\end{wrapfigure}
\hyperref[fig:scn_mv_065_wave_cascading_opponent]{Opponent's pieces can be cascaded},
...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_077_converting_own_piece_end.png}
\vspace*{-1.4\baselineskip}
\caption{Own piece converted}
\label{fig:scn_mv_077_converting_own_piece_end}
\end{wrapfigure}
On the left, grey arrows show path traveled over by a piece they point to.
...
when
\hyperref[fig:scn_mv_059_converting_opponents_piece_init]{final, convertion ply started}.
...
\hyperref[fig:scn_mv_023_wave_activation_by_capture_pawn]{activating piece is Pawn},
...
\hyperref[fig:scn_mv_024_wave_activated_by_capture_pawn]{activated by own, light Pawn}.\newline
\indent
...
\end{wrapfigure}
Since \hyperref[fig:scn_mv_007_wave_is_transparent]{Wave is transparent}, rushing
...
Again, \hyperref[fig:scn_mv_007_wave_is_transparent]{Wave is transparent}, so it does
...
\hyperref[fig:scn_mv_011_wave_block_castling_rook]{onto a field it occupies}.
