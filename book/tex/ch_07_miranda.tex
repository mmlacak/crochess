...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_95_wave_cascading_opponent.png}
\caption{Cascading opponent}
\label{fig:scn_mv_95_wave_cascading_opponent}
\end{figure}
