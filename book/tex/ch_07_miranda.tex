...
Wave is divergent; piece (which could activate Wave) can continue its movement in
...
\indent
Here, both Pawns can step forward, or capture piece after divergence, regardless
if own Wave is being encountered on a step-, or capture-field.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_60_diverging_activated_piece_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Rook}
\label{fig:scn_mv_60_diverging_activated_piece_init}
\end{figure}
...
Activated, non-Wave piece which has no momentum when reached own Wave cannot diverge
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_61_diverging_activated_piece_end.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging activated Rook}
\label{fig:scn_mv_61_diverging_activated_piece_end}
\end{figure}

\vspace*{-0.4\baselineskip}
In previous example, activated Rook cannot diverge from Wave C, only activate it,
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_62_wave_divergence_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Wave}
\label{fig:scn_mv_62_wave_divergence_init}
\end{figure}

\vspace*{-0.4\baselineskip}
Wave can diverge not only from own Wave, but also from opponent's. After divergence,
Wave can choose any direction its
\hyperref[fig:scn_mv_27_wave_cascading_steps]{activator} can, i.e. last non-Wave piece
preceeding it in a cascade.

Again, \hyperref[fig:scn_mv_56_own_wave_is_divergent_init]{diverence is optional},
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_63_wave_divergence_1.png}
\vspace*{-1.3\baselineskip}
\caption{Wave diverted}
\label{fig:scn_mv_63_wave_divergence_1}
\end{figure}
