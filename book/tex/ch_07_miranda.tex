...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_34_wave_blocked_init.png}
\caption{Activating Wave}
\label{fig:scn_mv_34_wave_blocked_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_35_wave_blocked_end.png}
\caption{Activated Wave blocked}
\label{fig:scn_mv_35_wave_blocked_end}
\end{figure}
...
This behavior retention includes promotion; opponent's Pawn in own cascade can be
promoted only to other opponent's pieces.

Here, dark Pawn, in a cascade started by light player, is not (and cannot be)
promoted to light piece, it's being promoting to dark piece, e.g. dark Queen.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_98_activated_piece_check_init.png}
\vspace*{-1.3\baselineskip}
\caption{Activating Rooks}
\label{fig:scn_mv_98_activated_piece_check_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_99_activated_piece_check_cascade.png}
\caption{Activated Rooks moved}
\label{fig:scn_mv_99_activated_piece_check_cascade}
\end{figure}
