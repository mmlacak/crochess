...
\indent
To be able to activate Pyramid, last Wave in a cascade and its activator has to
move over their capture-fields, other Waves does not matter. Here, light Pawn
activates Wave A on its step-field; so, even if Wave B takes its capture-steps,
it still can't activate Pyramid B.
...
\TODO :: REDO :: Cascading to Pyramid

step-P --> step-W --> capture-W -->| A

capture-P --> step-W --> capture-W --> A
