...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_04_wave_no_activating_blocked_piece.png}
\caption{Piece blocked}
\label{fig:scn_mv_04_wave_no_activating_blocked_piece}
% \centering
\end{figure}
...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_05_wave_blocked_init.png}
\caption{Activating Wave}
\label{fig:scn_mv_05_wave_blocked_init}
% \centering
\end{figure}
...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_06_wave_blocked_end.png}
\caption{Activated Wave blocked}
\label{fig:scn_mv_06_wave_blocked_end}
% \centering
\end{figure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_07_cascading_rook.png}
\caption{Rook starting cascade}
\label{fig:scn_mv_07_cascading_rook}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_08_cascading_wave_1.png}
\caption{Wave 1 cascading}
\label{fig:scn_mv_08_cascading_wave_1}
\end{wrapfigure}
...
\begin{wrapfigure}[13]{l}{0.5625\textwidth}
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_09_cascading_wave_2.png}
\caption{Wave 2 cascading}
\label{fig:scn_mv_09_cascading_wave_2}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_10_cascading_rook_2nd_time.png}
\caption{Rook, 2nd cascading}
\label{fig:scn_mv_10_cascading_rook_2nd_time}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_11_cascading_wave_1_2nd_time.png}
\caption{Wave 1, 2nd cascading}
\label{fig:scn_mv_11_cascading_wave_1_2nd_time}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_12_cascading_queen.png}
\caption{Queen cascading}
\label{fig:scn_mv_12_cascading_queen}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_13_cascading_wave_2_2nd_time.png}
\caption{Wave 2, 2nd cascading}
\label{fig:scn_mv_13_cascading_wave_2_2nd_time}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_14_cascading_wave_1_3rd_time.png}
\caption{Wave 1, 3rd cascading}
\label{fig:scn_mv_14_cascading_wave_1_3rd_time}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_15_cascading_end.png}
\caption{Wave 1, end cascading}
\label{fig:scn_mv_15_cascading_end}
\end{wrapfigure}
...
\begin{wrapfigure}[10]{l}{0.5625\textwidth}
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_16_casc_oppo_light_queen.png}
\caption{Light Queen starting cascade}
\label{fig:scn_mv_16_casc_oppo_light_queen}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_17_casc_oppo_light_wave.png}
\caption{Light Wave}
\label{fig:scn_mv_17_casc_oppo_light_wave}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_18_casc_oppo_dark_wave.png}
\caption{Dark Wave}
\label{fig:scn_mv_18_casc_oppo_dark_wave}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_19_casc_oppo_dark_queen.png}
\caption{Dark Queen}
\label{fig:scn_mv_19_casc_oppo_dark_queen}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_20_casc_oppo_end.png}
\caption{Cascading opponent end}
\label{fig:scn_mv_20_casc_oppo_end}
\end{wrapfigure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_21_activating_rush_pawn_init.png}
\caption{Activating Pawns}
\label{fig:scn_mv_21_activating_rush_pawn_init}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_22_activating_rush_pawn_end.png}
\caption{Pawns activated}
\label{fig:scn_mv_22_activating_rush_pawn_end}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_23_wave_activation_by_step_pawn.png}
\caption{Pawn activates Wave on step-field}
\label{fig:scn_mv_23_wave_activation_by_step_pawn}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_24_wave_activated_by_step_pawn.png}
\caption{Wave activated on Pawn's step-field}
\label{fig:scn_mv_24_wave_activated_by_step_pawn}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_25_wave_activation_by_capture_pawn.png}
\caption{Pawn activates Wave on capture-field}
\label{fig:scn_mv_25_wave_activation_by_capture_pawn}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_26_wave_activated_by_capture_pawn.png}
\caption{Wave activated on Pawn's capture-field}
\label{fig:scn_mv_26_wave_activated_by_capture_pawn}
% \centering
\end{figure}
...
\centering
\includegraphics[width=0.4375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_27_wave_same_color.png}
\vspace*{-0.7\baselineskip}
\caption{Wave short jump}
\label{fig:scn_mv_27_wave_same_color}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.6875\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_28_wave_opposite_color.png}
\vspace*{-0.7\baselineskip}
\caption{Wave long jump}
\label{fig:scn_mv_28_wave_opposite_color}
\end{wrapfigure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_29_wave_activation_by_unicorn_first_step.png}
\caption{Unicorn activates Wave}
\label{fig:scn_mv_29_wave_activation_by_unicorn_first_step}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_30_wave_activation_by_unicorn_second_step.png}
\caption{Unicorn activates Wave}
\label{fig:scn_mv_30_wave_activation_by_unicorn_second_step}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_31_wave_activation_by_unicorn_complete.png}
\caption{Unicorn activates Wave}
\label{fig:scn_mv_31_wave_activation_by_unicorn_complete}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_32_wave_off_board.png}
\caption{Wave off-board steps}
\label{fig:scn_mv_32_wave_off_board}
% \centering
\end{figure}
