...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_96_wave_blocked_init.png}
\caption{Activating Wave}
\label{fig:scn_mv_96_wave_blocked_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_97_wave_blocked_end.png}
\caption{Activated Wave blocked}
\label{fig:scn_mv_97_wave_blocked_end}
\end{figure}
