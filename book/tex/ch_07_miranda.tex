...
\begin{wrapfigure}[15]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_59_rushing_cascade.png}
\vspace*{-1.4\baselineskip}
\caption{Rushing cascade}
\label{fig:scn_mv_59_rushing_cascade}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_60_en_passant_turning_capture.png}
\vspace*{-1.4\baselineskip}
\caption{Setting-up a figure}
\label{fig:scn_mv_60_en_passant_turning_capture}
\end{wrapfigure}
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_61_en_passant_turned_capture.png}
\vspace*{-1.4\baselineskip}
\caption{Capturing figure instead}
\label{fig:scn_mv_61_en_passant_turned_capture}
\end{wrapfigure}
...
\begin{wrapfigure}[13]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_62_en_passant_wave_captured.png}
\vspace*{-1.4\baselineskip}
\caption{Capturing Wave instead}
\label{fig:scn_mv_62_en_passant_wave_captured}
\end{wrapfigure}
...
\label{sec:Miranda's veil/Wave/Cascading Waves/Activation after en passant}

\vspace*{-0.7\baselineskip}
\noindent
\begin{wrapfigure}[9]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_63_activation_after_en_passant_init.png}
\vspace*{-1.4\baselineskip}
\caption{Rushing light Pawn}
\label{fig:scn_mv_63_activation_after_en_passant_init}
\end{wrapfigure}
Opponent's Wave is also transparent to a rushing Pawn; while Pawn cannot interact
with opponent's Wave on its step-fields, Pawn can step over Wave, and continue
rushing.
...
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_64_activation_after_en_passant_end.png}
\vspace*{-1.4\baselineskip}
\caption{Activation after en passant}
\label{fig:scn_mv_64_activation_after_en_passant_end}
\end{wrapfigure}
...
light Pawn would be captured, and dark Wave would continue a cascade.

\clearpage % ..........................................................

\subsubsection*{En passant denied}
\addcontentsline{toc}{subsubsection}{En passant denied}
\label{sec:Miranda's veil/Wave/Cascading Waves/En passant denied}

\vspace*{-0.7\baselineskip}
\noindent
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_65_en_passant_denied_init.png}
\vspace*{-1.4\baselineskip}
\caption{Rushing light Pawn}
\label{fig:scn_mv_65_en_passant_denied_init}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_66_en_passant_denied_pawn_activated.png}
\vspace*{-1.4\baselineskip}
\caption{Light Pawn activated}
\label{fig:scn_mv_66_en_passant_denied_pawn_activated}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_67_en_passant_denied_end.png}
\vspace*{-1.4\baselineskip}
\caption{En passant denied}
\label{fig:scn_mv_67_en_passant_denied_end}
\end{wrapfigure}
. . .
...
\addcontentsline{toc}{subsubsection}{En passant possible}
\label{sec:Miranda's veil/Wave/Cascading Waves/En passant possible}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_63_converting_opponents_piece_init.png}
\vspace*{-1.3\baselineskip}
\caption{Starting conversion cascade}
\label{fig:scn_mv_63_converting_opponents_piece_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_64_converting_opponents_piece_end.png}
\vspace*{-1.3\baselineskip}
\caption{Converting opponent's piece}
\label{fig:scn_mv_64_converting_opponents_piece_end}
\end{figure}
...
\begin{wrapfigure}[15]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_72_rushing_cascade_opponent.png}
\vspace*{-1.4\baselineskip}
\caption{Rushing cascade}
\label{fig:scn_mv_72_rushing_cascade_opponent}
\end{wrapfigure}
...
\begin{wrapfigure}[7]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_73_blocking_en_passant.png}
\vspace*{-1.4\baselineskip}
\caption{Blocking en passant}
\label{fig:scn_mv_73_blocking_en_passant}
\end{wrapfigure}
Grey arrows show path traveled over by a piece they point to; taken together they
show first part of the cascade, which is already done.\newline
\indent
...
\begin{wrapfigure}[10]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_74_blocked_en_passant.png}
\vspace*{-1.4\baselineskip}
\caption{Blocked en passant}
\label{fig:scn_mv_74_blocked_en_passant}
\end{wrapfigure}
...
\begin{wrapfigure}[13]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.39375\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_75_en_passant_blocked_by_wave.png}
\vspace*{-1.4\baselineskip}
\caption{Blocked by Wave}
\label{fig:scn_mv_75_en_passant_blocked_by_wave}
\end{wrapfigure}
...
when
\hyperref[fig:scn_mv_63_converting_opponents_piece_init]{final, convertion ply started}.
