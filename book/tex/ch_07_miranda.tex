...
\vspace*{-0.5\baselineskip}
During cascade, Wave can be the only piece on a pinning path (i.e. on a opponent's
...
light Queen; this is fine, there will be light Knight blocking dark Pegasus'
capture-field, after light player's move finishes.
