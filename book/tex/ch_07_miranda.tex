...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_move_wave_opponent_dark_queen.png}
\caption{Dark Queen}
...
\centering
\includegraphics[width=0.5625\textwidth, keepaspectratio=true]{examples/10_move_wave_opponent_end.png}
...
\centering
\includegraphics[width=0.3125\textwidth, keepaspectratio=true]{examples/10_move_wave_activating_pawn_init.png}
\caption{Activating Pawn}
\label{fig:10_move_wave_activating_pawn_init}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.3125\textwidth, keepaspectratio=true]{examples/10_move_wave_activating_pawn_end.png}
\caption{Pawn activated}
\label{fig:10_move_wave_activating_pawn_end}
\end{wrapfigure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{castlings/10_miranda_s_veil_castling.png}
\caption{Castling}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{castlings/long_left/10_miranda_s_veil_castling_long_left.png}
