...
has no momentum. Wave can move as if there are no pieces on a chessboard at all.
...
Wave can choose direction on the first step, which cannot be changed later. Wave
can step outside of a chessboard, and only has to end its' ply on a board. For
