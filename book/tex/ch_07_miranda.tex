...
\subsubsection*{Pinned piece in a cascade}
\addcontentsline{toc}{subsubsection}{Pinned piece in a cascade}
\label{sec:Miranda's veil/Wave/Cascading Waves/Pinned piece in a cascade}
...
\subsubsection*{Pinned piece in a cascade 2}
\addcontentsline{toc}{subsubsection}{Pinned piece in a cascade 2}
\label{sec:Miranda's veil/Wave/Cascading Waves/Pinned piece in a cascade 2}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_35_pinned_piece_cascaded_init.png}
% \vspace*{-1.3\baselineskip}
\caption{Pinned piece in a cascade}
\label{fig:scn_mv_35_pinned_piece_cascaded_init}
\end{figure}

% \vspace*{-0.4\baselineskip}
A
\href{https://en.wikipedia.org/wiki/Pin_(chess)#Absolute_pin}{piece pinned to its King cannot move}
in a normal, non-cascading move, since that would leave King checked. In a cascade, activating piece
would take place of originally pinned piece, and so King still would not be checked.

Here, light Queen is pinned to its King.
