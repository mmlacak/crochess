...
% \begin{figure}[t]
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_05_wave_no_momentum_no_activating.png}
\caption{No momentum}
\label{fig:scn_mv_05_wave_no_momentum_no_activating}
% \centering
\end{figure}
