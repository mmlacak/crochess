...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_26_wave_activation_by_unicorn.png}
\caption{Unicorn activates Wave}
\label{fig:scn_mv_26_wave_activation_by_unicorn}
% \centering
\end{figure}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_27_wave_activated_by_unicorn.png}
\caption{Wave activated by Unicorn}
\label{fig:scn_mv_27_wave_activated_by_unicorn}
% \centering
\end{figure}
