...
Once activated, Wave can move forward diagonally, either to the left or to the right, until
the end of the board, regardless if capture-fields are empty, or if own or opponent's pieces
are present.
...
Wave can't activate light Pegasus.
