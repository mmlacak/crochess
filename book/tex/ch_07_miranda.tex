...
piece other than Wave) on its capture-fields.
...
\centering
\includegraphics[width=0.35\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_029_wave_same_color.png}
\vspace*{-0.3\baselineskip}
...
\centering
\includegraphics[width=0.6\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_030_wave_opposite_color.png}
\vspace*{-1.3\baselineskip}
...
if Wave started on opposite-color field.\newline
\indent
On all subsequent steps, Wave has to keep alternating between
...
\hyperref[fig:scn_mv_027_wave_activation_by_capture_pawn]{activating piece is opponent's Pawn},
Wave would also have movement direction swapped backwards, i.e. towards own
initial positions.
