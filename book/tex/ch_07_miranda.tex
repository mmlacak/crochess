...
a cascade, and the one which did (here, light Queen A) has been moved out of its
starting position (field Q).
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_47_wave_cascading_opponent.png}
% \vspace*{-1.3\baselineskip}
\caption{Cascading opponent}
\label{fig:scn_mv_47_wave_cascading_opponent}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_48_cascaded_opponent_capturing.png}
\caption{Cascaded opponent capturing piece}
\label{fig:scn_mv_48_cascaded_opponent_capturing}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_49_cascaded_opponent_promoting.png}
\caption{Cascaded opponent promoting Pawn}
\label{fig:scn_mv_49_cascaded_opponent_promoting}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_50_cascade_self_checkmate_init.png}
\vspace*{-1.4\baselineskip}
\caption{Cascading opponent's Rook}
\label{fig:scn_mv_50_cascade_self_checkmate_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_51_cascade_self_checkmate_end.png}
\caption{Cascaded self-checkmate}
\label{fig:scn_mv_51_cascade_self_checkmate_end}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_52_wave_blocked_init.png}
\caption{Activating Wave}
\label{fig:scn_mv_52_wave_blocked_init}
\end{figure}
...
\noindent
\begin{figure}[h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_53_wave_blocked_end.png}
\caption{Activated Wave blocked}
\label{fig:scn_mv_53_wave_blocked_end}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_54_own_wave_is_divergent_init.png}
\vspace*{-1.3\baselineskip}
\caption{Own Wave is divergent}
\label{fig:scn_mv_54_own_wave_is_divergent_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_55_own_wave_is_divergent_1.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Queen}
\label{fig:scn_mv_55_own_wave_is_divergent_1}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_56_no_single_step_divergence.png}
\vspace*{-1.3\baselineskip}
\caption{No single-step divergence}
\label{fig:scn_mv_56_no_single_step_divergence}
\end{figure}

\vspace*{-0.4\baselineskip}
Pieces which can move for only a single step in a ply, cannot neither diverge nor
ignore Wave, but only activate it, because Wave already occupies a destination field,
and does not grant another step. Those pieces are Kings, Knights, Unicorns and Pawns
(if they're not rushing).
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_57_diverging_rush.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging rush}
\label{fig:scn_mv_57_diverging_rush}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_58_wave_divergence_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Wave}
\label{fig:scn_mv_58_wave_divergence_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_59_wave_divergence_1.png}
\vspace*{-1.3\baselineskip}
\caption{Wave diverted}
\label{fig:scn_mv_59_wave_divergence_1}
\end{figure}
