...
% \vspace*{-1.3\baselineskip}
\caption{Pawn was promoted to a Queen}
...
delayed promotion is legal because piece after promotion is different than the one
at the beginning, even though starting and destination fields are the same.
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_59_diverging_activated_piece.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging activated piece}
\label{fig:scn_mv_59_diverging_activated_piece}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_60_wave_divergence_init.png}
\vspace*{-1.3\baselineskip}
\caption{Diverging Wave}
\label{fig:scn_mv_60_wave_divergence_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/10_mv/scn_mv_61_wave_divergence_1.png}
\vspace*{-1.3\baselineskip}
\caption{Wave diverted}
\label{fig:scn_mv_61_wave_divergence_1}
\end{figure}
