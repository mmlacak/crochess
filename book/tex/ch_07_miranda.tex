...
\indent
That means, either Pyramid or opponent's piece (or both!) could be moved from own
onto opponent's side of a chessboard before conversion is done, all in a single
cascade.
