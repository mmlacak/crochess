...
\centering
\includegraphics[width=0.4\textwidth, keepaspectratio=true]{examples/02_c/scn_cc_03_knight_stepping.png}
\vspace*{-1.4\baselineskip}
...
\centering
\includegraphics[width=0.4\textwidth, keepaspectratio=true]{examples/02_c/scn_cc_04_rook_capturing.png}
\vspace*{-1.4\baselineskip}
