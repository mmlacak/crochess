...
\noindent
So, loops are illegal.

\clearpage % ..........................................................

\TODO

all are illegal within a single ply
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_08_static_piece_is_legal.png}
\vspace*{-0.5\baselineskip}
\caption{Static piece}
\label{fig:scn_tr_08_static_piece_is_legal}
\end{wrapfigure}
Also similar to
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_9_static_loop_is_legal.png}
\vspace*{-0.5\baselineskip}
\caption{Static loop}
\label{fig:scn_tr_9_static_loop_is_legal}
\end{wrapfigure}
Static loop is a movement of a Serpent over its starting position, to e.g.
% \hyperref[fig:scn_tr_10_serpent_loop_init]{build momentum}. Static loop is a legal move,
build momentum. Static loop is a legal move,
...
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_10_serpent_loop_init.png}
\vspace*{-0.5\baselineskip}
\caption{Activating Pyramid}
\label{fig:scn_tr_10_serpent_loop_init}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_11_serpent_loop_unwinded.png}
\vspace*{-0.5\baselineskip}
\caption{Without loop}
\label{fig:scn_tr_11_serpent_loop_unwinded}
\end{wrapfigure}
. . .
...
scn\_tr\_10\_serpent\_loop\_init --> find all, change link
