...
if it's unoccupied, to change color of accessible fields. Serpent can also
teleport using this color-changing move; teleporting or not, this move finishes
cascade, if Serpent was activated.

\TODO :: displacements of Pawns within a ply
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_06_serpent_loop_1.png}
\caption{Activating Pyramid}
\label{fig:scn_tr_06_serpent_loop_1}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_07_serpent_loop_end.png}
\caption{Building momentum}
\label{fig:scn_tr_07_serpent_loop_end}
\end{wrapfigure}
...
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_08_static_move_is_illegal.png}
\vspace*{-0.5\baselineskip}
\caption{Static move}
\label{fig:scn_tr_08_static_move_is_illegal}
\end{wrapfigure}
Static move is one in which a piece ends in the same position as it was at the
beginning of that same move. Similar to
\hyperref[fig:scn_mv_43_static_move_is_illegal_init]{previous example}, it's
illegal for a single piece in a move, or one starting a cascade, to end its
...
\label{sec:Tamoanchan Revisited/Serpent/Movement/Static piece is legal}

\vspace*{-1.2\baselineskip}
\noindent
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_09_static_piece_is_legal.png}
\vspace*{-0.5\baselineskip}
\caption{Static piece}
\label{fig:scn_tr_09_static_piece_is_legal}
\end{wrapfigure}
Also similar to
\hyperref[fig:scn_mv_45_static_piece_is_legal_init]{previous example}, for a piece
activated in a cascade it's legal to end its movement on its starting field.

Here, Serpent activated in a cascade can return to its originating field S,
reactivate Wave, and force it to move over to field W.

% \clearpage % ..........................................................

\vspace*{-0.6\baselineskip}
\subsubsection*{Static loop is legal}
\addcontentsline{toc}{subsubsection}{Static loop is legal}
\label{sec:Tamoanchan Revisited/Serpent/Movement/Static loop is legal}

\vspace*{-1.2\baselineskip}
\noindent
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_10_static_loop_is_legal.png}
\vspace*{-0.5\baselineskip}
\caption{Static loop}
\label{fig:scn_tr_10_static_loop_is_legal}
\end{wrapfigure}
Static loop is a movement of a Serpent over its starting position, to e.g.
\hyperref[fig:scn_tr_06_serpent_loop_1]{build momentum}. Static loop is a legal move,
even if Serpent was the only piece in a move, or was starting a cascade, as long as
its final destination is different from its starting position.
...
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_11_serpent_neighbors.png}
\caption{Color-changing move}
\label{fig:scn_tr_11_serpent_neighbors}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_12_cascade_serpent_neighbors.png}
\caption{Color-changing cascade}
\label{fig:scn_tr_12_cascade_serpent_neighbors}
\end{wrapfigure}
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_13_displacement_init.png}
\vspace*{-0.5\baselineskip}
\caption{Before displacement}
\label{fig:scn_tr_13_displacement_init}
\end{wrapfigure}
Serpent can displace a piece it encounters and, in the same ply, continue its movement.
Displacement does not use momentum, and can be performed even if Serpent has none. Any
piece, own or opponent's, can be displaced except Kings, and Stars. \newline
...
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_14_displacement_step.png}
\vspace*{-0.5\baselineskip}
\caption{Displacement step}
\label{fig:scn_tr_14_displacement_step}
\end{wrapfigure}
i.e. a piece can be displaced for one field to the left, right, up, or bottom from
its encountered position, if that displacing field is empty. This is so, regardless
how displaced piece moves otherwise. \newline
Here, dark Knight (now "in the air") can be displaced onto any of 3 empty neighboring
fields; up-field is illegal for displacement, since it's not empty.

\vspace*{-0.8\baselineskip}
\noindent
\begin{wrapfigure}[11]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_15_displacement_end.png}
\vspace*{-0.5\baselineskip}
\caption{Displacement end}
\label{fig:scn_tr_15_displacement_end}
\end{wrapfigure}
...
encountered piece. \newline
Here, dark Knight has been displaced onto down-field; arrows show complete Serpent's
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_16_serpent_out_of_board.png}
\caption{Serpent out-of-board steps}
\label{fig:scn_tr_16_serpent_out_of_board}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_17_teleport_serpent_1.png}
\caption{Teleporting Serpent}
\label{fig:scn_tr_17_teleport_serpent_1}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_18_teleport_serpent_2.png}
\caption{Color-changing step}
\label{fig:scn_tr_18_teleport_serpent_2}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_19_pawn_sacrifice_init.png}
\caption{Pawn-sacrifice start}
\label{fig:scn_tr_19_pawn_sacrifice_init}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_20_pawn_sacrifice_end.png}
\caption{Pawn-sacrifice end}
\label{fig:scn_tr_20_pawn_sacrifice_end}
\end{figure}
...
\begin{wrapfigure}[3]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_21_serpent_activating_wave.png}
\caption{Activating}
\label{fig:scn_tr_21_serpent_activating_wave}
\end{wrapfigure}
Serpent can activate Wave on its step-fields only, it cannot activate Wave
on \hyperref[fig:scn_tr_11_serpent_neighbors]{color-changing fields}.

\vspace*{7.0\baselineskip}
\noindent
\begin{wrapfigure}[2]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_22_serpent_activated_wave.png}
\caption{Activated}
\label{fig:scn_tr_22_serpent_activated_wave}
\end{wrapfigure}
...
\begin{wrapfigure}[2]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_23_serpent_activated_wave_step_1.png}
\caption{First step}
\label{fig:scn_tr_23_serpent_activated_wave_step_1}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_24_serpent_activated_wave_ply.png}
\caption{Activated Wave ply}
\label{fig:scn_tr_24_serpent_activated_wave_ply}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_25_wave_out_of_board.png}
\caption{Wave out-of-board steps}
\label{fig:scn_tr_25_wave_out_of_board}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_26_off_board_teleport_wave.png}
\caption{Teleporting off-board Wave}
\label{fig:scn_tr_26_off_board_teleport_wave}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_27_teleported_wave_on_board.png}
\caption{Teleported Wave}
\label{fig:scn_tr_27_teleported_wave_on_board}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_28_on_board_teleport_wave.png}
\caption{Teleporting Wave}
\label{fig:scn_tr_28_on_board_teleport_wave}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_29_teleported_wave_off_board.png}
\caption{Wave teleported off-board}
\label{fig:scn_tr_29_teleported_wave_off_board}
\end{figure}
