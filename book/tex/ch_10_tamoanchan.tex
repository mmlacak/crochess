...
A and B, in that order), even across teleportation. Since Wave dived into a Star
from B direction, next step after teleporting has to be in A direction. Again,
Wave cannot change directions from those initially selected; e.g. upon reaching
field 9, it cannot choose other direction on B diagonal.
...
Wave, even though it stepped outside of a board. Note, field 3 if blocked by
