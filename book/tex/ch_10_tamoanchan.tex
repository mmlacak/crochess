...
\hyperref[fig:scn_mv_51_static_move_is_illegal_init]{previous example}, it's
...
\end{wrapfigure}
Unlike
\hyperref[fig:scn_mv_53_static_piece_is_legal_init]{previous example}, Serpent
...
\hyperref[fig:scn_mv_51_static_move_is_illegal_init]{the very first piece in a cascade}.
...
\begin{wrapfigure}[3]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_31_serpent_activating_wave.png}
\vspace*{-0.4\baselineskip}
\caption{Activating}
...
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_32_serpent_activated_wave.png}
\vspace*{-0.4\baselineskip}
\caption{Activated}
...
\begin{wrapfigure}[2]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_33_serpent_activated_wave_step_1.png}
\vspace*{-0.4\baselineskip}
\caption{First step}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_34_serpent_activated_wave_ply.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_35_wave_out_of_board.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_36_off_board_teleport_wave.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_37_teleported_wave_on_board.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_38_on_board_teleport_wave.png}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_39_teleported_wave_off_board.png}
