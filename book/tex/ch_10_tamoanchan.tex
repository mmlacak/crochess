...
with selected path, even though it would end movement on the chessboard.
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_12_serpent_activated_wave_ply.png}
...
\begin{figure}[!h]
% \begin{figure}[!t]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_13_wave_out_of_board.png}
\caption{Wave out-of-board steps}
\label{fig:scn_tr_13_wave_out_of_board}
% \centering
\end{figure}
