...
Pawn-sacrifice is a move initiated by Serpent activating own Pyramid on its
ritual-starting fields; Pyramid then captures field at which own Pawn is located.
Pawn is then \hyperref[sec:Terms/Oblation]{oblationed}, and Serpent gets
Pawn-sacrifice tag allowing it to capture one or more opponent's Pawns in the
following ply. Any of pieces involved can be on either side of a chessboard,
own or opponent's.
...
\begin{wrapfigure}[5]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.227272727\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_27_ritual_starting_fields.png}
\vspace*{-0.4\baselineskip}
\caption{Ritual-starting fields}
\label{fig:scn_tr_27_ritual_starting_fields}
\end{wrapfigure}
