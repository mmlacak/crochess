...
\begin{wrapfigure}[5]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.227272727\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_30_ritual_starting_fields.png}
\vspace*{-0.4\baselineskip}
...
\indent
Note, in a new ply Serpent is accumulating momentum, even though the ply is not
the first one in a cascade, since Serpent was not activated.\newline
\indent
Here, tagged Serpent cannot capture dark Bishop; but can use Wave transparency to
reach own, light Pawn C.
...
\begin{wrapfigure}[3]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_40_serpent_activating_wave.png}
\vspace*{-0.4\baselineskip}
\caption{Activating}
...
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_41_serpent_activated_wave.png}
\vspace*{-0.4\baselineskip}
\caption{Activated}
...
\begin{wrapfigure}[2]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_42_serpent_activated_wave_step_1.png}
\vspace*{-0.4\baselineskip}
\caption{First step}
