...
\hyperref[fig:scn_mv_46_static_move_is_illegal_init]{previous example}, it's
...
\end{wrapfigure}
Unlike
\hyperref[fig:scn_mv_48_static_piece_is_legal_init]{previous example}, Serpent
...
\hyperref[fig:scn_mv_46_static_move_is_illegal_init]{the very first piece in a cascade}.
