...
\end{wrapfigure}
Serpent can displace a piece it encounters, and continue its movement. Displacement
does not use momentum, and can be performed even if Serpent has none. Any piece, own
or opponent's, can be displaced except Kings, and Stars. \newline
...
\end{wrapfigure}
. . .
if no empty displacement field, Serpent must capture, or activate, or stop before
