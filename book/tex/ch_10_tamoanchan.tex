...
\subsubsection*{Static loop is illegal}
\addcontentsline{toc}{subsubsection}{Static loop is illegal}
\label{sec:Tamoanchan Revisited/Serpent/Movement/Static loop is illegal}

\vspace*{-1.2\baselineskip}
\noindent
\begin{wrapfigure}[8]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_09_static_loop_is_illegal.png}
\vspace*{-0.5\baselineskip}
\caption{Static loop}
\label{fig:scn_tr_09_static_loop_is_illegal}
\end{wrapfigure}
