...
are closed in a ply other than that Serpent's first ply.
...
% \begin{wrapfigure}[8]{l}{0.4\textwidth}
% \centering
% \includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_09_serpent_loop_init.png}
% \vspace*{-0.5\baselineskip}
% \caption{Static loop}
% \label{fig:scn_tr_09_serpent_loop_init}
% \end{wrapfigure}
% Static loop is a movement of a Serpent over its starting position, to e.g.
% % \hyperref[fig:scn_tr_10_serpent_loop_step]{build momentum}. Static loop is a legal move,
...
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_10_serpent_path_short.png}
\vspace*{-0.5\baselineskip}
\caption{Activating Pyramid}
\label{fig:scn_tr_10_serpent_path_short}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_11_serpent_path_long.png}
\vspace*{-0.5\baselineskip}
\caption{Without loop}
\label{fig:scn_tr_11_serpent_path_long}
\end{wrapfigure}
. . .
...
\begin{wrapfigure}[1]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_12_serpent_path_longest.png}
\vspace*{-0.5\baselineskip}
\caption{Without loop}
\label{fig:scn_tr_12_serpent_path_longest}
\end{wrapfigure}
. . .
...
% scn\_tr\_09\_serpent\_loop\_init --> check appendix if ok
