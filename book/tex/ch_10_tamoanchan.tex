...
% Here, tagged light Serpent can interact only with Pawns, and cannot capture dark
% Bishop or Wave.

% Here, tagged light Serpent can interact only with Pawns, both light and dark ones.
% Tagged Serpent cannot capture neither dark Bishop nor dark Wave. Dark Wave is
% transparent to a Serpent, so tagged Serpent here can move over it, just like it
% can move over empty field.

% . . . and, in the same move, starts a new ply.
...
\TODO :: Serpent tagged with Pawn-sacrifice can displace Pawns.

:: fix notation \& grammar :: fig:scn\_tr\_29\_pawn\_sacrifice\_end
% fig:scn_tr_29_pawn_sacrifice_end
...
\begin{wrapfigure}[3]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_30_serpent_activating_wave.png}
\vspace*{-0.4\baselineskip}
\caption{Activating}
\label{fig:scn_tr_30_serpent_activating_wave}
\end{wrapfigure}
...
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_31_serpent_activated_wave.png}
\vspace*{-0.4\baselineskip}
\caption{Activated}
\label{fig:scn_tr_31_serpent_activated_wave}
\end{wrapfigure}
...
\begin{wrapfigure}[2]{l}{0.4\textwidth}
\centering
\includegraphics[width=0.363636363636\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_32_serpent_activated_wave_step_1.png}
\vspace*{-0.4\baselineskip}
\caption{First step}
\label{fig:scn_tr_32_serpent_activated_wave_step_1}
\end{wrapfigure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_33_serpent_activated_wave_ply.png}
\caption{Activated Wave ply}
\label{fig:scn_tr_33_serpent_activated_wave_ply}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_34_wave_out_of_board.png}
\caption{Wave out-of-board steps}
\label{fig:scn_tr_34_wave_out_of_board}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_35_off_board_teleport_wave.png}
\caption{Teleporting off-board Wave}
\label{fig:scn_tr_35_off_board_teleport_wave}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_36_teleported_wave_on_board.png}
\caption{Teleported Wave}
\label{fig:scn_tr_36_teleported_wave_on_board}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_37_on_board_teleport_wave.png}
\caption{Teleporting Wave}
\label{fig:scn_tr_37_on_board_teleport_wave}
\end{figure}
...
\noindent
\begin{figure}[!h]
\includegraphics[width=1.0\textwidth, keepaspectratio=true]{examples/16_tr/scn_tr_38_teleported_wave_off_board.png}
\caption{Wave teleported off-board}
\label{fig:scn_tr_38_teleported_wave_off_board}
\end{figure}
