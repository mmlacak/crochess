...
echo
zip -rTv9 crochess.zip crochess -x *.* *. -i \*.txt \*LICENSING\* \*COPYING\* \*CODE_OF_CONDUCT\* \*CONTRIBUTING\* \*.md \*.sh \*.py \*.tex \*.c \*.h \*.ico \*Doxyfile\* -x \*tmp\* \*temp\* \*.github\* \*.DIFF.\* \*bin\* crochess/ws/docs/\* crochess/docs/build/\*
echo
