...
.. c:function:: CcParsedPly * cc_parsed_ply__new( char const * start_an__d, char const * end_an__d, size_t max_len__d, CcParsedPlyLinkEnum link, cc_piece piece, CcLosingTagEnum lost_tag, CcParsedStep ** steps__n )
...
.. c:function:: CcParsedPly * cc_parsed_ply_append( CcParsedPly ** plies__iod_a, char const * start_an__d, char const * end_an__d, size_t max_len__d, CcParsedPlyLinkEnum link, cc_piece piece, CcLosingTagEnum lost_tag, CcParsedStep ** steps__n )
...
.. c:function:: cc_piece cc_parsed_ply_find_activator( CcParsedPly * plies, CcParsedPly * ply__d )
