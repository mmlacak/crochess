...
The book and related texts, images in ``book`` subfolder of the project are in Public Domain.
...
Documentation and related texts in ``docs`` subfolder of the project is in Public Domain.
...
.. _lbl-licensing-dependecies-linenoise:

Linenoise
^^^^^^^^^

Linenoise is licensed under 2-clause BSD license, see
`Linenoise repository <https://github.com/antirez/linenoise>`_ for details.
